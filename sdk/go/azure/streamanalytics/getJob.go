...
func LookupJobApply(ctx *pulumi.Context, args LookupJobApplyInput, opts ...pulumi.InvokeOption) LookupJobResultOutput {
	return args.ToLookupJobApplyOutput().ApplyT(func(v LookupJobArgs) (LookupJobResult, error) {
		r, err := LookupJob(ctx, &v, opts...)
		return *r, err

	}).(LookupJobResultOutput)
}

// LookupJobApplyInput is an input type that accepts LookupJobApplyArgs and LookupJobApplyOutput values.
// You can construct a concrete instance of `LookupJobApplyInput` via:
//
//          LookupJobApplyArgs{...}
type LookupJobApplyInput interface {
	pulumi.Input

	ToLookupJobApplyOutput() LookupJobApplyOutput
	ToLookupJobApplyOutputWithContext(context.Context) LookupJobApplyOutput
}

// A collection of arguments for invoking getJob.
type LookupJobApplyArgs struct {
	// Specifies the name of the Stream Analytics Job.
...
func (LookupJobApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupJobArgs)(nil)).Elem()
}

func (i LookupJobApplyArgs) ToLookupJobApplyOutput() LookupJobApplyOutput {
	return i.ToLookupJobApplyOutputWithContext(context.Background())
}

func (i LookupJobApplyArgs) ToLookupJobApplyOutputWithContext(ctx context.Context) LookupJobApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupJobApplyOutput)
}

// A collection of arguments for invoking getJob.
type LookupJobApplyOutput struct{ *pulumi.OutputState }

func (LookupJobApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupJobArgs)(nil)).Elem()
}

func (o LookupJobApplyOutput) ToLookupJobApplyOutput() LookupJobApplyOutput {
	return o
}

func (o LookupJobApplyOutput) ToLookupJobApplyOutputWithContext(ctx context.Context) LookupJobApplyOutput {
	return o
}

// Specifies the name of the Stream Analytics Job.
func (o LookupJobApplyOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v LookupJobArgs) string { return v.Name }).(pulumi.StringOutput)
}

// Specifies the name of the resource group the Stream Analytics Job is located in.
func (o LookupJobApplyOutput) ResourceGroupName() pulumi.StringOutput {
	return o.ApplyT(func(v LookupJobArgs) string { return v.ResourceGroupName }).(pulumi.StringOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupJobApplyOutput{})
