...
func LookupApiVersionSetApply(ctx *pulumi.Context, args LookupApiVersionSetApplyInput, opts ...pulumi.InvokeOption) LookupApiVersionSetResultOutput {
	return args.ToLookupApiVersionSetApplyOutput().ApplyT(func(v LookupApiVersionSetArgs) (LookupApiVersionSetResult, error) {
		r, err := LookupApiVersionSet(ctx, &v, opts...)
		return *r, err

	}).(LookupApiVersionSetResultOutput)
}

// LookupApiVersionSetApplyInput is an input type that accepts LookupApiVersionSetApplyArgs and LookupApiVersionSetApplyOutput values.
// You can construct a concrete instance of `LookupApiVersionSetApplyInput` via:
//
//          LookupApiVersionSetApplyArgs{...}
type LookupApiVersionSetApplyInput interface {
	pulumi.Input

	ToLookupApiVersionSetApplyOutput() LookupApiVersionSetApplyOutput
	ToLookupApiVersionSetApplyOutputWithContext(context.Context) LookupApiVersionSetApplyOutput
}

// A collection of arguments for invoking getApiVersionSet.
type LookupApiVersionSetApplyArgs struct {
	// The name of the API Management Service where the API Version Set exists.
...
func (LookupApiVersionSetApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupApiVersionSetArgs)(nil)).Elem()
}

func (i LookupApiVersionSetApplyArgs) ToLookupApiVersionSetApplyOutput() LookupApiVersionSetApplyOutput {
	return i.ToLookupApiVersionSetApplyOutputWithContext(context.Background())
}

func (i LookupApiVersionSetApplyArgs) ToLookupApiVersionSetApplyOutputWithContext(ctx context.Context) LookupApiVersionSetApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupApiVersionSetApplyOutput)
}

// A collection of arguments for invoking getApiVersionSet.
type LookupApiVersionSetApplyOutput struct{ *pulumi.OutputState }

func (LookupApiVersionSetApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupApiVersionSetArgs)(nil)).Elem()
}

func (o LookupApiVersionSetApplyOutput) ToLookupApiVersionSetApplyOutput() LookupApiVersionSetApplyOutput {
	return o
}

func (o LookupApiVersionSetApplyOutput) ToLookupApiVersionSetApplyOutputWithContext(ctx context.Context) LookupApiVersionSetApplyOutput {
	return o
}

// The name of the API Management Service where the API Version Set exists.
func (o LookupApiVersionSetApplyOutput) ApiManagementName() pulumi.StringOutput {
	return o.ApplyT(func(v LookupApiVersionSetArgs) string { return v.ApiManagementName }).(pulumi.StringOutput)
}

// The name of the API Version Set.
func (o LookupApiVersionSetApplyOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v LookupApiVersionSetArgs) string { return v.Name }).(pulumi.StringOutput)
}

// The name of the Resource Group in which the parent API Management Service exists.
func (o LookupApiVersionSetApplyOutput) ResourceGroupName() pulumi.StringOutput {
	return o.ApplyT(func(v LookupApiVersionSetArgs) string { return v.ResourceGroupName }).(pulumi.StringOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupApiVersionSetApplyOutput{})
