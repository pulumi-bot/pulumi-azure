...
func GetServiceBusNamespaceApply(ctx *pulumi.Context, args GetServiceBusNamespaceApplyInput, opts ...pulumi.InvokeOption) GetServiceBusNamespaceResultOutput {
	return args.ToGetServiceBusNamespaceApplyOutput().ApplyT(func(v GetServiceBusNamespaceArgs) (GetServiceBusNamespaceResult, error) {
		r, err := GetServiceBusNamespace(ctx, &v, opts...)
		return *r, err

	}).(GetServiceBusNamespaceResultOutput)
}

// GetServiceBusNamespaceApplyInput is an input type that accepts GetServiceBusNamespaceApplyArgs and GetServiceBusNamespaceApplyOutput values.
// You can construct a concrete instance of `GetServiceBusNamespaceApplyInput` via:
//
//          GetServiceBusNamespaceApplyArgs{...}
type GetServiceBusNamespaceApplyInput interface {
	pulumi.Input

	ToGetServiceBusNamespaceApplyOutput() GetServiceBusNamespaceApplyOutput
	ToGetServiceBusNamespaceApplyOutputWithContext(context.Context) GetServiceBusNamespaceApplyOutput
}

// A collection of arguments for invoking getServiceBusNamespace.
type GetServiceBusNamespaceApplyArgs struct {
	// Specifies the name of the ServiceBus Namespace.
...
func (GetServiceBusNamespaceApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetServiceBusNamespaceArgs)(nil)).Elem()
}

func (i GetServiceBusNamespaceApplyArgs) ToGetServiceBusNamespaceApplyOutput() GetServiceBusNamespaceApplyOutput {
	return i.ToGetServiceBusNamespaceApplyOutputWithContext(context.Background())
}

func (i GetServiceBusNamespaceApplyArgs) ToGetServiceBusNamespaceApplyOutputWithContext(ctx context.Context) GetServiceBusNamespaceApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetServiceBusNamespaceApplyOutput)
}

// A collection of arguments for invoking getServiceBusNamespace.
type GetServiceBusNamespaceApplyOutput struct{ *pulumi.OutputState }

func (GetServiceBusNamespaceApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetServiceBusNamespaceArgs)(nil)).Elem()
}

func (o GetServiceBusNamespaceApplyOutput) ToGetServiceBusNamespaceApplyOutput() GetServiceBusNamespaceApplyOutput {
	return o
}

func (o GetServiceBusNamespaceApplyOutput) ToGetServiceBusNamespaceApplyOutputWithContext(ctx context.Context) GetServiceBusNamespaceApplyOutput {
	return o
}

// Specifies the name of the ServiceBus Namespace.
func (o GetServiceBusNamespaceApplyOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v GetServiceBusNamespaceArgs) string { return v.Name }).(pulumi.StringOutput)
}

// Specifies the name of the Resource Group where the ServiceBus Namespace exists.
func (o GetServiceBusNamespaceApplyOutput) ResourceGroupName() pulumi.StringOutput {
	return o.ApplyT(func(v GetServiceBusNamespaceArgs) string { return v.ResourceGroupName }).(pulumi.StringOutput)
}
...
func init() {
	pulumi.RegisterOutputType(GetServiceBusNamespaceApplyOutput{})
