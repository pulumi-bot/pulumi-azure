...
func LookupNamespaceApply(ctx *pulumi.Context, args LookupNamespaceApplyInput, opts ...pulumi.InvokeOption) LookupNamespaceResultOutput {
	return args.ToLookupNamespaceApplyOutput().ApplyT(func(v LookupNamespaceArgs) (LookupNamespaceResult, error) {
		r, err := LookupNamespace(ctx, &v, opts...)
		return *r, err

	}).(LookupNamespaceResultOutput)
}

// LookupNamespaceApplyInput is an input type that accepts LookupNamespaceApplyArgs and LookupNamespaceApplyOutput values.
// You can construct a concrete instance of `LookupNamespaceApplyInput` via:
//
//          LookupNamespaceApplyArgs{...}
type LookupNamespaceApplyInput interface {
	pulumi.Input

	ToLookupNamespaceApplyOutput() LookupNamespaceApplyOutput
	ToLookupNamespaceApplyOutputWithContext(context.Context) LookupNamespaceApplyOutput
}

// A collection of arguments for invoking getNamespace.
type LookupNamespaceApplyArgs struct {
	// The name of the EventHub Namespace.
...
func (LookupNamespaceApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupNamespaceArgs)(nil)).Elem()
}

func (i LookupNamespaceApplyArgs) ToLookupNamespaceApplyOutput() LookupNamespaceApplyOutput {
	return i.ToLookupNamespaceApplyOutputWithContext(context.Background())
}

func (i LookupNamespaceApplyArgs) ToLookupNamespaceApplyOutputWithContext(ctx context.Context) LookupNamespaceApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupNamespaceApplyOutput)
}

// A collection of arguments for invoking getNamespace.
type LookupNamespaceApplyOutput struct{ *pulumi.OutputState }

func (LookupNamespaceApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupNamespaceArgs)(nil)).Elem()
}

func (o LookupNamespaceApplyOutput) ToLookupNamespaceApplyOutput() LookupNamespaceApplyOutput {
	return o
}

func (o LookupNamespaceApplyOutput) ToLookupNamespaceApplyOutputWithContext(ctx context.Context) LookupNamespaceApplyOutput {
	return o
}

// The name of the EventHub Namespace.
func (o LookupNamespaceApplyOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v LookupNamespaceArgs) string { return v.Name }).(pulumi.StringOutput)
}

// The Name of the Resource Group where the EventHub Namespace exists.
func (o LookupNamespaceApplyOutput) ResourceGroupName() pulumi.StringOutput {
	return o.ApplyT(func(v LookupNamespaceArgs) string { return v.ResourceGroupName }).(pulumi.StringOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupNamespaceApplyOutput{})
