...
func LookupKeyVaultApply(ctx *pulumi.Context, args LookupKeyVaultApplyInput, opts ...pulumi.InvokeOption) LookupKeyVaultResultOutput {
	return args.ToLookupKeyVaultApplyOutput().ApplyT(func(v LookupKeyVaultArgs) (LookupKeyVaultResult, error) {
		r, err := LookupKeyVault(ctx, &v, opts...)
		return *r, err

	}).(LookupKeyVaultResultOutput)
}

// LookupKeyVaultApplyInput is an input type that accepts LookupKeyVaultApplyArgs and LookupKeyVaultApplyOutput values.
// You can construct a concrete instance of `LookupKeyVaultApplyInput` via:
//
//          LookupKeyVaultApplyArgs{...}
type LookupKeyVaultApplyInput interface {
	pulumi.Input

	ToLookupKeyVaultApplyOutput() LookupKeyVaultApplyOutput
	ToLookupKeyVaultApplyOutputWithContext(context.Context) LookupKeyVaultApplyOutput
}

// A collection of arguments for invoking getKeyVault.
type LookupKeyVaultApplyArgs struct {
	// Specifies the name of the Key Vault.
...
func (LookupKeyVaultApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupKeyVaultArgs)(nil)).Elem()
}

func (i LookupKeyVaultApplyArgs) ToLookupKeyVaultApplyOutput() LookupKeyVaultApplyOutput {
	return i.ToLookupKeyVaultApplyOutputWithContext(context.Background())
}

func (i LookupKeyVaultApplyArgs) ToLookupKeyVaultApplyOutputWithContext(ctx context.Context) LookupKeyVaultApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupKeyVaultApplyOutput)
}

// A collection of arguments for invoking getKeyVault.
type LookupKeyVaultApplyOutput struct{ *pulumi.OutputState }

func (LookupKeyVaultApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupKeyVaultArgs)(nil)).Elem()
}

func (o LookupKeyVaultApplyOutput) ToLookupKeyVaultApplyOutput() LookupKeyVaultApplyOutput {
	return o
}

func (o LookupKeyVaultApplyOutput) ToLookupKeyVaultApplyOutputWithContext(ctx context.Context) LookupKeyVaultApplyOutput {
	return o
}

// Specifies the name of the Key Vault.
func (o LookupKeyVaultApplyOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v LookupKeyVaultArgs) string { return v.Name }).(pulumi.StringOutput)
}

// The name of the Resource Group in which the Key Vault exists.
func (o LookupKeyVaultApplyOutput) ResourceGroupName() pulumi.StringOutput {
	return o.ApplyT(func(v LookupKeyVaultArgs) string { return v.ResourceGroupName }).(pulumi.StringOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupKeyVaultApplyOutput{})
