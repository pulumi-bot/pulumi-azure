...
func LookupManagedHardwareSecurityModuleApply(ctx *pulumi.Context, args LookupManagedHardwareSecurityModuleApplyInput, opts ...pulumi.InvokeOption) LookupManagedHardwareSecurityModuleResultOutput {
	return args.ToLookupManagedHardwareSecurityModuleApplyOutput().ApplyT(func(v LookupManagedHardwareSecurityModuleArgs) (LookupManagedHardwareSecurityModuleResult, error) {
		r, err := LookupManagedHardwareSecurityModule(ctx, &v, opts...)
		return *r, err

	}).(LookupManagedHardwareSecurityModuleResultOutput)
}

// LookupManagedHardwareSecurityModuleApplyInput is an input type that accepts LookupManagedHardwareSecurityModuleApplyArgs and LookupManagedHardwareSecurityModuleApplyOutput values.
// You can construct a concrete instance of `LookupManagedHardwareSecurityModuleApplyInput` via:
//
//          LookupManagedHardwareSecurityModuleApplyArgs{...}
type LookupManagedHardwareSecurityModuleApplyInput interface {
	pulumi.Input

	ToLookupManagedHardwareSecurityModuleApplyOutput() LookupManagedHardwareSecurityModuleApplyOutput
	ToLookupManagedHardwareSecurityModuleApplyOutputWithContext(context.Context) LookupManagedHardwareSecurityModuleApplyOutput
}

// A collection of arguments for invoking getManagedHardwareSecurityModule.
type LookupManagedHardwareSecurityModuleApplyArgs struct {
	// The name of the Key Vault Managed Hardware Security Module.
...
func (LookupManagedHardwareSecurityModuleApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupManagedHardwareSecurityModuleArgs)(nil)).Elem()
}

func (i LookupManagedHardwareSecurityModuleApplyArgs) ToLookupManagedHardwareSecurityModuleApplyOutput() LookupManagedHardwareSecurityModuleApplyOutput {
	return i.ToLookupManagedHardwareSecurityModuleApplyOutputWithContext(context.Background())
}

func (i LookupManagedHardwareSecurityModuleApplyArgs) ToLookupManagedHardwareSecurityModuleApplyOutputWithContext(ctx context.Context) LookupManagedHardwareSecurityModuleApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupManagedHardwareSecurityModuleApplyOutput)
}

// A collection of arguments for invoking getManagedHardwareSecurityModule.
type LookupManagedHardwareSecurityModuleApplyOutput struct{ *pulumi.OutputState }

func (LookupManagedHardwareSecurityModuleApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupManagedHardwareSecurityModuleArgs)(nil)).Elem()
}

func (o LookupManagedHardwareSecurityModuleApplyOutput) ToLookupManagedHardwareSecurityModuleApplyOutput() LookupManagedHardwareSecurityModuleApplyOutput {
	return o
}

func (o LookupManagedHardwareSecurityModuleApplyOutput) ToLookupManagedHardwareSecurityModuleApplyOutputWithContext(ctx context.Context) LookupManagedHardwareSecurityModuleApplyOutput {
	return o
}

// The name of the Key Vault Managed Hardware Security Module.
func (o LookupManagedHardwareSecurityModuleApplyOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v LookupManagedHardwareSecurityModuleArgs) string { return v.Name }).(pulumi.StringOutput)
}

// The name of the Resource Group in which the Key Vault Managed Hardware Security Module exists.
func (o LookupManagedHardwareSecurityModuleApplyOutput) ResourceGroupName() pulumi.StringOutput {
	return o.ApplyT(func(v LookupManagedHardwareSecurityModuleArgs) string { return v.ResourceGroupName }).(pulumi.StringOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupManagedHardwareSecurityModuleApplyOutput{})
