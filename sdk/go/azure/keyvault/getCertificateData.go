...
func GetCertificateDataApply(ctx *pulumi.Context, args GetCertificateDataApplyInput, opts ...pulumi.InvokeOption) GetCertificateDataResultOutput {
	return args.ToGetCertificateDataApplyOutput().ApplyT(func(v GetCertificateDataArgs) (GetCertificateDataResult, error) {
		r, err := GetCertificateData(ctx, &v, opts...)
		return *r, err

	}).(GetCertificateDataResultOutput)
}

// GetCertificateDataApplyInput is an input type that accepts GetCertificateDataApplyArgs and GetCertificateDataApplyOutput values.
// You can construct a concrete instance of `GetCertificateDataApplyInput` via:
//
//          GetCertificateDataApplyArgs{...}
type GetCertificateDataApplyInput interface {
	pulumi.Input

	ToGetCertificateDataApplyOutput() GetCertificateDataApplyOutput
	ToGetCertificateDataApplyOutputWithContext(context.Context) GetCertificateDataApplyOutput
}

// A collection of arguments for invoking getCertificateData.
type GetCertificateDataApplyArgs struct {
	// Specifies the ID of the Key Vault instance where the Secret resides, available on the `keyvault.KeyVault` Data Source / Resource.
...
func (GetCertificateDataApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetCertificateDataArgs)(nil)).Elem()
}

func (i GetCertificateDataApplyArgs) ToGetCertificateDataApplyOutput() GetCertificateDataApplyOutput {
	return i.ToGetCertificateDataApplyOutputWithContext(context.Background())
}

func (i GetCertificateDataApplyArgs) ToGetCertificateDataApplyOutputWithContext(ctx context.Context) GetCertificateDataApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetCertificateDataApplyOutput)
}

// A collection of arguments for invoking getCertificateData.
type GetCertificateDataApplyOutput struct{ *pulumi.OutputState }

func (GetCertificateDataApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetCertificateDataArgs)(nil)).Elem()
}

func (o GetCertificateDataApplyOutput) ToGetCertificateDataApplyOutput() GetCertificateDataApplyOutput {
	return o
}

func (o GetCertificateDataApplyOutput) ToGetCertificateDataApplyOutputWithContext(ctx context.Context) GetCertificateDataApplyOutput {
	return o
}

// Specifies the ID of the Key Vault instance where the Secret resides, available on the `keyvault.KeyVault` Data Source / Resource.
func (o GetCertificateDataApplyOutput) KeyVaultId() pulumi.StringOutput {
	return o.ApplyT(func(v GetCertificateDataArgs) string { return v.KeyVaultId }).(pulumi.StringOutput)
}

// Specifies the name of the Key Vault Secret.
func (o GetCertificateDataApplyOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v GetCertificateDataArgs) string { return v.Name }).(pulumi.StringOutput)
}

// Specifies the version of the certificate to look up.  (Defaults to latest)
func (o GetCertificateDataApplyOutput) Version() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetCertificateDataArgs) *string { return v.Version }).(pulumi.StringPtrOutput)
}
...
func init() {
	pulumi.RegisterOutputType(GetCertificateDataApplyOutput{})
