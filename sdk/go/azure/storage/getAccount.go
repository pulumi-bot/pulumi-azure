...
// The minimum supported TLS version for this storage account.
func (o LookupAccountApplyOutput) MinTlsVersion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupAccountArgs) *string { return v.MinTlsVersion }).(pulumi.StringPtrOutput)
}
...
// Specifies the name of the resource group the Storage Account is located in.
func (o LookupAccountApplyOutput) ResourceGroupName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupAccountArgs) *string { return v.ResourceGroupName }).(pulumi.StringPtrOutput)
}
