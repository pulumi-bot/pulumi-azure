...
func LookupTrafficManagerProfileApply(ctx *pulumi.Context, args LookupTrafficManagerProfileApplyInput, opts ...pulumi.InvokeOption) LookupTrafficManagerProfileResultOutput {
	return args.ToLookupTrafficManagerProfileApplyOutput().ApplyT(func(v LookupTrafficManagerProfileArgs) (LookupTrafficManagerProfileResult, error) {
		r, err := LookupTrafficManagerProfile(ctx, &v, opts...)
		return *r, err

	}).(LookupTrafficManagerProfileResultOutput)
}

// LookupTrafficManagerProfileApplyInput is an input type that accepts LookupTrafficManagerProfileApplyArgs and LookupTrafficManagerProfileApplyOutput values.
// You can construct a concrete instance of `LookupTrafficManagerProfileApplyInput` via:
//
//          LookupTrafficManagerProfileApplyArgs{...}
type LookupTrafficManagerProfileApplyInput interface {
	pulumi.Input

	ToLookupTrafficManagerProfileApplyOutput() LookupTrafficManagerProfileApplyOutput
	ToLookupTrafficManagerProfileApplyOutputWithContext(context.Context) LookupTrafficManagerProfileApplyOutput
}

// A collection of arguments for invoking getTrafficManagerProfile.
type LookupTrafficManagerProfileApplyArgs struct {
	// Specifies the name of the Traffic Manager Profile.
...
func (LookupTrafficManagerProfileApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupTrafficManagerProfileArgs)(nil)).Elem()
}

func (i LookupTrafficManagerProfileApplyArgs) ToLookupTrafficManagerProfileApplyOutput() LookupTrafficManagerProfileApplyOutput {
	return i.ToLookupTrafficManagerProfileApplyOutputWithContext(context.Background())
}

func (i LookupTrafficManagerProfileApplyArgs) ToLookupTrafficManagerProfileApplyOutputWithContext(ctx context.Context) LookupTrafficManagerProfileApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupTrafficManagerProfileApplyOutput)
}

// A collection of arguments for invoking getTrafficManagerProfile.
type LookupTrafficManagerProfileApplyOutput struct{ *pulumi.OutputState }

func (LookupTrafficManagerProfileApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupTrafficManagerProfileArgs)(nil)).Elem()
}

func (o LookupTrafficManagerProfileApplyOutput) ToLookupTrafficManagerProfileApplyOutput() LookupTrafficManagerProfileApplyOutput {
	return o
}

func (o LookupTrafficManagerProfileApplyOutput) ToLookupTrafficManagerProfileApplyOutputWithContext(ctx context.Context) LookupTrafficManagerProfileApplyOutput {
	return o
}

// Specifies the name of the Traffic Manager Profile.
func (o LookupTrafficManagerProfileApplyOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v LookupTrafficManagerProfileArgs) string { return v.Name }).(pulumi.StringOutput)
}

// Specifies the name of the resource group the Traffic Manager Profile is located in.
func (o LookupTrafficManagerProfileApplyOutput) ResourceGroupName() pulumi.StringOutput {
	return o.ApplyT(func(v LookupTrafficManagerProfileArgs) string { return v.ResourceGroupName }).(pulumi.StringOutput)
}

// A mapping of tags to assign to the resource.
func (o LookupTrafficManagerProfileApplyOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupTrafficManagerProfileArgs) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}

// Indicates whether Traffic View is enabled for the Traffic Manager profile.
func (o LookupTrafficManagerProfileApplyOutput) TrafficViewEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupTrafficManagerProfileArgs) *bool { return v.TrafficViewEnabled }).(pulumi.BoolPtrOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupTrafficManagerProfileApplyOutput{})
