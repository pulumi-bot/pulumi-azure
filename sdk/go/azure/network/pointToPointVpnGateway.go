...
// 			ResourceGroupName:        dynamic(azurerm_resource_group.Example.Resource_group_name),
// 			VirtualHubId:             dynamic(azurerm_virtual_hub.Example.Id),
// 			VpnServerConfigurationId: dynamic(azurerm_vpn_server_configuration.Example.Id),
