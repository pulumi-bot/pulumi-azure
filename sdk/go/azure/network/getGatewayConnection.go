...
func GetGatewayConnectionApply(ctx *pulumi.Context, args GetGatewayConnectionApplyInput, opts ...pulumi.InvokeOption) GetGatewayConnectionResultOutput {
	return args.ToGetGatewayConnectionApplyOutput().ApplyT(func(v GetGatewayConnectionArgs) (GetGatewayConnectionResult, error) {
		r, err := GetGatewayConnection(ctx, &v, opts...)
		return *r, err

	}).(GetGatewayConnectionResultOutput)
}

// GetGatewayConnectionApplyInput is an input type that accepts GetGatewayConnectionApplyArgs and GetGatewayConnectionApplyOutput values.
// You can construct a concrete instance of `GetGatewayConnectionApplyInput` via:
//
//          GetGatewayConnectionApplyArgs{...}
type GetGatewayConnectionApplyInput interface {
	pulumi.Input

	ToGetGatewayConnectionApplyOutput() GetGatewayConnectionApplyOutput
	ToGetGatewayConnectionApplyOutputWithContext(context.Context) GetGatewayConnectionApplyOutput
}

// A collection of arguments for invoking getGatewayConnection.
type GetGatewayConnectionApplyArgs struct {
	// Specifies the name of the Virtual Network Gateway Connection.
...
func (GetGatewayConnectionApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetGatewayConnectionArgs)(nil)).Elem()
}

func (i GetGatewayConnectionApplyArgs) ToGetGatewayConnectionApplyOutput() GetGatewayConnectionApplyOutput {
	return i.ToGetGatewayConnectionApplyOutputWithContext(context.Background())
}

func (i GetGatewayConnectionApplyArgs) ToGetGatewayConnectionApplyOutputWithContext(ctx context.Context) GetGatewayConnectionApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetGatewayConnectionApplyOutput)
}

// A collection of arguments for invoking getGatewayConnection.
type GetGatewayConnectionApplyOutput struct{ *pulumi.OutputState }

func (GetGatewayConnectionApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetGatewayConnectionArgs)(nil)).Elem()
}

func (o GetGatewayConnectionApplyOutput) ToGetGatewayConnectionApplyOutput() GetGatewayConnectionApplyOutput {
	return o
}

func (o GetGatewayConnectionApplyOutput) ToGetGatewayConnectionApplyOutputWithContext(ctx context.Context) GetGatewayConnectionApplyOutput {
	return o
}

// Specifies the name of the Virtual Network Gateway Connection.
func (o GetGatewayConnectionApplyOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v GetGatewayConnectionArgs) string { return v.Name }).(pulumi.StringOutput)
}

// Specifies the name of the resource group the Virtual Network Gateway Connection is located in.
func (o GetGatewayConnectionApplyOutput) ResourceGroupName() pulumi.StringOutput {
	return o.ApplyT(func(v GetGatewayConnectionArgs) string { return v.ResourceGroupName }).(pulumi.StringOutput)
}
...
func init() {
	pulumi.RegisterOutputType(GetGatewayConnectionApplyOutput{})
