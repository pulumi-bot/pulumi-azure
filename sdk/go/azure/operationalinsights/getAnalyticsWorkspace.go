...
func LookupAnalyticsWorkspaceApply(ctx *pulumi.Context, args LookupAnalyticsWorkspaceApplyInput, opts ...pulumi.InvokeOption) LookupAnalyticsWorkspaceResultOutput {
	return args.ToLookupAnalyticsWorkspaceApplyOutput().ApplyT(func(v LookupAnalyticsWorkspaceArgs) (LookupAnalyticsWorkspaceResult, error) {
		r, err := LookupAnalyticsWorkspace(ctx, &v, opts...)
		return *r, err

	}).(LookupAnalyticsWorkspaceResultOutput)
}

// LookupAnalyticsWorkspaceApplyInput is an input type that accepts LookupAnalyticsWorkspaceApplyArgs and LookupAnalyticsWorkspaceApplyOutput values.
// You can construct a concrete instance of `LookupAnalyticsWorkspaceApplyInput` via:
//
//          LookupAnalyticsWorkspaceApplyArgs{...}
type LookupAnalyticsWorkspaceApplyInput interface {
	pulumi.Input

	ToLookupAnalyticsWorkspaceApplyOutput() LookupAnalyticsWorkspaceApplyOutput
	ToLookupAnalyticsWorkspaceApplyOutputWithContext(context.Context) LookupAnalyticsWorkspaceApplyOutput
}

// A collection of arguments for invoking getAnalyticsWorkspace.
type LookupAnalyticsWorkspaceApplyArgs struct {
	// Specifies the name of the Log Analytics Workspace.
...
func (LookupAnalyticsWorkspaceApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupAnalyticsWorkspaceArgs)(nil)).Elem()
}

func (i LookupAnalyticsWorkspaceApplyArgs) ToLookupAnalyticsWorkspaceApplyOutput() LookupAnalyticsWorkspaceApplyOutput {
	return i.ToLookupAnalyticsWorkspaceApplyOutputWithContext(context.Background())
}

func (i LookupAnalyticsWorkspaceApplyArgs) ToLookupAnalyticsWorkspaceApplyOutputWithContext(ctx context.Context) LookupAnalyticsWorkspaceApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupAnalyticsWorkspaceApplyOutput)
}

// A collection of arguments for invoking getAnalyticsWorkspace.
type LookupAnalyticsWorkspaceApplyOutput struct{ *pulumi.OutputState }

func (LookupAnalyticsWorkspaceApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupAnalyticsWorkspaceArgs)(nil)).Elem()
}

func (o LookupAnalyticsWorkspaceApplyOutput) ToLookupAnalyticsWorkspaceApplyOutput() LookupAnalyticsWorkspaceApplyOutput {
	return o
}

func (o LookupAnalyticsWorkspaceApplyOutput) ToLookupAnalyticsWorkspaceApplyOutputWithContext(ctx context.Context) LookupAnalyticsWorkspaceApplyOutput {
	return o
}

// Specifies the name of the Log Analytics Workspace.
func (o LookupAnalyticsWorkspaceApplyOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v LookupAnalyticsWorkspaceArgs) string { return v.Name }).(pulumi.StringOutput)
}

// The name of the resource group in which the Log Analytics workspace is located in.
func (o LookupAnalyticsWorkspaceApplyOutput) ResourceGroupName() pulumi.StringOutput {
	return o.ApplyT(func(v LookupAnalyticsWorkspaceArgs) string { return v.ResourceGroupName }).(pulumi.StringOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupAnalyticsWorkspaceApplyOutput{})
