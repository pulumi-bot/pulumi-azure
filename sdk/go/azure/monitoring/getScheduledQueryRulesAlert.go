...
func LookupScheduledQueryRulesAlertApply(ctx *pulumi.Context, args LookupScheduledQueryRulesAlertApplyInput, opts ...pulumi.InvokeOption) LookupScheduledQueryRulesAlertResultOutput {
	return args.ToLookupScheduledQueryRulesAlertApplyOutput().ApplyT(func(v LookupScheduledQueryRulesAlertArgs) (LookupScheduledQueryRulesAlertResult, error) {
		r, err := LookupScheduledQueryRulesAlert(ctx, &v, opts...)
		return *r, err

	}).(LookupScheduledQueryRulesAlertResultOutput)
}

// LookupScheduledQueryRulesAlertApplyInput is an input type that accepts LookupScheduledQueryRulesAlertApplyArgs and LookupScheduledQueryRulesAlertApplyOutput values.
// You can construct a concrete instance of `LookupScheduledQueryRulesAlertApplyInput` via:
//
//          LookupScheduledQueryRulesAlertApplyArgs{...}
type LookupScheduledQueryRulesAlertApplyInput interface {
	pulumi.Input

	ToLookupScheduledQueryRulesAlertApplyOutput() LookupScheduledQueryRulesAlertApplyOutput
	ToLookupScheduledQueryRulesAlertApplyOutputWithContext(context.Context) LookupScheduledQueryRulesAlertApplyOutput
}

// A collection of arguments for invoking getScheduledQueryRulesAlert.
type LookupScheduledQueryRulesAlertApplyArgs struct {
	// Specifies the name of the scheduled query rule.
...
func (LookupScheduledQueryRulesAlertApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupScheduledQueryRulesAlertArgs)(nil)).Elem()
}

func (i LookupScheduledQueryRulesAlertApplyArgs) ToLookupScheduledQueryRulesAlertApplyOutput() LookupScheduledQueryRulesAlertApplyOutput {
	return i.ToLookupScheduledQueryRulesAlertApplyOutputWithContext(context.Background())
}

func (i LookupScheduledQueryRulesAlertApplyArgs) ToLookupScheduledQueryRulesAlertApplyOutputWithContext(ctx context.Context) LookupScheduledQueryRulesAlertApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupScheduledQueryRulesAlertApplyOutput)
}

// A collection of arguments for invoking getScheduledQueryRulesAlert.
type LookupScheduledQueryRulesAlertApplyOutput struct{ *pulumi.OutputState }

func (LookupScheduledQueryRulesAlertApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupScheduledQueryRulesAlertArgs)(nil)).Elem()
}

func (o LookupScheduledQueryRulesAlertApplyOutput) ToLookupScheduledQueryRulesAlertApplyOutput() LookupScheduledQueryRulesAlertApplyOutput {
	return o
}

func (o LookupScheduledQueryRulesAlertApplyOutput) ToLookupScheduledQueryRulesAlertApplyOutputWithContext(ctx context.Context) LookupScheduledQueryRulesAlertApplyOutput {
	return o
}

// Specifies the name of the scheduled query rule.
func (o LookupScheduledQueryRulesAlertApplyOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v LookupScheduledQueryRulesAlertArgs) string { return v.Name }).(pulumi.StringOutput)
}

// Specifies the name of the resource group where the scheduled query rule is located.
func (o LookupScheduledQueryRulesAlertApplyOutput) ResourceGroupName() pulumi.StringOutput {
	return o.ApplyT(func(v LookupScheduledQueryRulesAlertArgs) string { return v.ResourceGroupName }).(pulumi.StringOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupScheduledQueryRulesAlertApplyOutput{})
