...
func LookupFunctionAppApply(ctx *pulumi.Context, args LookupFunctionAppApplyInput, opts ...pulumi.InvokeOption) LookupFunctionAppResultOutput {
	return args.ToLookupFunctionAppApplyOutput().ApplyT(func(v LookupFunctionAppArgs) (LookupFunctionAppResult, error) {
		r, err := LookupFunctionApp(ctx, &v, opts...)
		return *r, err

	}).(LookupFunctionAppResultOutput)
}

// LookupFunctionAppApplyInput is an input type that accepts LookupFunctionAppApplyArgs and LookupFunctionAppApplyOutput values.
// You can construct a concrete instance of `LookupFunctionAppApplyInput` via:
//
//          LookupFunctionAppApplyArgs{...}
type LookupFunctionAppApplyInput interface {
	pulumi.Input

	ToLookupFunctionAppApplyOutput() LookupFunctionAppApplyOutput
	ToLookupFunctionAppApplyOutputWithContext(context.Context) LookupFunctionAppApplyOutput
}

// A collection of arguments for invoking getFunctionApp.
type LookupFunctionAppApplyArgs struct {
	// The name of the Function App resource.
...
func (LookupFunctionAppApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupFunctionAppArgs)(nil)).Elem()
}

func (i LookupFunctionAppApplyArgs) ToLookupFunctionAppApplyOutput() LookupFunctionAppApplyOutput {
	return i.ToLookupFunctionAppApplyOutputWithContext(context.Background())
}

func (i LookupFunctionAppApplyArgs) ToLookupFunctionAppApplyOutputWithContext(ctx context.Context) LookupFunctionAppApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupFunctionAppApplyOutput)
}

// A collection of arguments for invoking getFunctionApp.
type LookupFunctionAppApplyOutput struct{ *pulumi.OutputState }

func (LookupFunctionAppApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupFunctionAppArgs)(nil)).Elem()
}

func (o LookupFunctionAppApplyOutput) ToLookupFunctionAppApplyOutput() LookupFunctionAppApplyOutput {
	return o
}

func (o LookupFunctionAppApplyOutput) ToLookupFunctionAppApplyOutputWithContext(ctx context.Context) LookupFunctionAppApplyOutput {
	return o
}

// The name of the Function App resource.
func (o LookupFunctionAppApplyOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v LookupFunctionAppArgs) string { return v.Name }).(pulumi.StringOutput)
}

// The name of the Resource Group where the Function App exists.
func (o LookupFunctionAppApplyOutput) ResourceGroupName() pulumi.StringOutput {
	return o.ApplyT(func(v LookupFunctionAppArgs) string { return v.ResourceGroupName }).(pulumi.StringOutput)
}

func (o LookupFunctionAppApplyOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupFunctionAppArgs) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupFunctionAppApplyOutput{})
