...
func LookupAppServiceApply(ctx *pulumi.Context, args LookupAppServiceApplyInput, opts ...pulumi.InvokeOption) LookupAppServiceResultOutput {
	return args.ToLookupAppServiceApplyOutput().ApplyT(func(v LookupAppServiceArgs) (LookupAppServiceResult, error) {
		r, err := LookupAppService(ctx, &v, opts...)
		return *r, err

	}).(LookupAppServiceResultOutput)
}

// LookupAppServiceApplyInput is an input type that accepts LookupAppServiceApplyArgs and LookupAppServiceApplyOutput values.
// You can construct a concrete instance of `LookupAppServiceApplyInput` via:
//
//          LookupAppServiceApplyArgs{...}
type LookupAppServiceApplyInput interface {
	pulumi.Input

	ToLookupAppServiceApplyOutput() LookupAppServiceApplyOutput
	ToLookupAppServiceApplyOutputWithContext(context.Context) LookupAppServiceApplyOutput
}

// A collection of arguments for invoking getAppService.
type LookupAppServiceApplyArgs struct {
	// The name of the App Service.
...
func (LookupAppServiceApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupAppServiceArgs)(nil)).Elem()
}

func (i LookupAppServiceApplyArgs) ToLookupAppServiceApplyOutput() LookupAppServiceApplyOutput {
	return i.ToLookupAppServiceApplyOutputWithContext(context.Background())
}

func (i LookupAppServiceApplyArgs) ToLookupAppServiceApplyOutputWithContext(ctx context.Context) LookupAppServiceApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupAppServiceApplyOutput)
}

// A collection of arguments for invoking getAppService.
type LookupAppServiceApplyOutput struct{ *pulumi.OutputState }

func (LookupAppServiceApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupAppServiceArgs)(nil)).Elem()
}

func (o LookupAppServiceApplyOutput) ToLookupAppServiceApplyOutput() LookupAppServiceApplyOutput {
	return o
}

func (o LookupAppServiceApplyOutput) ToLookupAppServiceApplyOutputWithContext(ctx context.Context) LookupAppServiceApplyOutput {
	return o
}

// The name of the App Service.
func (o LookupAppServiceApplyOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v LookupAppServiceArgs) string { return v.Name }).(pulumi.StringOutput)
}

// The Name of the Resource Group where the App Service exists.
func (o LookupAppServiceApplyOutput) ResourceGroupName() pulumi.StringOutput {
	return o.ApplyT(func(v LookupAppServiceArgs) string { return v.ResourceGroupName }).(pulumi.StringOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupAppServiceApplyOutput{})
