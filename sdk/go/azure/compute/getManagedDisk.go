...
func LookupManagedDiskApply(ctx *pulumi.Context, args LookupManagedDiskApplyInput, opts ...pulumi.InvokeOption) LookupManagedDiskResultOutput {
	return args.ToLookupManagedDiskApplyOutput().ApplyT(func(v LookupManagedDiskArgs) (LookupManagedDiskResult, error) {
		r, err := LookupManagedDisk(ctx, &v, opts...)
		return *r, err

	}).(LookupManagedDiskResultOutput)
}

// LookupManagedDiskApplyInput is an input type that accepts LookupManagedDiskApplyArgs and LookupManagedDiskApplyOutput values.
// You can construct a concrete instance of `LookupManagedDiskApplyInput` via:
//
//          LookupManagedDiskApplyArgs{...}
type LookupManagedDiskApplyInput interface {
	pulumi.Input

	ToLookupManagedDiskApplyOutput() LookupManagedDiskApplyOutput
	ToLookupManagedDiskApplyOutputWithContext(context.Context) LookupManagedDiskApplyOutput
}

// A collection of arguments for invoking getManagedDisk.
type LookupManagedDiskApplyArgs struct {
	// Specifies the name of the Managed Disk.
...
func (LookupManagedDiskApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupManagedDiskArgs)(nil)).Elem()
}

func (i LookupManagedDiskApplyArgs) ToLookupManagedDiskApplyOutput() LookupManagedDiskApplyOutput {
	return i.ToLookupManagedDiskApplyOutputWithContext(context.Background())
}

func (i LookupManagedDiskApplyArgs) ToLookupManagedDiskApplyOutputWithContext(ctx context.Context) LookupManagedDiskApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupManagedDiskApplyOutput)
}

// A collection of arguments for invoking getManagedDisk.
type LookupManagedDiskApplyOutput struct{ *pulumi.OutputState }

func (LookupManagedDiskApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupManagedDiskArgs)(nil)).Elem()
}

func (o LookupManagedDiskApplyOutput) ToLookupManagedDiskApplyOutput() LookupManagedDiskApplyOutput {
	return o
}

func (o LookupManagedDiskApplyOutput) ToLookupManagedDiskApplyOutputWithContext(ctx context.Context) LookupManagedDiskApplyOutput {
	return o
}

// Specifies the name of the Managed Disk.
func (o LookupManagedDiskApplyOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v LookupManagedDiskArgs) string { return v.Name }).(pulumi.StringOutput)
}

// Specifies the name of the Resource Group where this Managed Disk exists.
func (o LookupManagedDiskApplyOutput) ResourceGroupName() pulumi.StringOutput {
	return o.ApplyT(func(v LookupManagedDiskArgs) string { return v.ResourceGroupName }).(pulumi.StringOutput)
}

// A mapping of tags assigned to the resource.
func (o LookupManagedDiskApplyOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupManagedDiskArgs) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}

// A list of Availability Zones where the Managed Disk exists.
func (o LookupManagedDiskApplyOutput) Zones() pulumi.StringArrayOutput {
	return o.ApplyT(func(v LookupManagedDiskArgs) []string { return v.Zones }).(pulumi.StringArrayOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupManagedDiskApplyOutput{})
