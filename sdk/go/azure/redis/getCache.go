...
func LookupCacheApply(ctx *pulumi.Context, args LookupCacheApplyInput, opts ...pulumi.InvokeOption) LookupCacheResultOutput {
	return args.ToLookupCacheApplyOutput().ApplyT(func(v LookupCacheArgs) (LookupCacheResult, error) {
		r, err := LookupCache(ctx, &v, opts...)
		return *r, err

	}).(LookupCacheResultOutput)
}

// LookupCacheApplyInput is an input type that accepts LookupCacheApplyArgs and LookupCacheApplyOutput values.
// You can construct a concrete instance of `LookupCacheApplyInput` via:
//
//          LookupCacheApplyArgs{...}
type LookupCacheApplyInput interface {
	pulumi.Input

	ToLookupCacheApplyOutput() LookupCacheApplyOutput
	ToLookupCacheApplyOutputWithContext(context.Context) LookupCacheApplyOutput
}

// A collection of arguments for invoking getCache.
type LookupCacheApplyArgs struct {
	// The name of the Redis cache
...
func (LookupCacheApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupCacheArgs)(nil)).Elem()
}

func (i LookupCacheApplyArgs) ToLookupCacheApplyOutput() LookupCacheApplyOutput {
	return i.ToLookupCacheApplyOutputWithContext(context.Background())
}

func (i LookupCacheApplyArgs) ToLookupCacheApplyOutputWithContext(ctx context.Context) LookupCacheApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupCacheApplyOutput)
}

// A collection of arguments for invoking getCache.
type LookupCacheApplyOutput struct{ *pulumi.OutputState }

func (LookupCacheApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupCacheArgs)(nil)).Elem()
}

func (o LookupCacheApplyOutput) ToLookupCacheApplyOutput() LookupCacheApplyOutput {
	return o
}

func (o LookupCacheApplyOutput) ToLookupCacheApplyOutputWithContext(ctx context.Context) LookupCacheApplyOutput {
	return o
}

// The name of the Redis cache
func (o LookupCacheApplyOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v LookupCacheArgs) string { return v.Name }).(pulumi.StringOutput)
}

// The name of the resource group the Redis cache instance is located in.
func (o LookupCacheApplyOutput) ResourceGroupName() pulumi.StringOutput {
	return o.ApplyT(func(v LookupCacheArgs) string { return v.ResourceGroupName }).(pulumi.StringOutput)
}

func (o LookupCacheApplyOutput) Zones() pulumi.StringArrayOutput {
	return o.ApplyT(func(v LookupCacheArgs) []string { return v.Zones }).(pulumi.StringArrayOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupCacheApplyOutput{})
