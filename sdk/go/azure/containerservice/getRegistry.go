...
func LookupRegistryApply(ctx *pulumi.Context, args LookupRegistryApplyInput, opts ...pulumi.InvokeOption) LookupRegistryResultOutput {
	return args.ToLookupRegistryApplyOutput().ApplyT(func(v LookupRegistryArgs) (LookupRegistryResult, error) {
		r, err := LookupRegistry(ctx, &v, opts...)
		return *r, err

	}).(LookupRegistryResultOutput)
}

// LookupRegistryApplyInput is an input type that accepts LookupRegistryApplyArgs and LookupRegistryApplyOutput values.
// You can construct a concrete instance of `LookupRegistryApplyInput` via:
//
//          LookupRegistryApplyArgs{...}
type LookupRegistryApplyInput interface {
	pulumi.Input

	ToLookupRegistryApplyOutput() LookupRegistryApplyOutput
	ToLookupRegistryApplyOutputWithContext(context.Context) LookupRegistryApplyOutput
}

// A collection of arguments for invoking getRegistry.
type LookupRegistryApplyArgs struct {
	// The name of the Container Registry.
...
func (LookupRegistryApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupRegistryArgs)(nil)).Elem()
}

func (i LookupRegistryApplyArgs) ToLookupRegistryApplyOutput() LookupRegistryApplyOutput {
	return i.ToLookupRegistryApplyOutputWithContext(context.Background())
}

func (i LookupRegistryApplyArgs) ToLookupRegistryApplyOutputWithContext(ctx context.Context) LookupRegistryApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupRegistryApplyOutput)
}

// A collection of arguments for invoking getRegistry.
type LookupRegistryApplyOutput struct{ *pulumi.OutputState }

func (LookupRegistryApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupRegistryArgs)(nil)).Elem()
}

func (o LookupRegistryApplyOutput) ToLookupRegistryApplyOutput() LookupRegistryApplyOutput {
	return o
}

func (o LookupRegistryApplyOutput) ToLookupRegistryApplyOutputWithContext(ctx context.Context) LookupRegistryApplyOutput {
	return o
}

// The name of the Container Registry.
func (o LookupRegistryApplyOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v LookupRegistryArgs) string { return v.Name }).(pulumi.StringOutput)
}

// The Name of the Resource Group where this Container Registry exists.
func (o LookupRegistryApplyOutput) ResourceGroupName() pulumi.StringOutput {
	return o.ApplyT(func(v LookupRegistryArgs) string { return v.ResourceGroupName }).(pulumi.StringOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupRegistryApplyOutput{})
