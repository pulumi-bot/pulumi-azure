...
func GetClusterNodePoolApply(ctx *pulumi.Context, args GetClusterNodePoolApplyInput, opts ...pulumi.InvokeOption) GetClusterNodePoolResultOutput {
	return args.ToGetClusterNodePoolApplyOutput().ApplyT(func(v GetClusterNodePoolArgs) (GetClusterNodePoolResult, error) {
		r, err := GetClusterNodePool(ctx, &v, opts...)
		return *r, err

	}).(GetClusterNodePoolResultOutput)
}

// GetClusterNodePoolApplyInput is an input type that accepts GetClusterNodePoolApplyArgs and GetClusterNodePoolApplyOutput values.
// You can construct a concrete instance of `GetClusterNodePoolApplyInput` via:
//
//          GetClusterNodePoolApplyArgs{...}
type GetClusterNodePoolApplyInput interface {
	pulumi.Input

	ToGetClusterNodePoolApplyOutput() GetClusterNodePoolApplyOutput
	ToGetClusterNodePoolApplyOutputWithContext(context.Context) GetClusterNodePoolApplyOutput
}

// A collection of arguments for invoking getClusterNodePool.
type GetClusterNodePoolApplyArgs struct {
	// The Name of the Kubernetes Cluster where this Node Pool is located.
...
func (GetClusterNodePoolApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetClusterNodePoolArgs)(nil)).Elem()
}

func (i GetClusterNodePoolApplyArgs) ToGetClusterNodePoolApplyOutput() GetClusterNodePoolApplyOutput {
	return i.ToGetClusterNodePoolApplyOutputWithContext(context.Background())
}

func (i GetClusterNodePoolApplyArgs) ToGetClusterNodePoolApplyOutputWithContext(ctx context.Context) GetClusterNodePoolApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetClusterNodePoolApplyOutput)
}

// A collection of arguments for invoking getClusterNodePool.
type GetClusterNodePoolApplyOutput struct{ *pulumi.OutputState }

func (GetClusterNodePoolApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetClusterNodePoolArgs)(nil)).Elem()
}

func (o GetClusterNodePoolApplyOutput) ToGetClusterNodePoolApplyOutput() GetClusterNodePoolApplyOutput {
	return o
}

func (o GetClusterNodePoolApplyOutput) ToGetClusterNodePoolApplyOutputWithContext(ctx context.Context) GetClusterNodePoolApplyOutput {
	return o
}

// The Name of the Kubernetes Cluster where this Node Pool is located.
func (o GetClusterNodePoolApplyOutput) KubernetesClusterName() pulumi.StringOutput {
	return o.ApplyT(func(v GetClusterNodePoolArgs) string { return v.KubernetesClusterName }).(pulumi.StringOutput)
}

// The name of this Kubernetes Cluster Node Pool.
func (o GetClusterNodePoolApplyOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v GetClusterNodePoolArgs) string { return v.Name }).(pulumi.StringOutput)
}

// The name of the Resource Group where the Kubernetes Cluster exists.
func (o GetClusterNodePoolApplyOutput) ResourceGroupName() pulumi.StringOutput {
	return o.ApplyT(func(v GetClusterNodePoolArgs) string { return v.ResourceGroupName }).(pulumi.StringOutput)
}
...
func init() {
	pulumi.RegisterOutputType(GetClusterNodePoolApplyOutput{})
