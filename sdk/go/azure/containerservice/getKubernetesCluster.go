...
func LookupKubernetesClusterApply(ctx *pulumi.Context, args LookupKubernetesClusterApplyInput, opts ...pulumi.InvokeOption) LookupKubernetesClusterResultOutput {
	return args.ToLookupKubernetesClusterApplyOutput().ApplyT(func(v LookupKubernetesClusterArgs) (LookupKubernetesClusterResult, error) {
		r, err := LookupKubernetesCluster(ctx, &v, opts...)
		return *r, err

	}).(LookupKubernetesClusterResultOutput)
}

// LookupKubernetesClusterApplyInput is an input type that accepts LookupKubernetesClusterApplyArgs and LookupKubernetesClusterApplyOutput values.
// You can construct a concrete instance of `LookupKubernetesClusterApplyInput` via:
//
//          LookupKubernetesClusterApplyArgs{...}
type LookupKubernetesClusterApplyInput interface {
	pulumi.Input

	ToLookupKubernetesClusterApplyOutput() LookupKubernetesClusterApplyOutput
	ToLookupKubernetesClusterApplyOutputWithContext(context.Context) LookupKubernetesClusterApplyOutput
}

// A collection of arguments for invoking getKubernetesCluster.
type LookupKubernetesClusterApplyArgs struct {
	// The name of the managed Kubernetes Cluster.
...
func (LookupKubernetesClusterApplyArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupKubernetesClusterArgs)(nil)).Elem()
}

func (i LookupKubernetesClusterApplyArgs) ToLookupKubernetesClusterApplyOutput() LookupKubernetesClusterApplyOutput {
	return i.ToLookupKubernetesClusterApplyOutputWithContext(context.Background())
}

func (i LookupKubernetesClusterApplyArgs) ToLookupKubernetesClusterApplyOutputWithContext(ctx context.Context) LookupKubernetesClusterApplyOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LookupKubernetesClusterApplyOutput)
}

// A collection of arguments for invoking getKubernetesCluster.
type LookupKubernetesClusterApplyOutput struct{ *pulumi.OutputState }

func (LookupKubernetesClusterApplyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LookupKubernetesClusterArgs)(nil)).Elem()
}

func (o LookupKubernetesClusterApplyOutput) ToLookupKubernetesClusterApplyOutput() LookupKubernetesClusterApplyOutput {
	return o
}

func (o LookupKubernetesClusterApplyOutput) ToLookupKubernetesClusterApplyOutputWithContext(ctx context.Context) LookupKubernetesClusterApplyOutput {
	return o
}

// The name of the managed Kubernetes Cluster.
func (o LookupKubernetesClusterApplyOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v LookupKubernetesClusterArgs) string { return v.Name }).(pulumi.StringOutput)
}

// The name of the Resource Group in which the managed Kubernetes Cluster exists.
func (o LookupKubernetesClusterApplyOutput) ResourceGroupName() pulumi.StringOutput {
	return o.ApplyT(func(v LookupKubernetesClusterArgs) string { return v.ResourceGroupName }).(pulumi.StringOutput)
}
...
func init() {
	pulumi.RegisterOutputType(LookupKubernetesClusterApplyOutput{})
