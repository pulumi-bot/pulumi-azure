...
// The name of the resource group in which the Recovery Services Vault resides.
func (o LookupVaultApplyOutput) ResourceGroupName() pulumi.StringOutput {
	return o.ApplyT(func(v LookupVaultArgs) string { return v.ResourceGroupName }).(pulumi.StringOutput)
}
