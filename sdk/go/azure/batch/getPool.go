...
// One or more `certificate` blocks that describe the certificates installed on each compute node in the pool.
func (o LookupPoolApplyOutput) Certificates() GetPoolCertificateArrayOutput {
	return o.ApplyT(func(v LookupPoolArgs) []GetPoolCertificate { return v.Certificates }).(GetPoolCertificateArrayOutput)
}
...
// A `startTask` block that describes the start task settings for the Batch pool.
func (o LookupPoolApplyOutput) StartTask() GetPoolStartTaskPtrOutput {
	return o.ApplyT(func(v LookupPoolArgs) *GetPoolStartTask { return v.StartTask }).(GetPoolStartTaskPtrOutput)
}
