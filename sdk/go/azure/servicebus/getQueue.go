...
// The name of the ServiceBus Namespace.
func (o LookupQueueApplyOutput) NamespaceName() pulumi.StringOutput {
	return o.ApplyT(func(v LookupQueueArgs) string { return v.NamespaceName }).(pulumi.StringOutput)
}

// The name of the Resource Group where the Service Bus Queue exists.
func (o LookupQueueApplyOutput) ResourceGroupName() pulumi.StringOutput {
	return o.ApplyT(func(v LookupQueueArgs) string { return v.ResourceGroupName }).(pulumi.StringOutput)
}
