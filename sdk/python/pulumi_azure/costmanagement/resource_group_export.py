...
class ResourceGroupExport(pulumi.CustomResource):
    active: pulumi.Output[Optional[bool]] = pulumi.output_property("active")
    """
    Is the cost management export active? Default is `true`.
    """
    delivery_info: pulumi.Output['outputs.ResourceGroupExportDeliveryInfo'] = pulumi.output_property("deliveryInfo")
    """
    ...
    """
    query: pulumi.Output['outputs.ResourceGroupExportQuery'] = pulumi.output_property("query")
    """
    A `query` block as defined below.
    """
    recurrence_period_end: pulumi.Output[str] = pulumi.output_property("recurrencePeriodEnd")
    """
    The date the export will stop capturing information.
    """
    recurrence_period_start: pulumi.Output[str] = pulumi.output_property("recurrencePeriodStart")
    """
    The date the export will start capturing information.
    """
    recurrence_type: pulumi.Output[str] = pulumi.output_property("recurrenceType")
    """
    How often the requested information will be exported. Valid values include `Annually`, `Daily`, `Monthly`, `Weekly`.
    """
    resource_group_id: pulumi.Output[str] = pulumi.output_property("resourceGroupId")
    """
    The id of the resource group in which to export information.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, active: Optional[pulumi.Input[bool]] = None, delivery_info: Optional[pulumi.Input[pulumi.InputType['ResourceGroupExportDeliveryInfoArgs']]] = None, name: Optional[pulumi.Input[str]] = None, query: Optional[pulumi.Input[pulumi.InputType['ResourceGroupExportQueryArgs']]] = None, recurrence_period_end: Optional[pulumi.Input[str]] = None, recurrence_period_start: Optional[pulumi.Input[str]] = None, recurrence_type: Optional[pulumi.Input[str]] = None, resource_group_id: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, active: Optional[pulumi.Input[bool]] = None, delivery_info: Optional[pulumi.Input[pulumi.InputType['ResourceGroupExportDeliveryInfoArgs']]] = None, name: Optional[pulumi.Input[str]] = None, query: Optional[pulumi.Input[pulumi.InputType['ResourceGroupExportQueryArgs']]] = None, recurrence_period_end: Optional[pulumi.Input[str]] = None, recurrence_period_start: Optional[pulumi.Input[str]] = None, recurrence_type: Optional[pulumi.Input[str]] = None, resource_group_id: Optional[pulumi.Input[str]] = None) -> 'ResourceGroupExport':
        """
