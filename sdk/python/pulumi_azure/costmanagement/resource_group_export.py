...
class ResourceGroupExport(pulumi.CustomResource):
    active: pulumi.Output[Optional[bool]] = pulumi.property("active")
    """
    Is the cost management export active? Default is `true`.
    """

    delivery_info: pulumi.Output['outputs.ResourceGroupExportDeliveryInfo'] = pulumi.property("deliveryInfo")
    """
    ...
    query: pulumi.Output['outputs.ResourceGroupExportQuery'] = pulumi.property("query")
    """
    A `query` block as defined below.
    """

    recurrence_period_end: pulumi.Output[str] = pulumi.property("recurrencePeriodEnd")
    """
    The date the export will stop capturing information.
    """

    recurrence_period_start: pulumi.Output[str] = pulumi.property("recurrencePeriodStart")
    """
    The date the export will start capturing information.
    """

    recurrence_type: pulumi.Output[str] = pulumi.property("recurrenceType")
    """
    How often the requested information will be exported. Valid values include `Annually`, `Daily`, `Monthly`, `Weekly`.
    """

    resource_group_id: pulumi.Output[str] = pulumi.property("resourceGroupId")
    """
