...
class Cluster(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, add_on_features: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, azure_active_directory: Optional[pulumi.Input[pulumi.InputType['ClusterAzureActiveDirectoryArgs']]] = None, certificate: Optional[pulumi.Input[pulumi.InputType['ClusterCertificateArgs']]] = None, certificate_common_names: Optional[pulumi.Input[pulumi.InputType['ClusterCertificateCommonNamesArgs']]] = None, client_certificate_common_names: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ClusterClientCertificateCommonNameArgs']]]]] = None, client_certificate_thumbprints: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ClusterClientCertificateThumbprintArgs']]]]] = None, cluster_code_version: Optional[pulumi.Input[str]] = None, diagnostics_config: Optional[pulumi.Input[pulumi.InputType['ClusterDiagnosticsConfigArgs']]] = None, fabric_settings: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ClusterFabricSettingArgs']]]]] = None, location: Optional[pulumi.Input[str]] = None, management_endpoint: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, node_types: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ClusterNodeTypeArgs']]]]] = None, reliability_level: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, reverse_proxy_certificate: Optional[pulumi.Input[pulumi.InputType['ClusterReverseProxyCertificateArgs']]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, upgrade_mode: Optional[pulumi.Input[str]] = None, vm_image: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, add_on_features: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, azure_active_directory: Optional[pulumi.Input[pulumi.InputType['ClusterAzureActiveDirectoryArgs']]] = None, certificate: Optional[pulumi.Input[pulumi.InputType['ClusterCertificateArgs']]] = None, certificate_common_names: Optional[pulumi.Input[pulumi.InputType['ClusterCertificateCommonNamesArgs']]] = None, client_certificate_common_names: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ClusterClientCertificateCommonNameArgs']]]]] = None, client_certificate_thumbprints: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ClusterClientCertificateThumbprintArgs']]]]] = None, cluster_code_version: Optional[pulumi.Input[str]] = None, cluster_endpoint: Optional[pulumi.Input[str]] = None, diagnostics_config: Optional[pulumi.Input[pulumi.InputType['ClusterDiagnosticsConfigArgs']]] = None, fabric_settings: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ClusterFabricSettingArgs']]]]] = None, location: Optional[pulumi.Input[str]] = None, management_endpoint: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, node_types: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ClusterNodeTypeArgs']]]]] = None, reliability_level: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, reverse_proxy_certificate: Optional[pulumi.Input[pulumi.InputType['ClusterReverseProxyCertificateArgs']]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, upgrade_mode: Optional[pulumi.Input[str]] = None, vm_image: Optional[pulumi.Input[str]] = None) -> 'Cluster':
        """
