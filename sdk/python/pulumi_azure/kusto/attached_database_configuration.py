...
class AttachedDatabaseConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, cluster_name=None, cluster_resource_id=None, database_name=None, default_principal_modification_kind=None, location=None, name=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
