...
class Database(pulumi.CustomResource):
    ...
    hot_cache_period: pulumi.Output[Optional[str]] = pulumi.property("hotCachePeriod")
    """
    ...
    soft_delete_period: pulumi.Output[Optional[str]] = pulumi.property("softDeletePeriod")
    """
