...
class LinkService(pulumi.CustomResource):
    ...
    auto_approval_subscription_ids: pulumi.Output[Optional[List[str]]] = pulumi.property("autoApprovalSubscriptionIds")
    """
    A list of Subscription UUID/GUID's that will be automatically be able to use this Private Link Service.
    """

    enable_proxy_protocol: pulumi.Output[Optional[bool]] = pulumi.property("enableProxyProtocol")
    """
    Should the Private Link Service support the Proxy Protocol? Defaults to `false`.
    """

    load_balancer_frontend_ip_configuration_ids: pulumi.Output[List[str]] = pulumi.property("loadBalancerFrontendIpConfigurationIds")
    """
    ...
    nat_ip_configurations: pulumi.Output[List['outputs.LinkServiceNatIpConfiguration']] = pulumi.property("natIpConfigurations")
    """
    ...
    visibility_subscription_ids: pulumi.Output[Optional[List[str]]] = pulumi.property("visibilitySubscriptionIds")
    """
