...
class ZoneVirtualNetworkLink(pulumi.CustomResource):
    ...
    private_dns_zone_name: pulumi.Output[str] = pulumi.property("privateDnsZoneName")
    """
    The name of the Private DNS zone (without a terminating dot). Changing this forces a new resource to be created.
    """

    registration_enabled: pulumi.Output[Optional[bool]] = pulumi.property("registrationEnabled")
    """
    ...
    virtual_network_id: pulumi.Output[str] = pulumi.property("virtualNetworkId")
    """
