...
class Zone(pulumi.CustomResource):
    max_number_of_record_sets: pulumi.Output[float] = pulumi.property("maxNumberOfRecordSets")
    """
    The maximum number of record sets that can be created in this Private DNS zone.
    """

    max_number_of_virtual_network_links: pulumi.Output[float] = pulumi.property("maxNumberOfVirtualNetworkLinks")
    """
    The maximum number of virtual networks that can be linked to this Private DNS zone.
    """

    max_number_of_virtual_network_links_with_registration: pulumi.Output[float] = pulumi.property("maxNumberOfVirtualNetworkLinksWithRegistration")
    """
    ...
    number_of_record_sets: pulumi.Output[float] = pulumi.property("numberOfRecordSets")
    """
