...
@pulumi.output_type
class _GetEndpointConnectionResult(dict):
    id: str = pulumi.property("id")
    location: str = pulumi.property("location")
    name: str = pulumi.property("name")
    private_service_connections: List['outputs.GetEndpointConnectionPrivateServiceConnectionResult'] = pulumi.property("privateServiceConnections")
...
def get_endpoint_connection(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure:privatelink/getEndpointConnection:getEndpointConnection', __args__, opts=opts, typ=_GetEndpointConnectionResult).value

    return AwaitableGetEndpointConnectionResult(
        id=_utilities.get_dict_value(__ret__, 'id'),
        location=_utilities.get_dict_value(__ret__, 'location'),
        name=_utilities.get_dict_value(__ret__, 'name'),
        private_service_connections=_utilities.get_dict_value(__ret__, 'privateServiceConnections'),
