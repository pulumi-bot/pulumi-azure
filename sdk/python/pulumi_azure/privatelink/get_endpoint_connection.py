...
class GetEndpointConnectionResult:
    ...
    def __init__(__self__, id=None, location=None, name=None, private_service_connections=None, resource_group_name=None) -> None:
...
def get_endpoint_connection(name: Optional[str] = None, resource_group_name: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEndpointConnectionResult:
    """
