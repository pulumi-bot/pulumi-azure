...
class GetRecommendationsResult:
    ...
    def __init__(__self__, filter_by_categories=None, filter_by_resource_groups=None, id=None, recommendations=None) -> None:
...
def get_recommendations(filter_by_categories: Optional[List[str]] = None, filter_by_resource_groups: Optional[List[str]] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRecommendationsResult:
    """
