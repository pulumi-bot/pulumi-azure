...
class DataLakeGen2Filesystem(pulumi.CustomResource):
    ...
    """
    properties: pulumi.Output[Optional[Dict[str, str]]] = pulumi.output_property("properties")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, name: Optional[pulumi.Input[str]] = None, properties: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, storage_account_id: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        :param pulumi.Input[Dict[str, pulumi.Input[str]]] properties: A mapping of Key to Base64-Encoded Values which should be assigned to this Data Lake Gen2 File System.
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, name: Optional[pulumi.Input[str]] = None, properties: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, storage_account_id: Optional[pulumi.Input[str]] = None) -> 'DataLakeGen2Filesystem':
        """
