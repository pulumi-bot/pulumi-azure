...
class Table(pulumi.CustomResource):
    acls: pulumi.Output[Optional[List['outputs.TableAcl']]] = pulumi.output_property("acls")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, acls: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['TableAclArgs']]]]] = None, name: Optional[pulumi.Input[str]] = None, storage_account_name: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, acls: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['TableAclArgs']]]]] = None, name: Optional[pulumi.Input[str]] = None, storage_account_name: Optional[pulumi.Input[str]] = None) -> 'Table':
        """
