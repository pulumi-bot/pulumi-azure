...
class ManagementPolicy(pulumi.CustomResource):
    rules: pulumi.Output[Optional[List['outputs.ManagementPolicyRule']]] = pulumi.output_property("rules")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, rules: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ManagementPolicyRuleArgs']]]]] = None, storage_account_id: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, rules: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ManagementPolicyRuleArgs']]]]] = None, storage_account_id: Optional[pulumi.Input[str]] = None) -> 'ManagementPolicy':
        """
