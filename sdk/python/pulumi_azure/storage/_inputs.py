...
class AccountBlobPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "corsRules", cors_rules)
        pulumi.set(__self__, "deleteRetentionPolicy", delete_retention_policy)
...
class AccountBlobPropertiesCorsRuleArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "exposedHeaders", exposed_headers)
...
class AccountCustomDomainArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "useSubdomain", use_subdomain)
...
class AccountQueuePropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "corsRules", cors_rules)
        pulumi.set(__self__, "hourMetrics", hour_metrics)
        pulumi.set(__self__, "logging", logging)
        pulumi.set(__self__, "minuteMetrics", minute_metrics)
...
class AccountQueuePropertiesHourMetricsArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "includeApis", include_apis)
        pulumi.set(__self__, "retentionPolicyDays", retention_policy_days)
...
class AccountStaticWebsiteArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "error404Document", error404_document)
...
class ManagementPolicyRuleActionsArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "baseBlob", base_blob)
...
class ManagementPolicyRuleActionsBaseBlobArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "deleteAfterDaysSinceModificationGreaterThan", delete_after_days_since_modification_greater_than)
        pulumi.set(__self__, "tierToArchiveAfterDaysSinceModificationGreaterThan", tier_to_archive_after_days_since_modification_greater_than)
        pulumi.set(__self__, "tierToCoolAfterDaysSinceModificationGreaterThan", tier_to_cool_after_days_since_modification_greater_than)
...
class ManagementPolicyRuleActionsSnapshotArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "deleteAfterDaysSinceCreationGreaterThan", delete_after_days_since_creation_greater_than)
...
class ManagementPolicyRuleFiltersArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "blobTypes", blob_types)
        pulumi.set(__self__, "prefixMatches", prefix_matches)
...
class ShareAclArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "accessPolicies", access_policies)
