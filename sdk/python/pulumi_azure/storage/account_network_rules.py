...
class AccountNetworkRules(pulumi.CustomResource):
    bypasses: pulumi.Output[List[str]] = pulumi.property("bypasses")
    """
    Specifies whether traffic is bypassed for Logging/Metrics/AzureServices. Valid options are any combination of `Logging`, `Metrics`, `AzureServices`, or `None`.
    """

    default_action: pulumi.Output[str] = pulumi.property("defaultAction")
    """
    Specifies the default action of allow or deny when no other rules match. Valid options are `Deny` or `Allow`.
    """

    ip_rules: pulumi.Output[List[str]] = pulumi.property("ipRules")
    """
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[str]] = None,
            storage_account_name: Optional[pulumi.Input[str]] = None,
            virtual_network_subnet_ids: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None) -> 'AccountNetworkRules':
        """
