...
class GetPolicyResult:
    ...
    def __init__(__self__, id=None, rules=None, storage_account_id=None) -> None:
...
def get_policy(storage_account_id: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPolicyResult:
    """
