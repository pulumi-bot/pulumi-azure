...
def get_account_sas(connection_string=None, expiry=None, https_only=None, permissions=None, resource_types=None, services=None, start=None, opts=None):
    ...
    :param 'GetAccountSASPermissionsArgs' permissions: A `permissions` block as defined below.
    :param 'GetAccountSASResourceTypesArgs' resource_types: A `resource_types` block as defined below.
    :param 'GetAccountSASServicesArgs' services: A `services` block as defined below.
