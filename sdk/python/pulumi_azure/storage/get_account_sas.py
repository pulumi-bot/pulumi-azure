...
@pulumi.output_type
class _GetAccountSASResult(dict):
...
def get_account_sas(connection_string: Optional[str] = None,
    ...
    return AwaitableGetAccountSASResult(
        connection_string=_utilities.get_dict_value(__ret__, 'connectionString'),
        expiry=_utilities.get_dict_value(__ret__, 'expiry'),
        https_only=_utilities.get_dict_value(__ret__, 'httpsOnly'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        permissions=_utilities.get_dict_value(__ret__, 'permissions'),
        resource_types=_utilities.get_dict_value(__ret__, 'resourceTypes'),
        sas=_utilities.get_dict_value(__ret__, 'sas'),
        services=_utilities.get_dict_value(__ret__, 'services'),
        signed_version=_utilities.get_dict_value(__ret__, 'signedVersion'),
        start=_utilities.get_dict_value(__ret__, 'start'))
