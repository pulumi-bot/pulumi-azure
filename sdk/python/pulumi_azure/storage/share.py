...
class Share(pulumi.CustomResource):
    acls: pulumi.Output[Optional[List['outputs.ShareAcl']]] = pulumi.output_property("acls")
    """
    ...
    """
    quota: pulumi.Output[Optional[float]] = pulumi.output_property("quota")
    """
    ...
    """
    resource_manager_id: pulumi.Output[str] = pulumi.output_property("resourceManagerId")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, acls: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ShareAclArgs']]]]] = None, metadata: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, name: Optional[pulumi.Input[str]] = None, quota: Optional[pulumi.Input[float]] = None, storage_account_name: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        :param pulumi.Input[Dict[str, pulumi.Input[str]]] metadata: A mapping of MetaData for this File Share.
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, acls: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ShareAclArgs']]]]] = None, metadata: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, name: Optional[pulumi.Input[str]] = None, quota: Optional[pulumi.Input[float]] = None, resource_manager_id: Optional[pulumi.Input[str]] = None, storage_account_name: Optional[pulumi.Input[str]] = None, url: Optional[pulumi.Input[str]] = None) -> 'Share':
        """
