...
class Container(pulumi.CustomResource):
    container_access_type: pulumi.Output[Optional[str]] = pulumi.output_property("containerAccessType")
    """
    The Access Level configured for this Container. Possible values are `blob`, `container` or `private`. Defaults to `private`.
    """
    has_immutability_policy: pulumi.Output[bool] = pulumi.output_property("hasImmutabilityPolicy")
    """
    Is there an Immutability Policy configured on this Storage Container?
    """
    has_legal_hold: pulumi.Output[bool] = pulumi.output_property("hasLegalHold")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, container_access_type: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, name: Optional[pulumi.Input[str]] = None, storage_account_name: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        :param pulumi.Input[Dict[str, pulumi.Input[str]]] metadata: A mapping of MetaData for this Container.
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, container_access_type: Optional[pulumi.Input[str]] = None, has_immutability_policy: Optional[pulumi.Input[bool]] = None, has_legal_hold: Optional[pulumi.Input[bool]] = None, metadata: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, name: Optional[pulumi.Input[str]] = None, resource_manager_id: Optional[pulumi.Input[str]] = None, storage_account_name: Optional[pulumi.Input[str]] = None) -> 'Container':
        """
