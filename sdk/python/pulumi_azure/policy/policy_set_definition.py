...
class PolicySetDefinition(pulumi.CustomResource):
    ...
    """
    management_group_id: pulumi.Output[str] = pulumi.output_property("managementGroupId")
    """
    ...
    """
    management_group_name: pulumi.Output[str] = pulumi.output_property("managementGroupName")
    """
    The name of the Management Group where this policy set definition should be defined. Changing this forces a new resource to be created.
    """
    ...
    """
    policy_definition_references: pulumi.Output[List['outputs.PolicySetDefinitionPolicyDefinitionReference']] = pulumi.output_property("policyDefinitionReferences")
    """
    One or more `policy_definition_reference` blocks as defined below.
    """
    policy_definitions: pulumi.Output[str] = pulumi.output_property("policyDefinitions")
    """
    The policy definitions for the policy set definition. This is a json object representing the bundled policy definitions.
    """
    policy_type: pulumi.Output[str] = pulumi.output_property("policyType")
    """
    The policy set type. Possible values are `BuiltIn` or `Custom`. Changing this forces a new resource to be created.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, description: Optional[pulumi.Input[str]] = None, display_name: Optional[pulumi.Input[str]] = None, management_group_id: Optional[pulumi.Input[str]] = None, management_group_name: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, parameters: Optional[pulumi.Input[str]] = None, policy_definition_references: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['PolicySetDefinitionPolicyDefinitionReferenceArgs']]]]] = None, policy_definitions: Optional[pulumi.Input[str]] = None, policy_type: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, description: Optional[pulumi.Input[str]] = None, display_name: Optional[pulumi.Input[str]] = None, management_group_id: Optional[pulumi.Input[str]] = None, management_group_name: Optional[pulumi.Input[str]] = None, metadata: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, parameters: Optional[pulumi.Input[str]] = None, policy_definition_references: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['PolicySetDefinitionPolicyDefinitionReferenceArgs']]]]] = None, policy_definitions: Optional[pulumi.Input[str]] = None, policy_type: Optional[pulumi.Input[str]] = None) -> 'PolicySetDefinition':
        """
