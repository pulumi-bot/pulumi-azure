...
@pulumi.output_type
class _GetPolicySetDefinitionResult(dict):
...
def get_policy_set_definition(display_name: Optional[str] = None,
    ...
    return AwaitableGetPolicySetDefinitionResult(
        ...
        policy_definition_references=_utilities.get_dict_value(__ret__, 'policyDefinitionReferences'),
        policy_definitions=_utilities.get_dict_value(__ret__, 'policyDefinitions'),
