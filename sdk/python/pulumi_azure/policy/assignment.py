...
class Assignment(pulumi.CustomResource):
    ...
    enforcement_mode: pulumi.Output[Optional[bool]] = pulumi.property("enforcementMode")
    """
    Can be set to 'true' or 'false' to control whether the assignment is enforced (true) or not (false). Default is 'true'.
    ---
    """

    identity: pulumi.Output['outputs.AssignmentIdentity'] = pulumi.property("identity")
    """
    An `identity` block.
    """
    ...
    not_scopes: pulumi.Output[Optional[List[str]]] = pulumi.property("notScopes")
    """
    ...
    policy_definition_id: pulumi.Output[str] = pulumi.property("policyDefinitionId")
    """
