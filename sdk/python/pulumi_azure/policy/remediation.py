...
class Remediation(pulumi.CustomResource):
    location_filters: pulumi.Output[Optional[List[str]]] = pulumi.output_property("locationFilters")
    """
    ...
    """
    policy_assignment_id: pulumi.Output[str] = pulumi.output_property("policyAssignmentId")
    """
    The resource ID of the policy assignment that should be remediated.
    """
    policy_definition_reference_id: pulumi.Output[Optional[str]] = pulumi.output_property("policyDefinitionReferenceId")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, location_filters: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, name: Optional[pulumi.Input[str]] = None, policy_assignment_id: Optional[pulumi.Input[str]] = None, policy_definition_reference_id: Optional[pulumi.Input[str]] = None, scope: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, location_filters: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, name: Optional[pulumi.Input[str]] = None, policy_assignment_id: Optional[pulumi.Input[str]] = None, policy_definition_reference_id: Optional[pulumi.Input[str]] = None, scope: Optional[pulumi.Input[str]] = None) -> 'Remediation':
        """
