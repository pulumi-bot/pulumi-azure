...
class Remediation(pulumi.CustomResource):
    location_filters: pulumi.Output[Optional[List[str]]] = pulumi.property("locationFilters")
    """
    ...
    policy_assignment_id: pulumi.Output[str] = pulumi.property("policyAssignmentId")
    """
    The resource ID of the policy assignment that should be remediated.
    """

    policy_definition_reference_id: pulumi.Output[Optional[str]] = pulumi.property("policyDefinitionReferenceId")
    """
