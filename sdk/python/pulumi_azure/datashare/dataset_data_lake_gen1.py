...
class DatasetDataLakeGen1(pulumi.CustomResource):
    data_lake_store_id: pulumi.Output[str] = pulumi.property("dataLakeStoreId")
    """
    ...
    file_name: pulumi.Output[Optional[str]] = pulumi.property("fileName")
    """
    ...
    folder_path: pulumi.Output[str] = pulumi.property("folderPath")
    """
