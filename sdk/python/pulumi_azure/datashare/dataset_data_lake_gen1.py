...
class DatasetDataLakeGen1(pulumi.CustomResource):
    data_lake_store_id: pulumi.Output[str] = pulumi.output_property("dataLakeStoreId")
    """
    ...
    """
    file_name: pulumi.Output[Optional[str]] = pulumi.output_property("fileName")
    """
    ...
    """
    folder_path: pulumi.Output[str] = pulumi.output_property("folderPath")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, data_lake_store_id: Optional[pulumi.Input[str]] = None, data_share_id: Optional[pulumi.Input[str]] = None, file_name: Optional[pulumi.Input[str]] = None, folder_path: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, data_lake_store_id: Optional[pulumi.Input[str]] = None, data_share_id: Optional[pulumi.Input[str]] = None, display_name: Optional[pulumi.Input[str]] = None, file_name: Optional[pulumi.Input[str]] = None, folder_path: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None) -> 'DatasetDataLakeGen1':
        """
