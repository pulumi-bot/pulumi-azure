...
class DatasetBlobStorage(pulumi.CustomResource):
    ...
    data_share_id: pulumi.Output[str] = pulumi.property("dataShareId")
    """
    ...
    file_path: pulumi.Output[Optional[str]] = pulumi.property("filePath")
    """
    ...
    folder_path: pulumi.Output[Optional[str]] = pulumi.property("folderPath")
    """
    ...
    storage_account: pulumi.Output['outputs.DatasetBlobStorageStorageAccount'] = pulumi.property("storageAccount")
    """
