...
class HBaseCluster(pulumi.CustomResource):
    ...
    """
    component_version: pulumi.Output['outputs.HBaseClusterComponentVersion'] = pulumi.output_property("componentVersion")
    """
    A `component_version` block as defined below.
    """
    gateway: pulumi.Output['outputs.HBaseClusterGateway'] = pulumi.output_property("gateway")
    """
    ...
    """
    metastores: pulumi.Output[Optional['outputs.HBaseClusterMetastores']] = pulumi.output_property("metastores")
    """
    A `metastores` block as defined below.
    """
    monitor: pulumi.Output[Optional['outputs.HBaseClusterMonitor']] = pulumi.output_property("monitor")
    """
    ...
    """
    roles: pulumi.Output['outputs.HBaseClusterRoles'] = pulumi.output_property("roles")
    """
    ...
    """
    storage_account_gen2: pulumi.Output[Optional['outputs.HBaseClusterStorageAccountGen2']] = pulumi.output_property("storageAccountGen2")
    """
    A `storage_account_gen2` block as defined below.
    """
    storage_accounts: pulumi.Output[Optional[List['outputs.HBaseClusterStorageAccount']]] = pulumi.output_property("storageAccounts")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, cluster_version: Optional[pulumi.Input[str]] = None, component_version: Optional[pulumi.Input[pulumi.InputType['HBaseClusterComponentVersionArgs']]] = None, gateway: Optional[pulumi.Input[pulumi.InputType['HBaseClusterGatewayArgs']]] = None, location: Optional[pulumi.Input[str]] = None, metastores: Optional[pulumi.Input[pulumi.InputType['HBaseClusterMetastoresArgs']]] = None, monitor: Optional[pulumi.Input[pulumi.InputType['HBaseClusterMonitorArgs']]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, roles: Optional[pulumi.Input[pulumi.InputType['HBaseClusterRolesArgs']]] = None, storage_account_gen2: Optional[pulumi.Input[pulumi.InputType['HBaseClusterStorageAccountGen2Args']]] = None, storage_accounts: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['HBaseClusterStorageAccountArgs']]]]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, tier: Optional[pulumi.Input[str]] = None, tls_min_version: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['HBaseClusterStorageAccountArgs']]]] storage_accounts: One or more `storage_account` block as defined below.
        :param pulumi.Input[Dict[str, pulumi.Input[str]]] tags: A map of Tags which should be assigned to this HDInsight HBase Cluster.
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, cluster_version: Optional[pulumi.Input[str]] = None, component_version: Optional[pulumi.Input[pulumi.InputType['HBaseClusterComponentVersionArgs']]] = None, gateway: Optional[pulumi.Input[pulumi.InputType['HBaseClusterGatewayArgs']]] = None, https_endpoint: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, metastores: Optional[pulumi.Input[pulumi.InputType['HBaseClusterMetastoresArgs']]] = None, monitor: Optional[pulumi.Input[pulumi.InputType['HBaseClusterMonitorArgs']]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, roles: Optional[pulumi.Input[pulumi.InputType['HBaseClusterRolesArgs']]] = None, ssh_endpoint: Optional[pulumi.Input[str]] = None, storage_account_gen2: Optional[pulumi.Input[pulumi.InputType['HBaseClusterStorageAccountGen2Args']]] = None, storage_accounts: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['HBaseClusterStorageAccountArgs']]]]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, tier: Optional[pulumi.Input[str]] = None, tls_min_version: Optional[pulumi.Input[str]] = None) -> 'HBaseCluster':
        """
