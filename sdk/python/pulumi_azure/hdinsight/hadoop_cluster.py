...
class HadoopCluster(pulumi.CustomResource):
    ...
    component_version: pulumi.Output['outputs.HadoopClusterComponentVersion'] = pulumi.property("componentVersion")
    """
    A `component_version` block as defined below.
    """

    gateway: pulumi.Output['outputs.HadoopClusterGateway'] = pulumi.property("gateway")
    """
    ...
    metastores: pulumi.Output[Optional['outputs.HadoopClusterMetastores']] = pulumi.property("metastores")
    """
    A `metastores` block as defined below.
    """

    monitor: pulumi.Output[Optional['outputs.HadoopClusterMonitor']] = pulumi.property("monitor")
    """
    ...
    roles: pulumi.Output['outputs.HadoopClusterRoles'] = pulumi.property("roles")
    """
    ...
    storage_account_gen2: pulumi.Output[Optional['outputs.HadoopClusterStorageAccountGen2']] = pulumi.property("storageAccountGen2")
    """
    A `storage_account_gen2` block as defined below.
    """

    storage_accounts: pulumi.Output[Optional[List['outputs.HadoopClusterStorageAccount']]] = pulumi.property("storageAccounts")
    """
