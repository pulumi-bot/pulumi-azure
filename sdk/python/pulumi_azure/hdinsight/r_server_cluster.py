...
class RServerCluster(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def gateway(self) -> 'outputs.RServerClusterGateway':
        """
    ...
    @property
    @pulumi.getter
    def roles(self) -> 'outputs.RServerClusterRoles':
        """
    ...
    def storage_accounts(self) -> Optional[List['outputs.RServerClusterStorageAccount']]:
        """
