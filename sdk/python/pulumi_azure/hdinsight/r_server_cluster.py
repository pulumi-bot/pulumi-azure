...
class RServerCluster(pulumi.CustomResource):
    ...
    """
    gateway: pulumi.Output['outputs.RServerClusterGateway'] = pulumi.output_property("gateway")
    """
    ...
    """
    roles: pulumi.Output['outputs.RServerClusterRoles'] = pulumi.output_property("roles")
    """
    ...
    """
    storage_accounts: pulumi.Output[Optional[List['outputs.RServerClusterStorageAccount']]] = pulumi.output_property("storageAccounts")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, cluster_version: Optional[pulumi.Input[str]] = None, gateway: Optional[pulumi.Input[pulumi.InputType['RServerClusterGatewayArgs']]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, roles: Optional[pulumi.Input[pulumi.InputType['RServerClusterRolesArgs']]] = None, rstudio: Optional[pulumi.Input[bool]] = None, storage_accounts: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['RServerClusterStorageAccountArgs']]]]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, tier: Optional[pulumi.Input[str]] = None, tls_min_version: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        :param pulumi.Input[Dict[str, pulumi.Input[str]]] tags: A map of Tags which should be assigned to this HDInsight RServer Cluster.
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, cluster_version: Optional[pulumi.Input[str]] = None, edge_ssh_endpoint: Optional[pulumi.Input[str]] = None, gateway: Optional[pulumi.Input[pulumi.InputType['RServerClusterGatewayArgs']]] = None, https_endpoint: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, roles: Optional[pulumi.Input[pulumi.InputType['RServerClusterRolesArgs']]] = None, rstudio: Optional[pulumi.Input[bool]] = None, ssh_endpoint: Optional[pulumi.Input[str]] = None, storage_accounts: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['RServerClusterStorageAccountArgs']]]]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, tier: Optional[pulumi.Input[str]] = None, tls_min_version: Optional[pulumi.Input[str]] = None) -> 'RServerCluster':
        """
