...
class StormCluster(pulumi.CustomResource):
    ...
    """
    component_version: pulumi.Output['outputs.StormClusterComponentVersion'] = pulumi.output_property("componentVersion")
    """
    A `component_version` block as defined below.
    """
    gateway: pulumi.Output['outputs.StormClusterGateway'] = pulumi.output_property("gateway")
    """
    ...
    """
    metastores: pulumi.Output[Optional['outputs.StormClusterMetastores']] = pulumi.output_property("metastores")
    """
    A `metastores` block as defined below.
    """
    monitor: pulumi.Output[Optional['outputs.StormClusterMonitor']] = pulumi.output_property("monitor")
    """
    ...
    """
    roles: pulumi.Output['outputs.StormClusterRoles'] = pulumi.output_property("roles")
    """
    ...
    """
    storage_accounts: pulumi.Output[Optional[List['outputs.StormClusterStorageAccount']]] = pulumi.output_property("storageAccounts")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, cluster_version: Optional[pulumi.Input[str]] = None, component_version: Optional[pulumi.Input[pulumi.InputType['StormClusterComponentVersionArgs']]] = None, gateway: Optional[pulumi.Input[pulumi.InputType['StormClusterGatewayArgs']]] = None, location: Optional[pulumi.Input[str]] = None, metastores: Optional[pulumi.Input[pulumi.InputType['StormClusterMetastoresArgs']]] = None, monitor: Optional[pulumi.Input[pulumi.InputType['StormClusterMonitorArgs']]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, roles: Optional[pulumi.Input[pulumi.InputType['StormClusterRolesArgs']]] = None, storage_accounts: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['StormClusterStorageAccountArgs']]]]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, tier: Optional[pulumi.Input[str]] = None, tls_min_version: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        :param pulumi.Input[Dict[str, pulumi.Input[str]]] tags: A map of Tags which should be assigned to this HDInsight Storm Cluster.
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, cluster_version: Optional[pulumi.Input[str]] = None, component_version: Optional[pulumi.Input[pulumi.InputType['StormClusterComponentVersionArgs']]] = None, gateway: Optional[pulumi.Input[pulumi.InputType['StormClusterGatewayArgs']]] = None, https_endpoint: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, metastores: Optional[pulumi.Input[pulumi.InputType['StormClusterMetastoresArgs']]] = None, monitor: Optional[pulumi.Input[pulumi.InputType['StormClusterMonitorArgs']]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, roles: Optional[pulumi.Input[pulumi.InputType['StormClusterRolesArgs']]] = None, ssh_endpoint: Optional[pulumi.Input[str]] = None, storage_accounts: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['StormClusterStorageAccountArgs']]]]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, tier: Optional[pulumi.Input[str]] = None, tls_min_version: Optional[pulumi.Input[str]] = None) -> 'StormCluster':
        """
