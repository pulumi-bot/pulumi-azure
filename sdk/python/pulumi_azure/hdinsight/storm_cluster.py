...
class StormCluster(pulumi.CustomResource):
    ...
    component_version: pulumi.Output['outputs.StormClusterComponentVersion'] = pulumi.property("componentVersion")
    """
    A `component_version` block as defined below.
    """

    gateway: pulumi.Output['outputs.StormClusterGateway'] = pulumi.property("gateway")
    """
    ...
    metastores: pulumi.Output[Optional['outputs.StormClusterMetastores']] = pulumi.property("metastores")
    """
    A `metastores` block as defined below.
    """

    monitor: pulumi.Output[Optional['outputs.StormClusterMonitor']] = pulumi.property("monitor")
    """
    ...
    roles: pulumi.Output['outputs.StormClusterRoles'] = pulumi.property("roles")
    """
    ...
    storage_accounts: pulumi.Output[Optional[List['outputs.StormClusterStorageAccount']]] = pulumi.property("storageAccounts")
    """
