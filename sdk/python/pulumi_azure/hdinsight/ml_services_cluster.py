...
class MLServicesCluster(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def gateway(self) -> 'outputs.MLServicesClusterGateway':
        """
    ...
    @property
    @pulumi.getter
    def roles(self) -> 'outputs.MLServicesClusterRoles':
        """
    ...
    def storage_accounts(self) -> Optional[List['outputs.MLServicesClusterStorageAccount']]:
        """
