...
class MLServicesCluster(pulumi.CustomResource):
    ...
    gateway: pulumi.Output['outputs.MLServicesClusterGateway'] = pulumi.property("gateway")
    """
    ...
    roles: pulumi.Output['outputs.MLServicesClusterRoles'] = pulumi.property("roles")
    """
    ...
    storage_accounts: pulumi.Output[Optional[List['outputs.MLServicesClusterStorageAccount']]] = pulumi.property("storageAccounts")
    """
