...
class KafkaCluster(pulumi.CustomResource):
    ...
    component_version: pulumi.Output['outputs.KafkaClusterComponentVersion'] = pulumi.property("componentVersion")
    """
    A `component_version` block as defined below.
    """

    gateway: pulumi.Output['outputs.KafkaClusterGateway'] = pulumi.property("gateway")
    """
    ...
    metastores: pulumi.Output[Optional['outputs.KafkaClusterMetastores']] = pulumi.property("metastores")
    """
    A `metastores` block as defined below.
    """

    monitor: pulumi.Output[Optional['outputs.KafkaClusterMonitor']] = pulumi.property("monitor")
    """
    ...
    roles: pulumi.Output['outputs.KafkaClusterRoles'] = pulumi.property("roles")
    """
    ...
    storage_account_gen2: pulumi.Output[Optional['outputs.KafkaClusterStorageAccountGen2']] = pulumi.property("storageAccountGen2")
    """
    A `storage_account_gen2` block as defined below.
    """

    storage_accounts: pulumi.Output[Optional[List['outputs.KafkaClusterStorageAccount']]] = pulumi.property("storageAccounts")
    """
