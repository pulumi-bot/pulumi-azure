...
class Server(pulumi.CustomResource):
    ...
    """
    administrator_login_password: pulumi.Output[Optional[str]] = pulumi.output_property("administratorLoginPassword")
    """
    The Password associated with the `administrator_login` for the PostgreSQL Server. Required when `create_mode` is `Default`.
    """
    auto_grow_enabled: pulumi.Output[bool] = pulumi.output_property("autoGrowEnabled")
    """
    Enable/Disable auto-growing of the storage. Storage auto-grow prevents your server from running out of storage and becoming read-only. If storage auto grow is enabled, the storage automatically grows without impacting the workload. The default value if not explicitly specified is `true`.
    """
    backup_retention_days: pulumi.Output[float] = pulumi.output_property("backupRetentionDays")
    """
    ...
    """
    creation_source_server_id: pulumi.Output[Optional[str]] = pulumi.output_property("creationSourceServerId")
    """
    ...
    """
    geo_redundant_backup_enabled: pulumi.Output[bool] = pulumi.output_property("geoRedundantBackupEnabled")
    """
    ...
    """
    infrastructure_encryption_enabled: pulumi.Output[Optional[bool]] = pulumi.output_property("infrastructureEncryptionEnabled")
    """
    ...
    """
    public_network_access_enabled: pulumi.Output[Optional[bool]] = pulumi.output_property("publicNetworkAccessEnabled")
    """
    ...
    """
    restore_point_in_time: pulumi.Output[Optional[str]] = pulumi.output_property("restorePointInTime")
    """
    ...
    """
    ssl_enforcement: pulumi.Output[str] = pulumi.output_property("sslEnforcement")
    ssl_enforcement_enabled: pulumi.Output[Optional[bool]] = pulumi.output_property("sslEnforcementEnabled")
    """
    Specifies if SSL should be enforced on connections. Possible values are `true` and `false`.
    """
    ssl_minimal_tls_version_enforced: pulumi.Output[Optional[str]] = pulumi.output_property("sslMinimalTlsVersionEnforced")
    """
    ...
    """
    storage_mb: pulumi.Output[float] = pulumi.output_property("storageMb")
    """
    Max storage allowed for a server. Possible values are between `5120` MB(5GB) and `1048576` MB(1TB) for the Basic SKU and between `5120` MB(5GB) and `4194304` MB(4TB) for General Purpose/Memory Optimized SKUs. For more information see the [product documentation](https://docs.microsoft.com/en-us/rest/api/postgresql/servers/create#StorageProfile).
    """
    storage_profile: pulumi.Output['outputs.ServerStorageProfile'] = pulumi.output_property("storageProfile")
    tags: pulumi.Output[Optional[Dict[str, str]]] = pulumi.output_property("tags")
    """
    A mapping of tags to assign to the resource.
    """
    threat_detection_policy: pulumi.Output[Optional['outputs.ServerThreatDetectionPolicy']] = pulumi.output_property("threatDetectionPolicy")
    """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, administrator_login: Optional[pulumi.Input[str]] = None, administrator_login_password: Optional[pulumi.Input[str]] = None, auto_grow_enabled: Optional[pulumi.Input[bool]] = None, backup_retention_days: Optional[pulumi.Input[float]] = None, create_mode: Optional[pulumi.Input[str]] = None, creation_source_server_id: Optional[pulumi.Input[str]] = None, fqdn: Optional[pulumi.Input[str]] = None, geo_redundant_backup_enabled: Optional[pulumi.Input[bool]] = None, infrastructure_encryption_enabled: Optional[pulumi.Input[bool]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, public_network_access_enabled: Optional[pulumi.Input[bool]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, restore_point_in_time: Optional[pulumi.Input[str]] = None, sku_name: Optional[pulumi.Input[str]] = None, ssl_enforcement: Optional[pulumi.Input[str]] = None, ssl_enforcement_enabled: Optional[pulumi.Input[bool]] = None, ssl_minimal_tls_version_enforced: Optional[pulumi.Input[str]] = None, storage_mb: Optional[pulumi.Input[float]] = None, storage_profile: Optional[pulumi.Input[pulumi.InputType['ServerStorageProfileArgs']]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, threat_detection_policy: Optional[pulumi.Input[pulumi.InputType['ServerThreatDetectionPolicyArgs']]] = None, version: Optional[pulumi.Input[str]] = None) -> 'Server':
        """
