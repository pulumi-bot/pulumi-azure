...
class WebTest(pulumi.CustomResource):
    application_insights_id: pulumi.Output[str] = pulumi.output_property("applicationInsightsId")
    """
    ...
    """
    frequency: pulumi.Output[Optional[float]] = pulumi.output_property("frequency")
    """
    Interval in seconds between test runs for this WebTest. Default is `300`.
    """
    geo_locations: pulumi.Output[List[str]] = pulumi.output_property("geoLocations")
    """
    ...
    retry_enabled: pulumi.Output[Optional[bool]] = pulumi.output_property("retryEnabled")
    """
    Allow for retries should this WebTest fail.
    """
    synthetic_monitor_id: pulumi.Output[str] = pulumi.output_property("syntheticMonitorId")
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, application_insights_id: Optional[pulumi.Input[str]] = None, configuration: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, enabled: Optional[pulumi.Input[bool]] = None, frequency: Optional[pulumi.Input[float]] = None, geo_locations: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, kind: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, retry_enabled: Optional[pulumi.Input[bool]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, timeout: Optional[pulumi.Input[float]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        :param pulumi.Input[Dict[str, pulumi.Input[str]]] tags: Resource tags.
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, application_insights_id: Optional[pulumi.Input[str]] = None, configuration: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, enabled: Optional[pulumi.Input[bool]] = None, frequency: Optional[pulumi.Input[float]] = None, geo_locations: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, kind: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, retry_enabled: Optional[pulumi.Input[bool]] = None, synthetic_monitor_id: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, timeout: Optional[pulumi.Input[float]] = None) -> 'WebTest':
        """
