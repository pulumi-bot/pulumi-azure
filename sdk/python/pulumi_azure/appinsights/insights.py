...
class Insights(pulumi.CustomResource):
    ...
    """
    application_type: pulumi.Output[str] = pulumi.output_property("applicationType")
    """
    Specifies the type of Application Insights to create. Valid values are `ios` for _iOS_, `java` for _Java web_, `MobileCenter` for _App Center_, `Node.JS` for _Node.js_, `other` for _General_, `phone` for _Windows Phone_, `store` for _Windows Store_ and `web` for _ASP.NET_. Please note these values are case sensitive; unmatched values are treated as _ASP.NET_ by Azure. Changing this forces a new resource to be created.
    """
    daily_data_cap_in_gb: pulumi.Output[float] = pulumi.output_property("dailyDataCapInGb")
    """
    Specifies the Application Insights component daily data volume cap in GB.
    """
    daily_data_cap_notifications_disabled: pulumi.Output[bool] = pulumi.output_property("dailyDataCapNotificationsDisabled")
    """
    Specifies if a notification email will be send when the daily data volume cap is met.
    """
    disable_ip_masking: pulumi.Output[Optional[bool]] = pulumi.output_property("disableIpMasking")
    """
    By default the real client ip is masked as `0.0.0.0` in the logs. Use this argument to disable masking and log the real client ip. Defaults to `false`.
    """
    instrumentation_key: pulumi.Output[str] = pulumi.output_property("instrumentationKey")
    """
    ...
    """
    sampling_percentage: pulumi.Output[Optional[float]] = pulumi.output_property("samplingPercentage")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, application_type: Optional[pulumi.Input[str]] = None, daily_data_cap_in_gb: Optional[pulumi.Input[float]] = None, daily_data_cap_notifications_disabled: Optional[pulumi.Input[bool]] = None, disable_ip_masking: Optional[pulumi.Input[bool]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, retention_in_days: Optional[pulumi.Input[float]] = None, sampling_percentage: Optional[pulumi.Input[float]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, app_id: Optional[pulumi.Input[str]] = None, application_type: Optional[pulumi.Input[str]] = None, daily_data_cap_in_gb: Optional[pulumi.Input[float]] = None, daily_data_cap_notifications_disabled: Optional[pulumi.Input[bool]] = None, disable_ip_masking: Optional[pulumi.Input[bool]] = None, instrumentation_key: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, retention_in_days: Optional[pulumi.Input[float]] = None, sampling_percentage: Optional[pulumi.Input[float]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None) -> 'Insights':
        """
