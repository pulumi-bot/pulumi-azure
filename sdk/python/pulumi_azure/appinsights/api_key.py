...
class ApiKey(pulumi.CustomResource):
    ...
    """
    read_permissions: pulumi.Output[Optional[List[str]]] = pulumi.output_property("readPermissions")
    """
    Specifies the list of read permissions granted to the API key. Valid values are `agentconfig`, `aggregate`, `api`, `draft`, `extendqueries`, `search`. Please note these values are case sensitive. Changing this forces a new resource to be created.
    """
    write_permissions: pulumi.Output[Optional[List[str]]] = pulumi.output_property("writePermissions")
    """
    Specifies the list of write permissions granted to the API key. Valid values are `annotations`. Please note these values are case sensitive. Changing this forces a new resource to be created.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, application_insights_id: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, read_permissions: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, write_permissions: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, api_key: Optional[pulumi.Input[str]] = None, application_insights_id: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, read_permissions: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, write_permissions: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None) -> 'ApiKey':
        """
