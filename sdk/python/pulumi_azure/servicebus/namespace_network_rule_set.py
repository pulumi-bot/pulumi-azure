...
class NamespaceNetworkRuleSet(pulumi.CustomResource):
    default_action: pulumi.Output[Optional[str]] = pulumi.property("defaultAction")
    """
    ...
    ip_rules: pulumi.Output[Optional[List[str]]] = pulumi.property("ipRules")
    """
    ...
    network_rules: pulumi.Output[Optional[List['outputs.NamespaceNetworkRuleSetNetworkRule']]] = pulumi.property("networkRules")
    """
