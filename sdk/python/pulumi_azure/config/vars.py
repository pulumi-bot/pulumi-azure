...
class _ExportableConfig(types.ModuleType):
    @property
    def auxiliary_tenant_ids(self) -> Optional[Sequence[str]]:
    ...
    @property
    def features(self) -> Optional[pulumi.InputType['outputs.Features']]:
    ...
    @property
    def storage_use_azuread(self) -> Optional[bool]:
        """
