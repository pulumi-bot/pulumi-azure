...
class Api(pulumi.CustomResource):
    ...
    """
    import_: pulumi.Output[Optional['outputs.ApiImport']] = pulumi.output_property("import")
    """
    A `import` block as documented below.
    """
    is_current: pulumi.Output[bool] = pulumi.output_property("isCurrent")
    """
    Is this the current API Revision?
    """
    is_online: pulumi.Output[bool] = pulumi.output_property("isOnline")
    """
    ...
    """
    revision: pulumi.Output[str] = pulumi.output_property("revision")
    """
    The Revision which used for this API.
    """
    service_url: pulumi.Output[str] = pulumi.output_property("serviceUrl")
    """
    Absolute URL of the backend service implementing this API.
    """
    soap_pass_through: pulumi.Output[Optional[bool]] = pulumi.output_property("soapPassThrough")
    """
    Should this API expose a SOAP frontend, rather than a HTTP frontend? Defaults to `false`.
    """
    subscription_key_parameter_names: pulumi.Output['outputs.ApiSubscriptionKeyParameterNames'] = pulumi.output_property("subscriptionKeyParameterNames")
    """
    ...
    """
    version_set_id: pulumi.Output[str] = pulumi.output_property("versionSetId")
    """
    The ID of the Version Set which this API is associated with.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, api_management_name: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, display_name: Optional[pulumi.Input[str]] = None, import_: Optional[pulumi.Input[pulumi.InputType['ApiImportArgs']]] = None, name: Optional[pulumi.Input[str]] = None, path: Optional[pulumi.Input[str]] = None, protocols: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, revision: Optional[pulumi.Input[str]] = None, service_url: Optional[pulumi.Input[str]] = None, soap_pass_through: Optional[pulumi.Input[bool]] = None, subscription_key_parameter_names: Optional[pulumi.Input[pulumi.InputType['ApiSubscriptionKeyParameterNamesArgs']]] = None, subscription_required: Optional[pulumi.Input[bool]] = None, version: Optional[pulumi.Input[str]] = None, version_set_id: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, api_management_name: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, display_name: Optional[pulumi.Input[str]] = None, import_: Optional[pulumi.Input[pulumi.InputType['ApiImportArgs']]] = None, is_current: Optional[pulumi.Input[bool]] = None, is_online: Optional[pulumi.Input[bool]] = None, name: Optional[pulumi.Input[str]] = None, path: Optional[pulumi.Input[str]] = None, protocols: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, revision: Optional[pulumi.Input[str]] = None, service_url: Optional[pulumi.Input[str]] = None, soap_pass_through: Optional[pulumi.Input[bool]] = None, subscription_key_parameter_names: Optional[pulumi.Input[pulumi.InputType['ApiSubscriptionKeyParameterNamesArgs']]] = None, subscription_required: Optional[pulumi.Input[bool]] = None, version: Optional[pulumi.Input[str]] = None, version_set_id: Optional[pulumi.Input[str]] = None) -> 'Api':
        """
