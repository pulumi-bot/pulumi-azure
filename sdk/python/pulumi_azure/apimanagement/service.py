...
class Service(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, additional_locations: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ServiceAdditionalLocationArgs']]]]] = None, certificates: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ServiceCertificateArgs']]]]] = None, hostname_configuration: Optional[pulumi.Input[pulumi.InputType['ServiceHostnameConfigurationArgs']]] = None, identity: Optional[pulumi.Input[pulumi.InputType['ServiceIdentityArgs']]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, notification_sender_email: Optional[pulumi.Input[str]] = None, policy: Optional[pulumi.Input[pulumi.InputType['ServicePolicyArgs']]] = None, protocols: Optional[pulumi.Input[pulumi.InputType['ServiceProtocolsArgs']]] = None, publisher_email: Optional[pulumi.Input[str]] = None, publisher_name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, security: Optional[pulumi.Input[pulumi.InputType['ServiceSecurityArgs']]] = None, sign_in: Optional[pulumi.Input[pulumi.InputType['ServiceSignInArgs']]] = None, sign_up: Optional[pulumi.Input[pulumi.InputType['ServiceSignUpArgs']]] = None, sku_name: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, virtual_network_configuration: Optional[pulumi.Input[pulumi.InputType['ServiceVirtualNetworkConfigurationArgs']]] = None, virtual_network_type: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, additional_locations: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ServiceAdditionalLocationArgs']]]]] = None, certificates: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ServiceCertificateArgs']]]]] = None, developer_portal_url: Optional[pulumi.Input[str]] = None, gateway_regional_url: Optional[pulumi.Input[str]] = None, gateway_url: Optional[pulumi.Input[str]] = None, hostname_configuration: Optional[pulumi.Input[pulumi.InputType['ServiceHostnameConfigurationArgs']]] = None, identity: Optional[pulumi.Input[pulumi.InputType['ServiceIdentityArgs']]] = None, location: Optional[pulumi.Input[str]] = None, management_api_url: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, notification_sender_email: Optional[pulumi.Input[str]] = None, policy: Optional[pulumi.Input[pulumi.InputType['ServicePolicyArgs']]] = None, portal_url: Optional[pulumi.Input[str]] = None, private_ip_addresses: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, protocols: Optional[pulumi.Input[pulumi.InputType['ServiceProtocolsArgs']]] = None, public_ip_addresses: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, publisher_email: Optional[pulumi.Input[str]] = None, publisher_name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, scm_url: Optional[pulumi.Input[str]] = None, security: Optional[pulumi.Input[pulumi.InputType['ServiceSecurityArgs']]] = None, sign_in: Optional[pulumi.Input[pulumi.InputType['ServiceSignInArgs']]] = None, sign_up: Optional[pulumi.Input[pulumi.InputType['ServiceSignUpArgs']]] = None, sku_name: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, virtual_network_configuration: Optional[pulumi.Input[pulumi.InputType['ServiceVirtualNetworkConfigurationArgs']]] = None, virtual_network_type: Optional[pulumi.Input[str]] = None) -> 'Service':
        """
