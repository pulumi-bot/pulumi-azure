...
class AuthorizationServer(pulumi.CustomResource):
    ...
    authorization_endpoint: pulumi.Output[str] = pulumi.property("authorizationEndpoint")
    """
    The OAUTH Authorization Endpoint.
    """

    authorization_methods: pulumi.Output[List[str]] = pulumi.property("authorizationMethods")
    """
    The HTTP Verbs supported by the Authorization Endpoint. Possible values are `DELETE`, `GET`, `HEAD`, `OPTIONS`, `PATCH`, `POST`, `PUT` and `TRACE`.
    """

    bearer_token_sending_methods: pulumi.Output[Optional[List[str]]] = pulumi.property("bearerTokenSendingMethods")
    """
    The mechanism by which Access Tokens are passed to the API. Possible values are `authorizationHeader` and `query`.
    """

    client_authentication_methods: pulumi.Output[Optional[List[str]]] = pulumi.property("clientAuthenticationMethods")
    """
    ...
    client_registration_endpoint: pulumi.Output[str] = pulumi.property("clientRegistrationEndpoint")
    """
    ...
    default_scope: pulumi.Output[Optional[str]] = pulumi.property("defaultScope")
    """
    ...
    grant_types: pulumi.Output[List[str]] = pulumi.property("grantTypes")
    """
    ...
    resource_owner_password: pulumi.Output[Optional[str]] = pulumi.property("resourceOwnerPassword")
    """
    The password associated with the Resource Owner.
    """

    resource_owner_username: pulumi.Output[Optional[str]] = pulumi.property("resourceOwnerUsername")
    """
    The username associated with the Resource Owner.
    """

    support_state: pulumi.Output[Optional[bool]] = pulumi.property("supportState")
    """
    Does this Authorization Server support State? If this is set to `true` the client may use the state parameter to raise protocol security.
    """

    token_body_parameters: pulumi.Output[Optional[List['outputs.AuthorizationServerTokenBodyParameter']]] = pulumi.property("tokenBodyParameters")

    token_endpoint: pulumi.Output[Optional[str]] = pulumi.property("tokenEndpoint")
    """
