...
class Backend(pulumi.CustomResource):
    ...
    """
    credentials: pulumi.Output[Optional['outputs.BackendCredentials']] = pulumi.output_property("credentials")
    """
    ...
    """
    proxy: pulumi.Output[Optional['outputs.BackendProxy']] = pulumi.output_property("proxy")
    """
    ...
    """
    resource_id: pulumi.Output[Optional[str]] = pulumi.output_property("resourceId")
    """
    The management URI of the backend host in an external system. This URI can be the ARM Resource ID of Logic Apps, Function Apps or API Apps, or the management endpoint of a Service Fabric cluster.
    """
    service_fabric_cluster: pulumi.Output[Optional['outputs.BackendServiceFabricCluster']] = pulumi.output_property("serviceFabricCluster")
    """
    A `service_fabric_cluster` block as documented below.
    """
    title: pulumi.Output[Optional[str]] = pulumi.output_property("title")
    """
    The title of the backend.
    """
    tls: pulumi.Output[Optional['outputs.BackendTls']] = pulumi.output_property("tls")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, api_management_name: Optional[pulumi.Input[str]] = None, credentials: Optional[pulumi.Input[pulumi.InputType['BackendCredentialsArgs']]] = None, description: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, protocol: Optional[pulumi.Input[str]] = None, proxy: Optional[pulumi.Input[pulumi.InputType['BackendProxyArgs']]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, resource_id: Optional[pulumi.Input[str]] = None, service_fabric_cluster: Optional[pulumi.Input[pulumi.InputType['BackendServiceFabricClusterArgs']]] = None, title: Optional[pulumi.Input[str]] = None, tls: Optional[pulumi.Input[pulumi.InputType['BackendTlsArgs']]] = None, url: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, api_management_name: Optional[pulumi.Input[str]] = None, credentials: Optional[pulumi.Input[pulumi.InputType['BackendCredentialsArgs']]] = None, description: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, protocol: Optional[pulumi.Input[str]] = None, proxy: Optional[pulumi.Input[pulumi.InputType['BackendProxyArgs']]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, resource_id: Optional[pulumi.Input[str]] = None, service_fabric_cluster: Optional[pulumi.Input[pulumi.InputType['BackendServiceFabricClusterArgs']]] = None, title: Optional[pulumi.Input[str]] = None, tls: Optional[pulumi.Input[pulumi.InputType['BackendTlsArgs']]] = None, url: Optional[pulumi.Input[str]] = None) -> 'Backend':
        """
