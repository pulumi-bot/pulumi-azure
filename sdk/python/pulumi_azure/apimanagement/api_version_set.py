...
class ApiVersionSet(pulumi.CustomResource):
    ...
    version_header_name: pulumi.Output[Optional[str]] = pulumi.property("versionHeaderName")
    """
    The name of the Header which should be read from Inbound Requests which defines the API Version.
    """

    version_query_name: pulumi.Output[Optional[str]] = pulumi.property("versionQueryName")
    """
    The name of the Query String which should be read from Inbound Requests which defines the API Version.
    """

    versioning_scheme: pulumi.Output[str] = pulumi.property("versioningScheme")
    """
