...
def get_product(api_management_name: Optional[str] = None,
    ...
    return AwaitableGetProductResult(
        ...
        approval_required=_utilities.get_dict_value(__ret__, 'approvalRequired'),
        ...
        product_id=_utilities.get_dict_value(__ret__, 'productId'),
        published=_utilities.get_dict_value(__ret__, 'published'),
        ...
        subscriptions_limit=_utilities.get_dict_value(__ret__, 'subscriptionsLimit'),
