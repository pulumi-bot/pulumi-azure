...
class Logger(pulumi.CustomResource):
    ...
    application_insights: pulumi.Output[Optional['outputs.LoggerApplicationInsights']] = pulumi.property("applicationInsights")
    """
    An `application_insights` block as documented below.
    """

    buffered: pulumi.Output[Optional[bool]] = pulumi.property("buffered")
    """
    ...
    eventhub: pulumi.Output[Optional['outputs.LoggerEventhub']] = pulumi.property("eventhub")
    """
