...
class IoTHubEndpointArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "batchFrequencyInSeconds", batch_frequency_in_seconds)
        pulumi.set(__self__, "containerName", container_name)
        pulumi.set(__self__, "encoding", encoding)
        pulumi.set(__self__, "fileNameFormat", file_name_format)
        pulumi.set(__self__, "maxChunkSizeInBytes", max_chunk_size_in_bytes)
...
class IoTHubFallbackRouteArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "endpointNames", endpoint_names)
...
class IoTHubFileUploadArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "lockDuration", lock_duration)
        pulumi.set(__self__, "maxDeliveryCount", max_delivery_count)
        pulumi.set(__self__, "notifications", notifications)
        pulumi.set(__self__, "sasTtl", sas_ttl)
...
class IoTHubSharedAccessPolicyArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "secondaryKey", secondary_key)
...
class IotHubDpsLinkedHubArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "allocationWeight", allocation_weight)
        pulumi.set(__self__, "applyAllocationPolicy", apply_allocation_policy)
