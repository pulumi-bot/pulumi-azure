...
class TimeSeriesInsightsStandardEnvironment(pulumi.CustomResource):
    data_retention_time: pulumi.Output[str] = pulumi.output_property("dataRetentionTime")
    """
    ...
    """
    partition_key: pulumi.Output[Optional[str]] = pulumi.output_property("partitionKey")
    """
    ...
    """
    storage_limit_exceeded_behavior: pulumi.Output[Optional[str]] = pulumi.output_property("storageLimitExceededBehavior")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, data_retention_time: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, partition_key: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, sku_name: Optional[pulumi.Input[str]] = None, storage_limit_exceeded_behavior: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, data_retention_time: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, partition_key: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, sku_name: Optional[pulumi.Input[str]] = None, storage_limit_exceeded_behavior: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None) -> 'TimeSeriesInsightsStandardEnvironment':
        """
