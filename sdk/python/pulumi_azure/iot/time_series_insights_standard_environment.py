...
class TimeSeriesInsightsStandardEnvironment(pulumi.CustomResource):
    data_retention_time: pulumi.Output[str] = pulumi.property("dataRetentionTime")
    """
    ...
    partition_key: pulumi.Output[Optional[str]] = pulumi.property("partitionKey")
    """
    ...
    storage_limit_exceeded_behavior: pulumi.Output[Optional[str]] = pulumi.property("storageLimitExceededBehavior")
    """
