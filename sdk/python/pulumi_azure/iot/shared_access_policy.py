...
class SharedAccessPolicy(pulumi.CustomResource):
    device_connect: pulumi.Output[Optional[bool]] = pulumi.property("deviceConnect")
    """
    ...
    registry_read: pulumi.Output[Optional[bool]] = pulumi.property("registryRead")
    """
    Adds `RegistryRead` permission to this Shared Access Account. It allows read access to the identity registry.
    """

    registry_write: pulumi.Output[Optional[bool]] = pulumi.property("registryWrite")
    """
    ...
    service_connect: pulumi.Output[Optional[bool]] = pulumi.property("serviceConnect")
    """
