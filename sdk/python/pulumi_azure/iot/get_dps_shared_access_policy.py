...
@pulumi.output_type
class _GetDpsSharedAccessPolicyResult(dict):
    id: str = pulumi.property("id")
    iothub_dps_name: str = pulumi.property("iothubDpsName")
...
def get_dps_shared_access_policy(iothub_dps_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure:iot/getDpsSharedAccessPolicy:getDpsSharedAccessPolicy', __args__, opts=opts, typ=_GetDpsSharedAccessPolicyResult).value

    return AwaitableGetDpsSharedAccessPolicyResult(
        id=_utilities.get_dict_value(__ret__, 'id'),
        iothub_dps_name=_utilities.get_dict_value(__ret__, 'iothubDpsName'),
