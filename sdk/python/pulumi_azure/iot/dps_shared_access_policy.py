...
class DpsSharedAccessPolicy(pulumi.CustomResource):
    enrollment_read: pulumi.Output[Optional[bool]] = pulumi.property("enrollmentRead")
    """
    Adds `EnrollmentRead` permission to this Shared Access Account. It allows read access to enrollment data.
    """

    enrollment_write: pulumi.Output[Optional[bool]] = pulumi.property("enrollmentWrite")
    """
    Adds `EnrollmentWrite` permission to this Shared Access Account. It allows write access to enrollment data.
    """

    iothub_dps_name: pulumi.Output[str] = pulumi.property("iothubDpsName")
    """
    ...
    registration_read: pulumi.Output[Optional[bool]] = pulumi.property("registrationRead")
    """
    Adds `RegistrationStatusRead` permission to this Shared Access Account. It allows read access to device registrations.
    """

    registration_write: pulumi.Output[Optional[bool]] = pulumi.property("registrationWrite")
    """
    ...
    service_config: pulumi.Output[Optional[bool]] = pulumi.property("serviceConfig")
    """
