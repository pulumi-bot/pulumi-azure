...
class IotHubDps(pulumi.CustomResource):
    allocation_policy: pulumi.Output[str] = pulumi.output_property("allocationPolicy")
    """
    The allocation policy of the IoT Device Provisioning Service.
    """
    device_provisioning_host_name: pulumi.Output[str] = pulumi.output_property("deviceProvisioningHostName")
    """
    The device endpoint of the IoT Device Provisioning Service.
    """
    id_scope: pulumi.Output[str] = pulumi.output_property("idScope")
    """
    The unique identifier of the IoT Device Provisioning Service.
    """
    linked_hubs: pulumi.Output[Optional[List['outputs.IotHubDpsLinkedHub']]] = pulumi.output_property("linkedHubs")
    """
    ...
    """
    service_operations_host_name: pulumi.Output[str] = pulumi.output_property("serviceOperationsHostName")
    """
    The service endpoint of the IoT Device Provisioning Service.
    """
    sku: pulumi.Output['outputs.IotHubDpsSku'] = pulumi.output_property("sku")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, linked_hubs: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['IotHubDpsLinkedHubArgs']]]]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, sku: Optional[pulumi.Input[pulumi.InputType['IotHubDpsSkuArgs']]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, allocation_policy: Optional[pulumi.Input[str]] = None, device_provisioning_host_name: Optional[pulumi.Input[str]] = None, id_scope: Optional[pulumi.Input[str]] = None, linked_hubs: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['IotHubDpsLinkedHubArgs']]]]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, service_operations_host_name: Optional[pulumi.Input[str]] = None, sku: Optional[pulumi.Input[pulumi.InputType['IotHubDpsSkuArgs']]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None) -> 'IotHubDps':
        """
