...
class EndpointStorageContainer(pulumi.CustomResource):
    batch_frequency_in_seconds: pulumi.Output[Optional[float]] = pulumi.property("batchFrequencyInSeconds")
    """
    ...
    *
    ...
    file_name_format: pulumi.Output[Optional[str]] = pulumi.property("fileNameFormat")
    """
    ...
    max_chunk_size_in_bytes: pulumi.Output[Optional[float]] = pulumi.property("maxChunkSizeInBytes")
    """
