...
class EndpointStorageContainer(pulumi.CustomResource):
    ...
    *
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, batch_frequency_in_seconds=None, connection_string=None, container_name=None, encoding=None, file_name_format=None, iothub_name=None, max_chunk_size_in_bytes=None, name=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
