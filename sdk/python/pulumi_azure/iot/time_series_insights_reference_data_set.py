...
class TimeSeriesInsightsReferenceDataSet(pulumi.CustomResource):
    data_string_comparison_behavior: pulumi.Output[Optional[str]] = pulumi.output_property("dataStringComparisonBehavior")
    """
    ...
    """
    key_properties: pulumi.Output[List['outputs.TimeSeriesInsightsReferenceDataSetKeyProperty']] = pulumi.output_property("keyProperties")
    """
    ...
    """
    time_series_insights_environment_id: pulumi.Output[str] = pulumi.output_property("timeSeriesInsightsEnvironmentId")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, data_string_comparison_behavior: Optional[pulumi.Input[str]] = None, key_properties: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['TimeSeriesInsightsReferenceDataSetKeyPropertyArgs']]]]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, time_series_insights_environment_id: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, data_string_comparison_behavior: Optional[pulumi.Input[str]] = None, key_properties: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['TimeSeriesInsightsReferenceDataSetKeyPropertyArgs']]]]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, time_series_insights_environment_id: Optional[pulumi.Input[str]] = None) -> 'TimeSeriesInsightsReferenceDataSet':
        """
