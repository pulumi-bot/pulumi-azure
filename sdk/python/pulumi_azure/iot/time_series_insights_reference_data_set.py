...
class TimeSeriesInsightsReferenceDataSet(pulumi.CustomResource):
    data_string_comparison_behavior: pulumi.Output[Optional[str]] = pulumi.property("dataStringComparisonBehavior")
    """
    ...
    key_properties: pulumi.Output[List['outputs.TimeSeriesInsightsReferenceDataSetKeyProperty']] = pulumi.property("keyProperties")
    """
    ...
    time_series_insights_environment_id: pulumi.Output[str] = pulumi.property("timeSeriesInsightsEnvironmentId")
    """
