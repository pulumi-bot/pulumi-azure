...
class TimeSeriesInsightsReferenceDataSet(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, data_string_comparison_behavior=None, key_properties=None, location=None, name=None, tags=None, time_series_insights_environment_id=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['dataStringComparisonBehavior'] = data_string_comparison_behavior
            if key_properties is None:
                raise TypeError("Missing required property 'key_properties'")
            __props__['keyProperties'] = key_properties
            ...
            __props__['timeSeriesInsightsEnvironmentId'] = time_series_insights_environment_id
