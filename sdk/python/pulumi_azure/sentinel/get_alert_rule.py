...
class GetAlertRuleResult:
    ...
    def __init__(__self__, id=None, log_analytics_workspace_id=None, name=None) -> None:
...
def get_alert_rule(log_analytics_workspace_id: Optional[str] = None, name: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAlertRuleResult:
    """
