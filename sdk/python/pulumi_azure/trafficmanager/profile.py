...
class Profile(pulumi.CustomResource):
    dns_config: pulumi.Output['outputs.ProfileDnsConfig'] = pulumi.property("dnsConfig")
    """
    ...
    monitor_config: pulumi.Output['outputs.ProfileMonitorConfig'] = pulumi.property("monitorConfig")
    """
