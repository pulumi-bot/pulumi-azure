...
class SparkPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] spark_version: The Apache Spark version. Possible values are `2.4` and `3.0`. Defaults to `2.4`.
...
class SparkPool(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["synapse_workspace_id"] = synapse_workspace_id
        __props__.__dict__["tags"] = tags
        return SparkPool(resource_name_, opts=opts, __props__=__props__)
