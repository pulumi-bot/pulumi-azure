...
class GetWorkspaceResult:
    ...
    def __init__(__self__, connectivity_endpoints=None, id=None, location=None, name=None, resource_group_name=None, tags=None) -> None:
...
def get_workspace(name: Optional[str] = None, resource_group_name: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWorkspaceResult:
    """
