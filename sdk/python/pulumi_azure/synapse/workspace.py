...
class Workspace(pulumi.CustomResource):
    aad_admin: pulumi.Output['outputs.WorkspaceAadAdmin'] = pulumi.output_property("aadAdmin")
    """
    An `aad_admin` block as defined below.
    """
    connectivity_endpoints: pulumi.Output[Dict[str, str]] = pulumi.output_property("connectivityEndpoints")
    """
    A list of Connectivity endpoints for this Synapse Workspace.
    """
    identities: pulumi.Output[List['outputs.WorkspaceIdentity']] = pulumi.output_property("identities")
    """
    ...
    """
    managed_virtual_network_enabled: pulumi.Output[Optional[bool]] = pulumi.output_property("managedVirtualNetworkEnabled")
    """
    ...
    """
    sql_administrator_login: pulumi.Output[str] = pulumi.output_property("sqlAdministratorLogin")
    """
    Specifies The Login Name of the SQL administrator. Changing this forces a new resource to be created.
    """
    sql_administrator_login_password: pulumi.Output[str] = pulumi.output_property("sqlAdministratorLoginPassword")
    """
    The Password associated with the `sql_administrator_login` for the SQL administrator.
    """
    storage_data_lake_gen2_filesystem_id: pulumi.Output[str] = pulumi.output_property("storageDataLakeGen2FilesystemId")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, aad_admin: Optional[pulumi.Input[pulumi.InputType['WorkspaceAadAdminArgs']]] = None, location: Optional[pulumi.Input[str]] = None, managed_virtual_network_enabled: Optional[pulumi.Input[bool]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, sql_administrator_login: Optional[pulumi.Input[str]] = None, sql_administrator_login_password: Optional[pulumi.Input[str]] = None, storage_data_lake_gen2_filesystem_id: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        :param pulumi.Input[Dict[str, pulumi.Input[str]]] tags: A mapping of tags which should be assigned to the Synapse Workspace.
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, aad_admin: Optional[pulumi.Input[pulumi.InputType['WorkspaceAadAdminArgs']]] = None, connectivity_endpoints: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, identities: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['WorkspaceIdentityArgs']]]]] = None, location: Optional[pulumi.Input[str]] = None, managed_resource_group_name: Optional[pulumi.Input[str]] = None, managed_virtual_network_enabled: Optional[pulumi.Input[bool]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, sql_administrator_login: Optional[pulumi.Input[str]] = None, sql_administrator_login_password: Optional[pulumi.Input[str]] = None, storage_data_lake_gen2_filesystem_id: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None) -> 'Workspace':
        """
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[pulumi.InputType['WorkspaceAadAdminArgs']] aad_admin: An `aad_admin` block as defined below.
        :param pulumi.Input[Dict[str, pulumi.Input[str]]] connectivity_endpoints: A list of Connectivity endpoints for this Synapse Workspace.
