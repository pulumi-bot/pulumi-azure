...
class Workspace(pulumi.CustomResource):
    aad_admin: pulumi.Output['outputs.WorkspaceAadAdmin'] = pulumi.property("aadAdmin")
    """
    An `aad_admin` block as defined below.
    """

    connectivity_endpoints: pulumi.Output[Mapping[str, str]] = pulumi.property("connectivityEndpoints")
    """
    A list of Connectivity endpoints for this Synapse Workspace.
    """

    identities: pulumi.Output[List['outputs.WorkspaceIdentity']] = pulumi.property("identities")
    """
    ...
    managed_resource_group_name: pulumi.Output[str] = pulumi.property("managedResourceGroupName")
    """
    Workspace managed resource group.
    """

    managed_virtual_network_enabled: pulumi.Output[Optional[bool]] = pulumi.property("managedVirtualNetworkEnabled")
    """
    ...
    sql_administrator_login: pulumi.Output[str] = pulumi.property("sqlAdministratorLogin")
    """
    Specifies The Login Name of the SQL administrator. Changing this forces a new resource to be created.
    """

    sql_administrator_login_password: pulumi.Output[str] = pulumi.property("sqlAdministratorLoginPassword")
    """
    The Password associated with the `sql_administrator_login` for the SQL administrator.
    """

    storage_data_lake_gen2_filesystem_id: pulumi.Output[str] = pulumi.property("storageDataLakeGen2FilesystemId")
    """
