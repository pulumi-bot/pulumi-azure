...
class DefinitionArgs:
    def __init__(__self__, *,
                 permissions: pulumi.Input[Sequence[pulumi.Input['DefinitionPermissionArgs']]],
    ...
    @property
    @pulumi.getter
    def permissions(self) -> pulumi.Input[Sequence[pulumi.Input['DefinitionPermissionArgs']]]:
        """
    ...
    @permissions.setter
    def permissions(self, value: pulumi.Input[Sequence[pulumi.Input['DefinitionPermissionArgs']]]):
...
class Definition(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[DefinitionArgs] = None,
