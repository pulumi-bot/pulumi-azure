...
class CustomProvider(pulumi.CustomResource):
    actions: pulumi.Output[Optional[List['outputs.CustomProviderAction']]] = pulumi.property("actions")
    """
    ...
    resource_types: pulumi.Output[Optional[List['outputs.CustomProviderResourceType']]] = pulumi.property("resourceTypes")
    """
    ...
    validations: pulumi.Output[Optional[List['outputs.CustomProviderValidation']]] = pulumi.property("validations")
    """
