...
class GetResourcesResult:
    ...
    def __init__(__self__, id=None, name=None, required_tags=None, resource_group_name=None, resources=None, type=None) -> None:
...
def get_resources(name: Optional[str] = None, required_tags: Optional[Dict[str, str]] = None, resource_group_name: Optional[str] = None, type: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetResourcesResult:
    """
    Use this data source to access information about existing resources.


    :param str name: The name of the Resource.
    :param Dict[str, str] required_tags: A mapping of tags which the resource has to have in order to be included in the result.
