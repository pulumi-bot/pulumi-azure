...
@pulumi.output_type
class _GetSubscriptionResult(dict):
...
def get_subscription(subscription_id: Optional[str] = None,
    ...
    return AwaitableGetSubscriptionResult(
        ...
        location_placement_id=_utilities.get_dict_value(__ret__, 'locationPlacementId'),
        quota_id=_utilities.get_dict_value(__ret__, 'quotaId'),
        spending_limit=_utilities.get_dict_value(__ret__, 'spendingLimit'),
