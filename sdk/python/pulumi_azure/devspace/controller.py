...
class Controller(pulumi.CustomResource):
    data_plane_fqdn: pulumi.Output[str] = pulumi.output_property("dataPlaneFqdn")
    """
    DNS name for accessing DataPlane services.
    """
    host_suffix: pulumi.Output[str] = pulumi.output_property("hostSuffix")
    """
    ...
    """
    target_container_host_credentials_base64: pulumi.Output[str] = pulumi.output_property("targetContainerHostCredentialsBase64")
    """
    Base64 encoding of `kube_config_raw` of Azure Kubernetes Service cluster. Changing this forces a new resource to be created.
    """
    target_container_host_resource_id: pulumi.Output[str] = pulumi.output_property("targetContainerHostResourceId")
    """
    The resource id of Azure Kubernetes Service cluster. Changing this forces a new resource to be created.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, sku_name: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, target_container_host_credentials_base64: Optional[pulumi.Input[str]] = None, target_container_host_resource_id: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, data_plane_fqdn: Optional[pulumi.Input[str]] = None, host_suffix: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, sku_name: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, target_container_host_credentials_base64: Optional[pulumi.Input[str]] = None, target_container_host_resource_id: Optional[pulumi.Input[str]] = None) -> 'Controller':
        """
