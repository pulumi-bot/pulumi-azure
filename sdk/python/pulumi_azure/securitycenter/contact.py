...
class Contact(pulumi.CustomResource):
    alert_notifications: pulumi.Output[bool] = pulumi.output_property("alertNotifications")
    """
    Whether to send security alerts notifications to the security contact.
    """
    alerts_to_admins: pulumi.Output[bool] = pulumi.output_property("alertsToAdmins")
    """
    ...
    """
    phone: pulumi.Output[Optional[str]] = pulumi.output_property("phone")
    """
    The phone number of the Security Center Contact.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, alert_notifications: Optional[pulumi.Input[bool]] = None, alerts_to_admins: Optional[pulumi.Input[bool]] = None, email: Optional[pulumi.Input[str]] = None, phone: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, alert_notifications: Optional[pulumi.Input[bool]] = None, alerts_to_admins: Optional[pulumi.Input[bool]] = None, email: Optional[pulumi.Input[str]] = None, phone: Optional[pulumi.Input[str]] = None) -> 'Contact':
        """
