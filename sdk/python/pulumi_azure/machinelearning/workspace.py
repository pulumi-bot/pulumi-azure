...
class Workspace(pulumi.CustomResource):
    ...
    """
    container_registry_id: pulumi.Output[Optional[str]] = pulumi.output_property("containerRegistryId")
    """
    ...
    """
    high_business_impact: pulumi.Output[Optional[bool]] = pulumi.output_property("highBusinessImpact")
    """
    Flag to signal High Business Impact (HBI) data in the workspace and reduce diagnostic data collected by the service
    """
    identity: pulumi.Output['outputs.WorkspaceIdentity'] = pulumi.output_property("identity")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, application_insights_id: Optional[pulumi.Input[str]] = None, container_registry_id: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, friendly_name: Optional[pulumi.Input[str]] = None, high_business_impact: Optional[pulumi.Input[bool]] = None, identity: Optional[pulumi.Input[pulumi.InputType['WorkspaceIdentityArgs']]] = None, key_vault_id: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, sku_name: Optional[pulumi.Input[str]] = None, storage_account_id: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
