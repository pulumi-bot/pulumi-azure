...
def get_workspace(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure:machinelearning/getWorkspace:getWorkspace', __args__, opts=opts, typ=_GetWorkspaceResult).value
