...
class HubApnsCredentialArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "applicationMode", application_mode)
        pulumi.set(__self__, "bundleId", bundle_id)
        pulumi.set(__self__, "keyId", key_id)
        pulumi.set(__self__, "teamId", team_id)
...
class HubGcmCredentialArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "apiKey", api_key)
