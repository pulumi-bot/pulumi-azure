...
class Namespace(pulumi.CustomResource):
    ...
    """
    namespace_type: pulumi.Output[str] = pulumi.output_property("namespaceType")
    """
    ...
    """
    servicebus_endpoint: pulumi.Output[str] = pulumi.output_property("servicebusEndpoint")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, enabled=None, location=None, name=None, namespace_type=None, resource_group_name=None, sku_name=None, tags=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
