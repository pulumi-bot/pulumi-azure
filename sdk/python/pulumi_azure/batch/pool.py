...
class Pool(pulumi.CustomResource):
    ...
    auto_scale: pulumi.Output[Optional['outputs.PoolAutoScale']] = pulumi.property("autoScale")
    """
    A `auto_scale` block that describes the scale settings when using auto scale.
    """

    certificates: pulumi.Output[Optional[List['outputs.PoolCertificate']]] = pulumi.property("certificates")
    """
    One or more `certificate` blocks that describe the certificates to be installed on each compute node in the pool.
    """

    container_configuration: pulumi.Output[Optional['outputs.PoolContainerConfiguration']] = pulumi.property("containerConfiguration")
    """
    ...
    fixed_scale: pulumi.Output[Optional['outputs.PoolFixedScale']] = pulumi.property("fixedScale")
    """
    A `fixed_scale` block that describes the scale settings when using fixed scale.
    """

    max_tasks_per_node: pulumi.Output[Optional[float]] = pulumi.property("maxTasksPerNode")
    """
    ...
    network_configuration: pulumi.Output[Optional['outputs.PoolNetworkConfiguration']] = pulumi.property("networkConfiguration")
    """
    A `network_configuration` block that describes the network configurations for the Batch pool.
    """

    node_agent_sku_id: pulumi.Output[str] = pulumi.property("nodeAgentSkuId")
    """
    ...
    start_task: pulumi.Output[Optional['outputs.PoolStartTask']] = pulumi.property("startTask")
    """
    A `start_task` block that describes the start task settings for the Batch pool.
    """

    stop_pending_resize_operation: pulumi.Output[Optional[bool]] = pulumi.property("stopPendingResizeOperation")

    storage_image_reference: pulumi.Output['outputs.PoolStorageImageReference'] = pulumi.property("storageImageReference")
    """
