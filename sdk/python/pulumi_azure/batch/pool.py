...
class Pool(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, account_name: Optional[pulumi.Input[str]] = None, auto_scale: Optional[pulumi.Input[pulumi.InputType['PoolAutoScaleArgs']]] = None, certificates: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['PoolCertificateArgs']]]]] = None, container_configuration: Optional[pulumi.Input[pulumi.InputType['PoolContainerConfigurationArgs']]] = None, display_name: Optional[pulumi.Input[str]] = None, fixed_scale: Optional[pulumi.Input[pulumi.InputType['PoolFixedScaleArgs']]] = None, max_tasks_per_node: Optional[pulumi.Input[float]] = None, metadata: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, name: Optional[pulumi.Input[str]] = None, network_configuration: Optional[pulumi.Input[pulumi.InputType['PoolNetworkConfigurationArgs']]] = None, node_agent_sku_id: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, start_task: Optional[pulumi.Input[pulumi.InputType['PoolStartTaskArgs']]] = None, stop_pending_resize_operation: Optional[pulumi.Input[bool]] = None, storage_image_reference: Optional[pulumi.Input[pulumi.InputType['PoolStorageImageReferenceArgs']]] = None, vm_size: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, account_name: Optional[pulumi.Input[str]] = None, auto_scale: Optional[pulumi.Input[pulumi.InputType['PoolAutoScaleArgs']]] = None, certificates: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['PoolCertificateArgs']]]]] = None, container_configuration: Optional[pulumi.Input[pulumi.InputType['PoolContainerConfigurationArgs']]] = None, display_name: Optional[pulumi.Input[str]] = None, fixed_scale: Optional[pulumi.Input[pulumi.InputType['PoolFixedScaleArgs']]] = None, max_tasks_per_node: Optional[pulumi.Input[float]] = None, metadata: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, name: Optional[pulumi.Input[str]] = None, network_configuration: Optional[pulumi.Input[pulumi.InputType['PoolNetworkConfigurationArgs']]] = None, node_agent_sku_id: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, start_task: Optional[pulumi.Input[pulumi.InputType['PoolStartTaskArgs']]] = None, stop_pending_resize_operation: Optional[pulumi.Input[bool]] = None, storage_image_reference: Optional[pulumi.Input[pulumi.InputType['PoolStorageImageReferenceArgs']]] = None, vm_size: Optional[pulumi.Input[str]] = None) -> 'Pool':
        """
