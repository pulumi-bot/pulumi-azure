...
class Account(pulumi.CustomResource):
    account_endpoint: pulumi.Output[str] = pulumi.property("accountEndpoint")
    """
    The account endpoint used to interact with the Batch service.
    """

    key_vault_reference: pulumi.Output[Optional['outputs.AccountKeyVaultReference']] = pulumi.property("keyVaultReference")
    """
    ...
    pool_allocation_mode: pulumi.Output[Optional[str]] = pulumi.property("poolAllocationMode")
    """
