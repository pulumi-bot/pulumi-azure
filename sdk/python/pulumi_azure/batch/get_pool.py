...
def get_pool(account_name: Optional[str] = None,
    ...
    return AwaitableGetPoolResult(
        ...
        auto_scales=_utilities.get_dict_value(__ret__, 'autoScales'),
        certificates=_utilities.get_dict_value(__ret__, 'certificates'),
        container_configurations=_utilities.get_dict_value(__ret__, 'containerConfigurations'),
        display_name=_utilities.get_dict_value(__ret__, 'displayName'),
        fixed_scales=_utilities.get_dict_value(__ret__, 'fixedScales'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        max_tasks_per_node=_utilities.get_dict_value(__ret__, 'maxTasksPerNode'),
        metadata=_utilities.get_dict_value(__ret__, 'metadata'),
        name=_utilities.get_dict_value(__ret__, 'name'),
        network_configuration=_utilities.get_dict_value(__ret__, 'networkConfiguration'),
        node_agent_sku_id=_utilities.get_dict_value(__ret__, 'nodeAgentSkuId'),
        resource_group_name=_utilities.get_dict_value(__ret__, 'resourceGroupName'),
        start_task=_utilities.get_dict_value(__ret__, 'startTask'),
        storage_image_references=_utilities.get_dict_value(__ret__, 'storageImageReferences'),
