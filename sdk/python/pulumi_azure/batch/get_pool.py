...
def get_pool(account_name: Optional[str] = None, certificates: Optional[List[pulumi.InputType['GetPoolCertificateArgs']]] = None, name: Optional[str] = None, network_configuration: Optional[pulumi.InputType['GetPoolNetworkConfigurationArgs']] = None, resource_group_name: Optional[str] = None, start_task: Optional[pulumi.InputType['GetPoolStartTaskArgs']] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPoolResult:
    """
