...
class Cache(pulumi.CustomResource):
    capacity: pulumi.Output[float] = pulumi.output_property("capacity")
    """
    The size of the Redis cache to deploy. Valid values for a SKU `family` of C (Basic/Standard) are `0, 1, 2, 3, 4, 5, 6`, and for P (Premium) `family` are `1, 2, 3, 4`.
    """
    enable_non_ssl_port: pulumi.Output[Optional[bool]] = pulumi.output_property("enableNonSslPort")
    """
    ...
    """
    minimum_tls_version: pulumi.Output[Optional[str]] = pulumi.output_property("minimumTlsVersion")
    """
    ...
    """
    patch_schedules: pulumi.Output[Optional[List['outputs.CachePatchSchedule']]] = pulumi.output_property("patchSchedules")
    """
    ...
    """
    private_static_ip_address: pulumi.Output[str] = pulumi.output_property("privateStaticIpAddress")
    """
    The Static IP Address to assign to the Redis Cache when hosted inside the Virtual Network. Changing this forces a new resource to be created.
    """
    redis_configuration: pulumi.Output['outputs.CacheRedisConfiguration'] = pulumi.output_property("redisConfiguration")
    """
    ...
    """
    shard_count: pulumi.Output[Optional[float]] = pulumi.output_property("shardCount")
    """
    *Only available when using the Premium SKU* The number of Shards to create on the Redis Cluster.
    ...
    """
    ssl_port: pulumi.Output[float] = pulumi.output_property("sslPort")
    """
    ...
    *Only available when using the Premium SKU* The ID of the Subnet within which the Redis Cache should be deployed. This Subnet must only contain Azure Cache for Redis instances without any other type of resources. Changing this forces a new resource to be created.
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, capacity: Optional[pulumi.Input[float]] = None, enable_non_ssl_port: Optional[pulumi.Input[bool]] = None, family: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, minimum_tls_version: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, patch_schedules: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['CachePatchScheduleArgs']]]]] = None, private_static_ip_address: Optional[pulumi.Input[str]] = None, redis_configuration: Optional[pulumi.Input[pulumi.InputType['CacheRedisConfigurationArgs']]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, shard_count: Optional[pulumi.Input[float]] = None, sku_name: Optional[pulumi.Input[str]] = None, subnet_id: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, zones: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, capacity: Optional[pulumi.Input[float]] = None, enable_non_ssl_port: Optional[pulumi.Input[bool]] = None, family: Optional[pulumi.Input[str]] = None, hostname: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, minimum_tls_version: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, patch_schedules: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['CachePatchScheduleArgs']]]]] = None, port: Optional[pulumi.Input[float]] = None, primary_access_key: Optional[pulumi.Input[str]] = None, primary_connection_string: Optional[pulumi.Input[str]] = None, private_static_ip_address: Optional[pulumi.Input[str]] = None, redis_configuration: Optional[pulumi.Input[pulumi.InputType['CacheRedisConfigurationArgs']]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, secondary_access_key: Optional[pulumi.Input[str]] = None, secondary_connection_string: Optional[pulumi.Input[str]] = None, shard_count: Optional[pulumi.Input[float]] = None, sku_name: Optional[pulumi.Input[str]] = None, ssl_port: Optional[pulumi.Input[float]] = None, subnet_id: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, zones: Optional[pulumi.Input[str]] = None) -> 'Cache':
        """
