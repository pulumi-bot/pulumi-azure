...
class FirewallRule(pulumi.CustomResource):
    end_ip: pulumi.Output[str] = pulumi.property("endIp")
    """
    ...
    redis_cache_name: pulumi.Output[str] = pulumi.property("redisCacheName")
    """
    ...
    start_ip: pulumi.Output[str] = pulumi.property("startIp")
    """
