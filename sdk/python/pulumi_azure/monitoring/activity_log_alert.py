...
class ActivityLogAlert(pulumi.CustomResource):
    actions: pulumi.Output[Optional[List['outputs.ActivityLogAlertAction']]] = pulumi.property("actions")
    """
    One or more `action` blocks as defined below.
    """

    criteria: pulumi.Output['outputs.ActivityLogAlertCriteria'] = pulumi.property("criteria")
    """
