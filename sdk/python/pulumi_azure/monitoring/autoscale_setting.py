...
class AutoscaleSetting(pulumi.CustomResource):
    ...
    notification: pulumi.Output[Optional['outputs.AutoscaleSettingNotification']] = pulumi.property("notification")
    """
    Specifies a `notification` block as defined below.
    """

    profiles: pulumi.Output[List['outputs.AutoscaleSettingProfile']] = pulumi.property("profiles")
    """
