...
class ActionRuleSuppression(pulumi.CustomResource):
    condition: pulumi.Output[Optional['outputs.ActionRuleSuppressionCondition']] = pulumi.output_property("condition")
    """
    ...
    """
    scope: pulumi.Output[Optional['outputs.ActionRuleSuppressionScope']] = pulumi.output_property("scope")
    """
    A `scope` block as defined below.
    """
    suppression: pulumi.Output['outputs.ActionRuleSuppressionSuppression'] = pulumi.output_property("suppression")
    """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, condition: Optional[pulumi.Input[pulumi.InputType['ActionRuleSuppressionConditionArgs']]] = None, description: Optional[pulumi.Input[str]] = None, enabled: Optional[pulumi.Input[bool]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, scope: Optional[pulumi.Input[pulumi.InputType['ActionRuleSuppressionScopeArgs']]] = None, suppression: Optional[pulumi.Input[pulumi.InputType['ActionRuleSuppressionSuppressionArgs']]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None) -> 'ActionRuleSuppression':
        """
