...
class ActionRuleActionGroup(pulumi.CustomResource):
    action_group_id: pulumi.Output[str] = pulumi.property("actionGroupId")
    """
    Specifies the resource id of monitor action group.
    """

    condition: pulumi.Output[Optional['outputs.ActionRuleActionGroupCondition']] = pulumi.property("condition")
    """
    ...
    scope: pulumi.Output[Optional['outputs.ActionRuleActionGroupScope']] = pulumi.property("scope")
    """
