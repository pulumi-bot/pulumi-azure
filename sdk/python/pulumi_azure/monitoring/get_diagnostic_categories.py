...
def get_diagnostic_categories(resource_id=None, opts=None):
    ...
    example_key_vault = azure.keyvault.get_key_vault(azure.keyvault.GetKeyVaultArgsArgs(
        name=azurerm_key_vault["example"]["name"],
        resource_group_name=azurerm_key_vault["example"]["resource_group_name"],
    ))
    example_diagnostic_categories = azure.monitoring.get_diagnostic_categories(azure.monitoring.GetDiagnosticCategoriesArgsArgs(
        resource_id=example_key_vault.id,
    ))
    ```
