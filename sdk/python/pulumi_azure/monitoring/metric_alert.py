...
class MetricAlert(pulumi.CustomResource):
    ...
    """
    application_insights_web_test_location_availability_criteria: pulumi.Output[Optional['outputs.MetricAlertApplicationInsightsWebTestLocationAvailabilityCriteria']] = pulumi.output_property("applicationInsightsWebTestLocationAvailabilityCriteria")
    """
    ...
    """
    criterias: pulumi.Output[Optional[List['outputs.MetricAlertCriteria']]] = pulumi.output_property("criterias")
    """
    ...
    """
    dynamic_criteria: pulumi.Output[Optional['outputs.MetricAlertDynamicCriteria']] = pulumi.output_property("dynamicCriteria")
    """
    ...
    """
    target_resource_location: pulumi.Output[str] = pulumi.output_property("targetResourceLocation")
    """
    The location of the target resource.
    """
    target_resource_type: pulumi.Output[str] = pulumi.output_property("targetResourceType")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, actions: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['MetricAlertActionArgs']]]]] = None, application_insights_web_test_location_availability_criteria: Optional[pulumi.Input[pulumi.InputType['MetricAlertApplicationInsightsWebTestLocationAvailabilityCriteriaArgs']]] = None, auto_mitigate: Optional[pulumi.Input[bool]] = None, criterias: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['MetricAlertCriteriaArgs']]]]] = None, description: Optional[pulumi.Input[str]] = None, dynamic_criteria: Optional[pulumi.Input[pulumi.InputType['MetricAlertDynamicCriteriaArgs']]] = None, enabled: Optional[pulumi.Input[bool]] = None, frequency: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, scopes: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, severity: Optional[pulumi.Input[float]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, target_resource_location: Optional[pulumi.Input[str]] = None, target_resource_type: Optional[pulumi.Input[str]] = None, window_size: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, actions: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['MetricAlertActionArgs']]]]] = None, application_insights_web_test_location_availability_criteria: Optional[pulumi.Input[pulumi.InputType['MetricAlertApplicationInsightsWebTestLocationAvailabilityCriteriaArgs']]] = None, auto_mitigate: Optional[pulumi.Input[bool]] = None, criterias: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['MetricAlertCriteriaArgs']]]]] = None, description: Optional[pulumi.Input[str]] = None, dynamic_criteria: Optional[pulumi.Input[pulumi.InputType['MetricAlertDynamicCriteriaArgs']]] = None, enabled: Optional[pulumi.Input[bool]] = None, frequency: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, scopes: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, severity: Optional[pulumi.Input[float]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, target_resource_location: Optional[pulumi.Input[str]] = None, target_resource_type: Optional[pulumi.Input[str]] = None, window_size: Optional[pulumi.Input[str]] = None) -> 'MetricAlert':
        """
