...
class MetricAlert(pulumi.CustomResource):
    actions: pulumi.Output[Optional[List['outputs.MetricAlertAction']]] = pulumi.property("actions")
    """
    One or more `action` blocks as defined below.
    """

    application_insights_web_test_location_availability_criteria: pulumi.Output[Optional['outputs.MetricAlertApplicationInsightsWebTestLocationAvailabilityCriteria']] = pulumi.property("applicationInsightsWebTestLocationAvailabilityCriteria")
    """
    A `application_insights_web_test_location_availability_criteria` block as defined below.
    """

    auto_mitigate: pulumi.Output[Optional[bool]] = pulumi.property("autoMitigate")
    """
    Should the alerts in this Metric Alert be auto resolved? Defaults to `true`.
    """

    criterias: pulumi.Output[Optional[List['outputs.MetricAlertCriteria']]] = pulumi.property("criterias")
    """
    ...
    dynamic_criteria: pulumi.Output[Optional['outputs.MetricAlertDynamicCriteria']] = pulumi.property("dynamicCriteria")
    """
    ...
    frequency: pulumi.Output[Optional[str]] = pulumi.property("frequency")
    """
    ...
    scopes: pulumi.Output[List[str]] = pulumi.property("scopes")
    """
    A set of strings of resource IDs at which the metric criteria should be applied.
    """

    severity: pulumi.Output[Optional[float]] = pulumi.property("severity")
    """
    ...
    target_resource_location: pulumi.Output[str] = pulumi.property("targetResourceLocation")
    """
    The location of the target resource.
    """

    target_resource_type: pulumi.Output[str] = pulumi.property("targetResourceType")
    """
    The resource type (e.g. `Microsoft.Compute/virtualMachines`) of the target resource.
    """

    window_size: pulumi.Output[Optional[str]] = pulumi.property("windowSize")
    """
