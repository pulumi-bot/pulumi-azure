...
class LogProfile(pulumi.CustomResource):
    categories: pulumi.Output[List[str]] = pulumi.property("categories")
    """
    ...
    retention_policy: pulumi.Output['outputs.LogProfileRetentionPolicy'] = pulumi.property("retentionPolicy")
    """
    ...
    servicebus_rule_id: pulumi.Output[Optional[str]] = pulumi.property("servicebusRuleId")
    """
