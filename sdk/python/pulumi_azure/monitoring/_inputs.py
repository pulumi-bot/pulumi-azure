...
class ActionGroupArmRoleReceiverArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "roleId", role_id)
        pulumi.set(__self__, "useCommonAlertSchema", use_common_alert_schema)
...
class ActionGroupAutomationRunbookReceiverArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] use_common_alert_schema: Enables or disables the common alert schema.
        """
        pulumi.set(__self__, "automationAccountId", automation_account_id)
        pulumi.set(__self__, "isGlobalRunbook", is_global_runbook)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "runbookName", runbook_name)
        pulumi.set(__self__, "serviceUri", service_uri)
        pulumi.set(__self__, "webhookResourceId", webhook_resource_id)
        pulumi.set(__self__, "useCommonAlertSchema", use_common_alert_schema)
...
class ActionGroupAzureAppPushReceiverArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "emailAddress", email_address)
        pulumi.set(__self__, "name", name)
...
class ActionGroupAzureFunctionReceiverArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] use_common_alert_schema: Enables or disables the common alert schema.
        """
        pulumi.set(__self__, "functionAppResourceId", function_app_resource_id)
        pulumi.set(__self__, "functionName", function_name)
        pulumi.set(__self__, "httpTriggerUrl", http_trigger_url)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "useCommonAlertSchema", use_common_alert_schema)
...
class ActionGroupItsmReceiverArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "connectionId", connection_id)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "region", region)
        pulumi.set(__self__, "ticketConfiguration", ticket_configuration)
...
class ActionGroupLogicAppReceiverArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] use_common_alert_schema: Enables or disables the common alert schema.
        """
        pulumi.set(__self__, "callbackUrl", callback_url)
        pulumi.set(__self__, "name", name)
...
class ActionGroupSmsReceiverArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "countryCode", country_code)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "phoneNumber", phone_number)
...
class ActionRuleActionGroupConditionArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "alertContext", alert_context)
        pulumi.set(__self__, "alertRuleId", alert_rule_id)
        pulumi.set(__self__, "description", description)
        pulumi.set(__self__, "monitor", monitor)
        pulumi.set(__self__, "monitorService", monitor_service)
        pulumi.set(__self__, "severity", severity)
        pulumi.set(__self__, "targetResourceType", target_resource_type)
...
class ActionRuleActionGroupScopeArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "resourceIds", resource_ids)
...
class ActionRuleSuppressionSuppressionArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "recurrenceType", recurrence_type)
...
class ActionRuleSuppressionSuppressionScheduleArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "endDateUtc", end_date_utc)
        pulumi.set(__self__, "startDateUtc", start_date_utc)
        pulumi.set(__self__, "recurrenceMonthlies", recurrence_monthlies)
        pulumi.set(__self__, "recurrenceWeeklies", recurrence_weeklies)
...
class ActivityLogAlertActionArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "actionGroupId", action_group_id)
        pulumi.set(__self__, "webhookProperties", webhook_properties)
...
class ActivityLogAlertCriteriaArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "operationName", operation_name)
        pulumi.set(__self__, "recommendationCategory", recommendation_category)
        pulumi.set(__self__, "recommendationImpact", recommendation_impact)
        pulumi.set(__self__, "recommendationType", recommendation_type)
        pulumi.set(__self__, "resourceGroup", resource_group)
        pulumi.set(__self__, "resourceId", resource_id)
        pulumi.set(__self__, "resourceProvider", resource_provider)
        pulumi.set(__self__, "resourceType", resource_type)
        pulumi.set(__self__, "status", status)
        pulumi.set(__self__, "subStatus", sub_status)
...
class AutoscaleSettingNotificationEmailArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "customEmails", custom_emails)
        pulumi.set(__self__, "sendToSubscriptionAdministrator", send_to_subscription_administrator)
        pulumi.set(__self__, "sendToSubscriptionCoAdministrator", send_to_subscription_co_administrator)
...
class AutoscaleSettingProfileArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "fixedDate", fixed_date)
...
class AutoscaleSettingProfileRuleArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "metricTrigger", metric_trigger)
        pulumi.set(__self__, "scaleAction", scale_action)
...
class AutoscaleSettingProfileRuleMetricTriggerArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "metricResourceId", metric_resource_id)
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "statistic", statistic)
        pulumi.set(__self__, "threshold", threshold)
        pulumi.set(__self__, "timeAggregation", time_aggregation)
        pulumi.set(__self__, "timeGrain", time_grain)
        pulumi.set(__self__, "timeWindow", time_window)
...
class MetricAlertApplicationInsightsWebTestLocationAvailabilityCriteriaArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "componentId", component_id)
        pulumi.set(__self__, "failedLocationCount", failed_location_count)
        pulumi.set(__self__, "webTestId", web_test_id)
...
class MetricAlertDynamicCriteriaArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "aggregation", aggregation)
        pulumi.set(__self__, "alertSensitivity", alert_sensitivity)
        pulumi.set(__self__, "metricName", metric_name)
        pulumi.set(__self__, "metricNamespace", metric_namespace)
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "dimensions", dimensions)
        pulumi.set(__self__, "evaluationFailureCount", evaluation_failure_count)
        pulumi.set(__self__, "evaluationTotalCount", evaluation_total_count)
        pulumi.set(__self__, "ignoreDataBefore", ignore_data_before)
...
class ScheduledQueryRulesAlertActionArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "actionGroups", action_groups)
        pulumi.set(__self__, "customWebhookPayload", custom_webhook_payload)
...
class ScheduledQueryRulesAlertTriggerMetricTriggerArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "metricColumn", metric_column)
        pulumi.set(__self__, "metricTriggerType", metric_trigger_type)
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "threshold", threshold)
