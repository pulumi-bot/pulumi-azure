...
class ActionRuleSuppressionSuppressionScheduleArgs:
    def __init__(__self__, *,
                 ...
                 recurrence_monthlies: Optional[pulumi.Input[Sequence[pulumi.Input[float]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[float]]] recurrence_monthlies: specifies the list of dayOfMonth to recurrence. Possible values are between `1` - `31`. Required if `recurrence_type` is `Monthly`.
    ...
    def recurrence_monthlies(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[float]]]]:
        """
    ...
    def recurrence_monthlies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[float]]]]):
