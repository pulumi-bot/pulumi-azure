...
class ScheduledQueryRulesAlert(pulumi.CustomResource):
    action: pulumi.Output['outputs.ScheduledQueryRulesAlertAction'] = pulumi.property("action")
    """
    An `action` block as defined below.
    """

    authorized_resource_ids: pulumi.Output[Optional[List[str]]] = pulumi.property("authorizedResourceIds")
    """
    ...
    frequency: pulumi.Output[float] = pulumi.property("frequency")
    """
    ...
    query_type: pulumi.Output[Optional[str]] = pulumi.property("queryType")
    ...
    throttling: pulumi.Output[Optional[float]] = pulumi.property("throttling")
    """
    Time (in minutes) for which Alerts should be throttled or suppressed.  Values must be between 0 and 10000 (inclusive).
    """

    time_window: pulumi.Output[float] = pulumi.property("timeWindow")
    """
    Time window for which data needs to be fetched for query (must be greater than or equal to `frequency`).  Values must be between 5 and 2880 (inclusive).
    """

    trigger: pulumi.Output['outputs.ScheduledQueryRulesAlertTrigger'] = pulumi.property("trigger")
    """
