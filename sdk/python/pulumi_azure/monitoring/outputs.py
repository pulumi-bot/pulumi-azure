...
class GetScheduledQueryRulesAlertTrigger(dict):
    ...
    def metric_triggers(self) -> List['outputs.GetScheduledQueryRulesAlertTriggerMetricTrigger']:
        ...
...
class GetScheduledQueryRulesLogCriteria(dict):
    @property
    @pulumi.getter
    def dimensions(self) -> List['outputs.GetScheduledQueryRulesLogCriteriaDimension']:
        """
        A `dimension` block as defined below.
        """
        ...
