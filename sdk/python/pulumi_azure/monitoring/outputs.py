...
class MetricAlertApplicationInsightsWebTestLocationAvailabilityCriteria(dict):
    component_id: str = pulumi.output_property("componentId")
    """
    The ID of the Application Insights Resource.
    """
    failed_location_count: float = pulumi.output_property("failedLocationCount")
    """
    The number of failed locations.
    """
    web_test_id: str = pulumi.output_property("webTestId")
    """
...
class MetricAlertDynamicCriteria(dict):
    ...
    The statistic that runs over the metric values. Possible values are `Average`, `Count`, `Minimum`, `Maximum` and `Total`.
    """
    alert_sensitivity: str = pulumi.output_property("alertSensitivity")
    """
    The extent of deviation required to trigger an alert. Possible values are `Low`, `Medium` and `High`.
    """
    dimensions: Optional[List['outputs.MetricAlertDynamicCriteriaDimension']] = pulumi.output_property("dimensions")
    """
    One or more `dimension` blocks as defined below.
    """
    evaluation_failure_count: Optional[float] = pulumi.output_property("evaluationFailureCount")
    """
    The number of violations to trigger an alert. Should be smaller or equal to `evaluation_total_count`.
    """
    evaluation_total_count: Optional[float] = pulumi.output_property("evaluationTotalCount")
    """
    ...
    """
    ignore_data_before: Optional[str] = pulumi.output_property("ignoreDataBefore")
    """
