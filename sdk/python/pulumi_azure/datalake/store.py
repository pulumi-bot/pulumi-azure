...
class Store(pulumi.CustomResource):
    encryption_state: pulumi.Output[Optional[str]] = pulumi.property("encryptionState")
    """
    Is Encryption enabled on this Data Lake Store Account? Possible values are `Enabled` or `Disabled`. Defaults to `Enabled`.
    """

    encryption_type: pulumi.Output[str] = pulumi.property("encryptionType")
    """
    ...
    firewall_allow_azure_ips: pulumi.Output[Optional[str]] = pulumi.property("firewallAllowAzureIps")
    """
    are Azure Service IP's allowed through the firewall? Possible values are `Enabled` and `Disabled`. Defaults to `Enabled.`
    """

    firewall_state: pulumi.Output[Optional[str]] = pulumi.property("firewallState")
    """
