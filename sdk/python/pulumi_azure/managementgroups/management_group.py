...
class ManagementGroup(pulumi.CustomResource):
    ...
    """
    group_id: pulumi.Output[str] = pulumi.output_property("groupId")
    """
    ...
    The name or UUID for this Management Group, which needs to be unique across your tenant. A new UUID will be generated if not provided. Changing this forces a new resource to be created.
    """
    parent_management_group_id: pulumi.Output[str] = pulumi.output_property("parentManagementGroupId")
    """
    The ID of the Parent Management Group. Changing this forces a new resource to be created.
    """
    subscription_ids: pulumi.Output[Optional[List[str]]] = pulumi.output_property("subscriptionIds")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, display_name: Optional[pulumi.Input[str]] = None, group_id: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, parent_management_group_id: Optional[pulumi.Input[str]] = None, subscription_ids: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, display_name: Optional[pulumi.Input[str]] = None, group_id: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, parent_management_group_id: Optional[pulumi.Input[str]] = None, subscription_ids: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None) -> 'ManagementGroup':
        """
