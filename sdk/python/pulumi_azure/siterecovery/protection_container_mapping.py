...
class ProtectionContainerMapping(pulumi.CustomResource):
    ...
    recovery_fabric_name: pulumi.Output[str] = pulumi.property("recoveryFabricName")
    """
    ...
    recovery_source_protection_container_name: pulumi.Output[str] = pulumi.property("recoverySourceProtectionContainerName")
    """
    Name of the source protection container to map.
    """

    recovery_target_protection_container_id: pulumi.Output[str] = pulumi.property("recoveryTargetProtectionContainerId")
    """
