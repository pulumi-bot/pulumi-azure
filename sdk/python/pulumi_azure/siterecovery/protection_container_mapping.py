...
class ProtectionContainerMapping(pulumi.CustomResource):
    ...
    """
    recovery_fabric_name: pulumi.Output[str] = pulumi.output_property("recoveryFabricName")
    """
    ...
    """
    recovery_source_protection_container_name: pulumi.Output[str] = pulumi.output_property("recoverySourceProtectionContainerName")
    """
    Name of the source protection container to map.
    """
    recovery_target_protection_container_id: pulumi.Output[str] = pulumi.output_property("recoveryTargetProtectionContainerId")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, name: Optional[pulumi.Input[str]] = None, recovery_fabric_name: Optional[pulumi.Input[str]] = None, recovery_replication_policy_id: Optional[pulumi.Input[str]] = None, recovery_source_protection_container_name: Optional[pulumi.Input[str]] = None, recovery_target_protection_container_id: Optional[pulumi.Input[str]] = None, recovery_vault_name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, name: Optional[pulumi.Input[str]] = None, recovery_fabric_name: Optional[pulumi.Input[str]] = None, recovery_replication_policy_id: Optional[pulumi.Input[str]] = None, recovery_source_protection_container_name: Optional[pulumi.Input[str]] = None, recovery_target_protection_container_id: Optional[pulumi.Input[str]] = None, recovery_vault_name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None) -> 'ProtectionContainerMapping':
        """
