...
class NetworkMapping(pulumi.CustomResource):
    ...
    source_network_id: pulumi.Output[str] = pulumi.property("sourceNetworkId")
    """
    ...
    target_recovery_fabric_name: pulumi.Output[str] = pulumi.property("targetRecoveryFabricName")
    """
