...
class NetworkMapping(pulumi.CustomResource):
    ...
    """
    source_network_id: pulumi.Output[str] = pulumi.output_property("sourceNetworkId")
    """
    ...
    """
    target_network_id: pulumi.Output[str] = pulumi.output_property("targetNetworkId")
    """
    The id of the recovery network.
    """
    target_recovery_fabric_name: pulumi.Output[str] = pulumi.output_property("targetRecoveryFabricName")
    """
    The Azure Site Recovery fabric object corresponding to the recovery Azure region.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, name: Optional[pulumi.Input[str]] = None, recovery_vault_name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, source_network_id: Optional[pulumi.Input[str]] = None, source_recovery_fabric_name: Optional[pulumi.Input[str]] = None, target_network_id: Optional[pulumi.Input[str]] = None, target_recovery_fabric_name: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, name: Optional[pulumi.Input[str]] = None, recovery_vault_name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, source_network_id: Optional[pulumi.Input[str]] = None, source_recovery_fabric_name: Optional[pulumi.Input[str]] = None, target_network_id: Optional[pulumi.Input[str]] = None, target_recovery_fabric_name: Optional[pulumi.Input[str]] = None) -> 'NetworkMapping':
        """
