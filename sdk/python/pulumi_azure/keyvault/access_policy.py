...
class AccessPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, application_id: Optional[pulumi.Input[str]] = None, certificate_permissions: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, key_permissions: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, key_vault_id: Optional[pulumi.Input[str]] = None, object_id: Optional[pulumi.Input[str]] = None, secret_permissions: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, storage_permissions: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, tenant_id: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, application_id: Optional[pulumi.Input[str]] = None, certificate_permissions: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, key_permissions: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, key_vault_id: Optional[pulumi.Input[str]] = None, object_id: Optional[pulumi.Input[str]] = None, secret_permissions: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, storage_permissions: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, tenant_id: Optional[pulumi.Input[str]] = None) -> 'AccessPolicy':
        """
