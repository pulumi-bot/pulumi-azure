...
class Certifiate(pulumi.CustomResource):
    certificate: pulumi.Output[Optional['outputs.CertifiateCertificate']] = pulumi.property("certificate")
    """
    A `certificate` block as defined below, used to Import an existing certificate.
    """

    certificate_attributes: pulumi.Output[List['outputs.CertifiateCertificateAttribute']] = pulumi.property("certificateAttributes")
    """
    ...
    certificate_policy: pulumi.Output['outputs.CertifiateCertificatePolicy'] = pulumi.property("certificatePolicy")
    """
