...
class CertificateIssuer(pulumi.CustomResource):
    account_id: pulumi.Output[Optional[str]] = pulumi.output_property("accountId")
    """
    The account number with the third-party Certificate Issuer.
    """
    admins: pulumi.Output[Optional[List['outputs.CertificateIssuerAdmin']]] = pulumi.output_property("admins")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, account_id: Optional[pulumi.Input[str]] = None, admins: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['CertificateIssuerAdminArgs']]]]] = None, key_vault_id: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, org_id: Optional[pulumi.Input[str]] = None, password: Optional[pulumi.Input[str]] = None, provider_name: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, account_id: Optional[pulumi.Input[str]] = None, admins: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['CertificateIssuerAdminArgs']]]]] = None, key_vault_id: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, org_id: Optional[pulumi.Input[str]] = None, password: Optional[pulumi.Input[str]] = None, provider_name: Optional[pulumi.Input[str]] = None) -> 'CertificateIssuer':
        """
