...
class CertifiateCertificateAttributeArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "notBefore", not_before)
        pulumi.set(__self__, "recoveryLevel", recovery_level)
...
class CertifiateCertificatePolicyArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "issuerParameters", issuer_parameters)
        pulumi.set(__self__, "keyProperties", key_properties)
        pulumi.set(__self__, "secretProperties", secret_properties)
        pulumi.set(__self__, "lifetimeActions", lifetime_actions)
        pulumi.set(__self__, "x509CertificateProperties", x509_certificate_properties)
...
class CertifiateCertificatePolicyKeyPropertiesArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "keySize", key_size)
        pulumi.set(__self__, "keyType", key_type)
        pulumi.set(__self__, "reuseKey", reuse_key)
...
class CertifiateCertificatePolicyLifetimeActionActionArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "actionType", action_type)
...
class CertifiateCertificatePolicyLifetimeActionTriggerArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "daysBeforeExpiry", days_before_expiry)
        pulumi.set(__self__, "lifetimePercentage", lifetime_percentage)
...
class CertifiateCertificatePolicyX509CertificatePropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "keyUsages", key_usages)
        pulumi.set(__self__, "subject", subject)
        pulumi.set(__self__, "validityInMonths", validity_in_months)
        pulumi.set(__self__, "extendedKeyUsages", extended_key_usages)
        pulumi.set(__self__, "subjectAlternativeNames", subject_alternative_names)
...
class CertifiateCertificatePolicyX509CertificatePropertiesSubjectAlternativeNamesArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "dnsNames", dns_names)
...
class CertificateIssuerAdminArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "firstName", first_name)
        pulumi.set(__self__, "lastName", last_name)
...
class KeyVaultAccessPolicyArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "certificatePermissions", certificate_permissions)
        pulumi.set(__self__, "keyPermissions", key_permissions)
        pulumi.set(__self__, "secretPermissions", secret_permissions)
        pulumi.set(__self__, "storagePermissions", storage_permissions)
...
class KeyVaultNetworkAclsArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "virtualNetworkSubnetIds", virtual_network_subnet_ids)
