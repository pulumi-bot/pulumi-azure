...
class Key(pulumi.CustomResource):
    curve: pulumi.Output[str] = pulumi.property("curve")
    """
    ...
    e: pulumi.Output[str] = pulumi.property("e")
    """
    ...
    key_opts: pulumi.Output[List[str]] = pulumi.property("keyOpts")
    """
    ...
    n: pulumi.Output[str] = pulumi.property("n")
    """
    ...
    x: pulumi.Output[str] = pulumi.property("x")
    """
    The EC X component of this Key Vault Key.
    """

    y: pulumi.Output[str] = pulumi.property("y")
    """
