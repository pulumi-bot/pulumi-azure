...
class Certificate(pulumi.CustomResource):
    certificate: pulumi.Output[Optional['outputs.CertificateCertificate']] = pulumi.property("certificate")
    """
    A `certificate` block as defined below, used to Import an existing certificate.
    """

    certificate_attributes: pulumi.Output[List['outputs.CertificateCertificateAttribute']] = pulumi.property("certificateAttributes")
    """
    A `certificate_attribute` block as defined below.
    """

    certificate_data: pulumi.Output[str] = pulumi.property("certificateData")
    """
    The raw Key Vault Certificate data represented as a hexadecimal string.
    """

    certificate_policy: pulumi.Output['outputs.CertificateCertificatePolicy'] = pulumi.property("certificatePolicy")
    """
