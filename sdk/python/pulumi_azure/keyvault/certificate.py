...
class Certificate(pulumi.CustomResource):
    certificate: pulumi.Output[Optional['outputs.CertificateCertificate']] = pulumi.output_property("certificate")
    """
    A `certificate` block as defined below, used to Import an existing certificate.
    """
    certificate_attributes: pulumi.Output[List['outputs.CertificateCertificateAttribute']] = pulumi.output_property("certificateAttributes")
    """
    ...
    """
    certificate_policy: pulumi.Output['outputs.CertificateCertificatePolicy'] = pulumi.output_property("certificatePolicy")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, certificate: Optional[pulumi.Input[pulumi.InputType['CertificateCertificateArgs']]] = None, certificate_policy: Optional[pulumi.Input[pulumi.InputType['CertificateCertificatePolicyArgs']]] = None, key_vault_id: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, certificate: Optional[pulumi.Input[pulumi.InputType['CertificateCertificateArgs']]] = None, certificate_attributes: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['CertificateCertificateAttributeArgs']]]]] = None, certificate_data: Optional[pulumi.Input[str]] = None, certificate_policy: Optional[pulumi.Input[pulumi.InputType['CertificateCertificatePolicyArgs']]] = None, key_vault_id: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, secret_id: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, thumbprint: Optional[pulumi.Input[str]] = None, version: Optional[pulumi.Input[str]] = None) -> 'Certificate':
        """
