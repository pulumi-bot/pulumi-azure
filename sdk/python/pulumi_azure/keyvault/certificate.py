...
class Certificate(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, certificate=None, certificate_policy=None, key_vault_id=None, name=None, tags=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    def get(resource_name, id, opts=None, certificate=None, certificate_attributes=None, certificate_data=None, certificate_policy=None, key_vault_id=None, name=None, secret_id=None, tags=None, thumbprint=None, version=None):
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input['CertificateCertificateArgs'] certificate: A `certificate` block as defined below, used to Import an existing certificate.
        :param pulumi.Input[List[pulumi.Input['CertificateCertificateAttributeArgs']]] certificate_attributes: A `certificate_attribute` block as defined below.
