...
class KeyVault(pulumi.CustomResource):
    access_policies: pulumi.Output[List['outputs.KeyVaultAccessPolicy']] = pulumi.property("accessPolicies")
    """
    A list of up to 16 objects describing access policies, as described below.
    """

    enabled_for_deployment: pulumi.Output[Optional[bool]] = pulumi.property("enabledForDeployment")
    """
    Boolean flag to specify whether Azure Virtual Machines are permitted to retrieve certificates stored as secrets from the key vault. Defaults to `false`.
    """

    enabled_for_disk_encryption: pulumi.Output[Optional[bool]] = pulumi.property("enabledForDiskEncryption")
    """
    Boolean flag to specify whether Azure Disk Encryption is permitted to retrieve secrets from the vault and unwrap keys. Defaults to `false`.
    """

    enabled_for_template_deployment: pulumi.Output[Optional[bool]] = pulumi.property("enabledForTemplateDeployment")
    """
    ...
    network_acls: pulumi.Output['outputs.KeyVaultNetworkAcls'] = pulumi.property("networkAcls")
    """
    A `network_acls` block as defined below.
    """

    purge_protection_enabled: pulumi.Output[Optional[bool]] = pulumi.property("purgeProtectionEnabled")
    """
    ...
    soft_delete_enabled: pulumi.Output[Optional[bool]] = pulumi.property("softDeleteEnabled")
    """
    ...
    vault_uri: pulumi.Output[str] = pulumi.property("vaultUri")
    """
