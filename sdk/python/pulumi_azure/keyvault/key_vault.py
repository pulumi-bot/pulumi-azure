...
class KeyVault(pulumi.CustomResource):
    access_policies: pulumi.Output[List['outputs.KeyVaultAccessPolicy']] = pulumi.output_property("accessPolicies")
    """
    A list of up to 16 objects describing access policies, as described below.
    """
    enabled_for_deployment: pulumi.Output[Optional[bool]] = pulumi.output_property("enabledForDeployment")
    """
    Boolean flag to specify whether Azure Virtual Machines are permitted to retrieve certificates stored as secrets from the key vault. Defaults to `false`.
    """
    enabled_for_disk_encryption: pulumi.Output[Optional[bool]] = pulumi.output_property("enabledForDiskEncryption")
    """
    Boolean flag to specify whether Azure Disk Encryption is permitted to retrieve secrets from the vault and unwrap keys. Defaults to `false`.
    """
    enabled_for_template_deployment: pulumi.Output[Optional[bool]] = pulumi.output_property("enabledForTemplateDeployment")
    """
    ...
    """
    network_acls: pulumi.Output['outputs.KeyVaultNetworkAcls'] = pulumi.output_property("networkAcls")
    """
    A `network_acls` block as defined below.
    """
    purge_protection_enabled: pulumi.Output[Optional[bool]] = pulumi.output_property("purgeProtectionEnabled")
    """
    ...
    """
    vault_uri: pulumi.Output[str] = pulumi.output_property("vaultUri")
    """
    The URI of the Key Vault, used for performing operations on keys and secrets.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, access_policies: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['KeyVaultAccessPolicyArgs']]]]] = None, enabled_for_deployment: Optional[pulumi.Input[bool]] = None, enabled_for_disk_encryption: Optional[pulumi.Input[bool]] = None, enabled_for_template_deployment: Optional[pulumi.Input[bool]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, network_acls: Optional[pulumi.Input[pulumi.InputType['KeyVaultNetworkAclsArgs']]] = None, purge_protection_enabled: Optional[pulumi.Input[bool]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, sku_name: Optional[pulumi.Input[str]] = None, soft_delete_enabled: Optional[pulumi.Input[bool]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, tenant_id: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        Manages a Key Vault.
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, access_policies: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['KeyVaultAccessPolicyArgs']]]]] = None, enabled_for_deployment: Optional[pulumi.Input[bool]] = None, enabled_for_disk_encryption: Optional[pulumi.Input[bool]] = None, enabled_for_template_deployment: Optional[pulumi.Input[bool]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, network_acls: Optional[pulumi.Input[pulumi.InputType['KeyVaultNetworkAclsArgs']]] = None, purge_protection_enabled: Optional[pulumi.Input[bool]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, sku_name: Optional[pulumi.Input[str]] = None, soft_delete_enabled: Optional[pulumi.Input[bool]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, tenant_id: Optional[pulumi.Input[str]] = None, vault_uri: Optional[pulumi.Input[str]] = None) -> 'KeyVault':
        """
