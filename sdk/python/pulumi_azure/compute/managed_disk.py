...
class ManagedDisk(pulumi.CustomResource):
    ...
    disk_iops_read_write: pulumi.Output[float] = pulumi.property("diskIopsReadWrite")
    """
    The number of IOPS allowed for this disk; only settable for UltraSSD disks. One operation can transfer between 4k and 256k bytes.
    """

    disk_mbps_read_write: pulumi.Output[float] = pulumi.property("diskMbpsReadWrite")
    """
    ...
    encryption_settings: pulumi.Output[Optional['outputs.ManagedDiskEncryptionSettings']] = pulumi.property("encryptionSettings")
    """
    A `encryption_settings` block as defined below.
    """

    image_reference_id: pulumi.Output[Optional[str]] = pulumi.property("imageReferenceId")
    """
    ...
    source_uri: pulumi.Output[str] = pulumi.property("sourceUri")
    """
    ...
    storage_account_type: pulumi.Output[str] = pulumi.property("storageAccountType")
    """
