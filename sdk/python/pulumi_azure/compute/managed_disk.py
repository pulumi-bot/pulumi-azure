...
class ManagedDisk(pulumi.CustomResource):
    create_option: pulumi.Output[str] = pulumi.output_property("createOption")
    """
    ...
    """
    disk_iops_read_write: pulumi.Output[float] = pulumi.output_property("diskIopsReadWrite")
    """
    The number of IOPS allowed for this disk; only settable for UltraSSD disks. One operation can transfer between 4k and 256k bytes.
    """
    disk_mbps_read_write: pulumi.Output[float] = pulumi.output_property("diskMbpsReadWrite")
    """
    ...
    """
    encryption_settings: pulumi.Output[Optional['outputs.ManagedDiskEncryptionSettings']] = pulumi.output_property("encryptionSettings")
    """
    A `encryption_settings` block as defined below.
    """
    image_reference_id: pulumi.Output[Optional[str]] = pulumi.output_property("imageReferenceId")
    """
    ...
    """
    source_resource_id: pulumi.Output[Optional[str]] = pulumi.output_property("sourceResourceId")
    """
    ...
    """
    source_uri: pulumi.Output[str] = pulumi.output_property("sourceUri")
    """
    ...
    """
    storage_account_type: pulumi.Output[str] = pulumi.output_property("storageAccountType")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, create_option: Optional[pulumi.Input[str]] = None, disk_encryption_set_id: Optional[pulumi.Input[str]] = None, disk_iops_read_write: Optional[pulumi.Input[float]] = None, disk_mbps_read_write: Optional[pulumi.Input[float]] = None, disk_size_gb: Optional[pulumi.Input[float]] = None, encryption_settings: Optional[pulumi.Input[pulumi.InputType['ManagedDiskEncryptionSettingsArgs']]] = None, image_reference_id: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, os_type: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, source_resource_id: Optional[pulumi.Input[str]] = None, source_uri: Optional[pulumi.Input[str]] = None, storage_account_id: Optional[pulumi.Input[str]] = None, storage_account_type: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, zones: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, create_option: Optional[pulumi.Input[str]] = None, disk_encryption_set_id: Optional[pulumi.Input[str]] = None, disk_iops_read_write: Optional[pulumi.Input[float]] = None, disk_mbps_read_write: Optional[pulumi.Input[float]] = None, disk_size_gb: Optional[pulumi.Input[float]] = None, encryption_settings: Optional[pulumi.Input[pulumi.InputType['ManagedDiskEncryptionSettingsArgs']]] = None, image_reference_id: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, os_type: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, source_resource_id: Optional[pulumi.Input[str]] = None, source_uri: Optional[pulumi.Input[str]] = None, storage_account_id: Optional[pulumi.Input[str]] = None, storage_account_type: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, zones: Optional[pulumi.Input[str]] = None) -> 'ManagedDisk':
        """
