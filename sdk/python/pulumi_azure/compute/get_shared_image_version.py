...
@pulumi.output_type
class _GetSharedImageVersionResult(dict):
...
def get_shared_image_version(gallery_name: Optional[str] = None,
    ...
    return AwaitableGetSharedImageVersionResult(
        exclude_from_latest=_utilities.get_dict_value(__ret__, 'excludeFromLatest'),
        ...
        managed_image_id=_utilities.get_dict_value(__ret__, 'managedImageId'),
        name=_utilities.get_dict_value(__ret__, 'name'),
        os_disk_snapshot_id=_utilities.get_dict_value(__ret__, 'osDiskSnapshotId'),
        resource_group_name=_utilities.get_dict_value(__ret__, 'resourceGroupName'),
        tags=_utilities.get_dict_value(__ret__, 'tags'),
        target_regions=_utilities.get_dict_value(__ret__, 'targetRegions'))
