...
class DataDiskAttachment(pulumi.CustomResource):
    caching: pulumi.Output[str] = pulumi.output_property("caching")
    """
    Specifies the caching requirements for this Data Disk. Possible values include `None`, `ReadOnly` and `ReadWrite`.
    """
    create_option: pulumi.Output[Optional[str]] = pulumi.output_property("createOption")
    """
    The Create Option of the Data Disk, such as `Empty` or `Attach`. Defaults to `Attach`. Changing this forces a new resource to be created.
    """
    lun: pulumi.Output[float] = pulumi.output_property("lun")
    """
    The Logical Unit Number of the Data Disk, which needs to be unique within the Virtual Machine. Changing this forces a new resource to be created.
    """
    managed_disk_id: pulumi.Output[str] = pulumi.output_property("managedDiskId")
    """
    ...
    """
    write_accelerator_enabled: pulumi.Output[Optional[bool]] = pulumi.output_property("writeAcceleratorEnabled")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, caching: Optional[pulumi.Input[str]] = None, create_option: Optional[pulumi.Input[str]] = None, lun: Optional[pulumi.Input[float]] = None, managed_disk_id: Optional[pulumi.Input[str]] = None, virtual_machine_id: Optional[pulumi.Input[str]] = None, write_accelerator_enabled: Optional[pulumi.Input[bool]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, caching: Optional[pulumi.Input[str]] = None, create_option: Optional[pulumi.Input[str]] = None, lun: Optional[pulumi.Input[float]] = None, managed_disk_id: Optional[pulumi.Input[str]] = None, virtual_machine_id: Optional[pulumi.Input[str]] = None, write_accelerator_enabled: Optional[pulumi.Input[bool]] = None) -> 'DataDiskAttachment':
        """
