...
class BastionHost(pulumi.CustomResource):
    ...
    """
    ip_configuration: pulumi.Output[Optional['outputs.BastionHostIpConfiguration']] = pulumi.output_property("ipConfiguration")
    """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, dns_name: Optional[pulumi.Input[str]] = None, ip_configuration: Optional[pulumi.Input[pulumi.InputType['BastionHostIpConfigurationArgs']]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None) -> 'BastionHost':
        """
