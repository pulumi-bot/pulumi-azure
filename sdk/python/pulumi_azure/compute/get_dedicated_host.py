...
@pulumi.output_type
class _GetDedicatedHostResult(dict):
    dedicated_host_group_name: str = pulumi.property("dedicatedHostGroupName")
...
def get_dedicated_host(dedicated_host_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure:compute/getDedicatedHost:getDedicatedHost', __args__, opts=opts, typ=_GetDedicatedHostResult).value

    return AwaitableGetDedicatedHostResult(
        dedicated_host_group_name=_utilities.get_dict_value(__ret__, 'dedicatedHostGroupName'),
