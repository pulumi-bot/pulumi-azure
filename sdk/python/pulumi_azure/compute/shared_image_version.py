...
class SharedImageVersion(pulumi.CustomResource):
    exclude_from_latest: pulumi.Output[Optional[bool]] = pulumi.property("excludeFromLatest")
    """
    ...
    image_name: pulumi.Output[str] = pulumi.property("imageName")
    """
    ...
    managed_image_id: pulumi.Output[Optional[str]] = pulumi.property("managedImageId")
    """
    ...
    os_disk_snapshot_id: pulumi.Output[Optional[str]] = pulumi.property("osDiskSnapshotId")
    """
    ...
    target_regions: pulumi.Output[List['outputs.SharedImageVersionTargetRegion']] = pulumi.property("targetRegions")
    """
