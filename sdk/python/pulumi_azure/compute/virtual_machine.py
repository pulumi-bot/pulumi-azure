...
class VirtualMachine(pulumi.CustomResource):
    additional_capabilities: pulumi.Output[Optional['outputs.VirtualMachineAdditionalCapabilities']] = pulumi.property("additionalCapabilities")
    """
    A `additional_capabilities` block.
    """

    availability_set_id: pulumi.Output[str] = pulumi.property("availabilitySetId")
    """
    The ID of the Availability Set in which the Virtual Machine should exist. Changing this forces a new resource to be created.
    """

    boot_diagnostics: pulumi.Output[Optional['outputs.VirtualMachineBootDiagnostics']] = pulumi.property("bootDiagnostics")
    """
    A `boot_diagnostics` block.
    """

    delete_data_disks_on_termination: pulumi.Output[Optional[bool]] = pulumi.property("deleteDataDisksOnTermination")
    """
    Should the Data Disks (either the Managed Disks / VHD Blobs) be deleted when the Virtual Machine is destroyed? Defaults to `false`.
    """

    delete_os_disk_on_termination: pulumi.Output[Optional[bool]] = pulumi.property("deleteOsDiskOnTermination")
    """
    Should the OS Disk (either the Managed Disk / VHD Blob) be deleted when the Virtual Machine is destroyed? Defaults to `false`.
    """

    identity: pulumi.Output['outputs.VirtualMachineIdentity'] = pulumi.property("identity")
    """
    A `identity` block.
    """
    ...
    os_profile: pulumi.Output[Optional['outputs.VirtualMachineOsProfile']] = pulumi.property("osProfile")
    """
    An `os_profile` block. Required when `create_option` in the `storage_os_disk` block is set to `FromImage`.
    """

    os_profile_linux_config: pulumi.Output[Optional['outputs.VirtualMachineOsProfileLinuxConfig']] = pulumi.property("osProfileLinuxConfig")
    """
    A `os_profile_linux_config` block.
    """

    os_profile_secrets: pulumi.Output[Optional[List['outputs.VirtualMachineOsProfileSecret']]] = pulumi.property("osProfileSecrets")
    """
    One or more `os_profile_secrets` blocks.
    """

    os_profile_windows_config: pulumi.Output[Optional['outputs.VirtualMachineOsProfileWindowsConfig']] = pulumi.property("osProfileWindowsConfig")
    """
    A `os_profile_windows_config` block.
    """

    plan: pulumi.Output[Optional['outputs.VirtualMachinePlan']] = pulumi.property("plan")
    """
    A `plan` block.
    """

    primary_network_interface_id: pulumi.Output[Optional[str]] = pulumi.property("primaryNetworkInterfaceId")
    """
    ...
    storage_data_disks: pulumi.Output[List['outputs.VirtualMachineStorageDataDisk']] = pulumi.property("storageDataDisks")
    """
    One or more `storage_data_disk` blocks.
    """

    storage_image_reference: pulumi.Output['outputs.VirtualMachineStorageImageReference'] = pulumi.property("storageImageReference")
    """
    A `storage_image_reference` block.
    """

    storage_os_disk: pulumi.Output['outputs.VirtualMachineStorageOsDisk'] = pulumi.property("storageOsDisk")
    """
    ...
    vm_size: pulumi.Output[str] = pulumi.property("vmSize")
    """
