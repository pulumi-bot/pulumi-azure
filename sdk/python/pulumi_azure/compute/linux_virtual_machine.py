...
class LinuxVirtualMachine(pulumi.CustomResource):
    additional_capabilities: pulumi.Output[Optional['outputs.LinuxVirtualMachineAdditionalCapabilities']] = pulumi.property("additionalCapabilities")
    """
    ...
    admin_ssh_keys: pulumi.Output[Optional[List['outputs.LinuxVirtualMachineAdminSshKey']]] = pulumi.property("adminSshKeys")
    """
    ...
    boot_diagnostics: pulumi.Output[Optional['outputs.LinuxVirtualMachineBootDiagnostics']] = pulumi.property("bootDiagnostics")
    """
    ...
    identity: pulumi.Output[Optional['outputs.LinuxVirtualMachineIdentity']] = pulumi.property("identity")
    """
    ...
    os_disk: pulumi.Output['outputs.LinuxVirtualMachineOsDisk'] = pulumi.property("osDisk")
    """
    A `os_disk` block as defined below.
    """

    plan: pulumi.Output[Optional['outputs.LinuxVirtualMachinePlan']] = pulumi.property("plan")
    """
    ...
    secrets: pulumi.Output[Optional[List['outputs.LinuxVirtualMachineSecret']]] = pulumi.property("secrets")
    """
    ...
    source_image_reference: pulumi.Output[Optional['outputs.LinuxVirtualMachineSourceImageReference']] = pulumi.property("sourceImageReference")
    """
