...
class WindowsVirtualMachineScaleSet(pulumi.CustomResource):
    additional_capabilities: pulumi.Output[Optional['outputs.WindowsVirtualMachineScaleSetAdditionalCapabilities']] = pulumi.property("additionalCapabilities")
    """
    A `additional_capabilities` block as defined below.
    """

    additional_unattend_contents: pulumi.Output[Optional[List['outputs.WindowsVirtualMachineScaleSetAdditionalUnattendContent']]] = pulumi.property("additionalUnattendContents")
    """
    ...
    automatic_instance_repair: pulumi.Output['outputs.WindowsVirtualMachineScaleSetAutomaticInstanceRepair'] = pulumi.property("automaticInstanceRepair")
    """
    ...
    automatic_os_upgrade_policy: pulumi.Output[Optional['outputs.WindowsVirtualMachineScaleSetAutomaticOsUpgradePolicy']] = pulumi.property("automaticOsUpgradePolicy")
    """
    ...
    boot_diagnostics: pulumi.Output[Optional['outputs.WindowsVirtualMachineScaleSetBootDiagnostics']] = pulumi.property("bootDiagnostics")
    """
    A `boot_diagnostics` block as defined below.
    """

    computer_name_prefix: pulumi.Output[str] = pulumi.property("computerNamePrefix")
    """
    ...
    data_disks: pulumi.Output[Optional[List['outputs.WindowsVirtualMachineScaleSetDataDisk']]] = pulumi.property("dataDisks")
    """
    One or more `data_disk` blocks as defined below.
    """

    do_not_run_extensions_on_overprovisioned_machines: pulumi.Output[Optional[bool]] = pulumi.property("doNotRunExtensionsOnOverprovisionedMachines")
    """
    ...
    identity: pulumi.Output[Optional['outputs.WindowsVirtualMachineScaleSetIdentity']] = pulumi.property("identity")
    """
    A `identity` block as defined below.
    """

    instances: pulumi.Output[float] = pulumi.property("instances")
    """
    ...
    network_interfaces: pulumi.Output[List['outputs.WindowsVirtualMachineScaleSetNetworkInterface']] = pulumi.property("networkInterfaces")
    """
    One or more `network_interface` blocks as defined below.
    """

    os_disk: pulumi.Output['outputs.WindowsVirtualMachineScaleSetOsDisk'] = pulumi.property("osDisk")
    """
    ...
    plan: pulumi.Output[Optional['outputs.WindowsVirtualMachineScaleSetPlan']] = pulumi.property("plan")
    ...
    rolling_upgrade_policy: pulumi.Output[Optional['outputs.WindowsVirtualMachineScaleSetRollingUpgradePolicy']] = pulumi.property("rollingUpgradePolicy")
    """
    ...
    scale_in_policy: pulumi.Output[Optional[str]] = pulumi.property("scaleInPolicy")
    """
    ...
    secrets: pulumi.Output[Optional[List['outputs.WindowsVirtualMachineScaleSetSecret']]] = pulumi.property("secrets")
    """
    ...
    source_image_reference: pulumi.Output[Optional['outputs.WindowsVirtualMachineScaleSetSourceImageReference']] = pulumi.property("sourceImageReference")
    """
    ...
    terminate_notification: pulumi.Output['outputs.WindowsVirtualMachineScaleSetTerminateNotification'] = pulumi.property("terminateNotification")
    """
    ...
    upgrade_mode: pulumi.Output[Optional[str]] = pulumi.property("upgradeMode")
    """
    ...
    winrm_listeners: pulumi.Output[Optional[List['outputs.WindowsVirtualMachineScaleSetWinrmListener']]] = pulumi.property("winrmListeners")
    """
    One or more `winrm_listener` blocks as defined below.
    """

    zone_balance: pulumi.Output[Optional[bool]] = pulumi.property("zoneBalance")
    """
    ...
    def __init__(__self__,
                 ...
                 additional_unattend_contents: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetAdditionalUnattendContentArgs']]]]] = None,
                 ...
                 data_disks: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetDataDiskArgs']]]]] = None,
                 ...
                 network_interfaces: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetNetworkInterfaceArgs']]]]] = None,
                 ...
                 secrets: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetSecretArgs']]]]] = None,
                 ...
                 winrm_listeners: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetWinrmListenerArgs']]]]] = None,
    ...
    def get(resource_name: str,
            ...
            winrm_listeners: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetWinrmListenerArgs']]]]] = None,
            zone_balance: Optional[pulumi.Input[bool]] = None,
            zones: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None) -> 'WindowsVirtualMachineScaleSet':
        """
