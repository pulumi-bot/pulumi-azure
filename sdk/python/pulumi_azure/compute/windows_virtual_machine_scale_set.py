...
__all__ = ['WindowsVirtualMachineScaleSet']


class WindowsVirtualMachineScaleSet(pulumi.CustomResource):
    additional_capabilities: pulumi.Output[Optional['outputs.WindowsVirtualMachineScaleSetAdditionalCapabilities']] = pulumi.output_property("additionalCapabilities")
    """
    A `additional_capabilities` block as defined below.
    """
    additional_unattend_contents: pulumi.Output[Optional[List['outputs.WindowsVirtualMachineScaleSetAdditionalUnattendContent']]] = pulumi.output_property("additionalUnattendContents")
    """
    ...
    """
    automatic_instance_repair: pulumi.Output['outputs.WindowsVirtualMachineScaleSetAutomaticInstanceRepair'] = pulumi.output_property("automaticInstanceRepair")
    """
    ...
    """
    automatic_os_upgrade_policy: pulumi.Output[Optional['outputs.WindowsVirtualMachineScaleSetAutomaticOsUpgradePolicy']] = pulumi.output_property("automaticOsUpgradePolicy")
    """
    ...
    """
    boot_diagnostics: pulumi.Output[Optional['outputs.WindowsVirtualMachineScaleSetBootDiagnostics']] = pulumi.output_property("bootDiagnostics")
    """
    ...
    """
    data_disks: pulumi.Output[Optional[List['outputs.WindowsVirtualMachineScaleSetDataDisk']]] = pulumi.output_property("dataDisks")
    """
    ...
    """
    enable_automatic_updates: pulumi.Output[Optional[bool]] = pulumi.output_property("enableAutomaticUpdates")
    """
    ...
    """
    identity: pulumi.Output[Optional['outputs.WindowsVirtualMachineScaleSetIdentity']] = pulumi.output_property("identity")
    """
    ...
    """
    network_interfaces: pulumi.Output[List['outputs.WindowsVirtualMachineScaleSetNetworkInterface']] = pulumi.output_property("networkInterfaces")
    """
    One or more `network_interface` blocks as defined below.
    """
    os_disk: pulumi.Output['outputs.WindowsVirtualMachineScaleSetOsDisk'] = pulumi.output_property("osDisk")
    """
    ...
    """
    plan: pulumi.Output[Optional['outputs.WindowsVirtualMachineScaleSetPlan']] = pulumi.output_property("plan")
    ...
    """
    rolling_upgrade_policy: pulumi.Output[Optional['outputs.WindowsVirtualMachineScaleSetRollingUpgradePolicy']] = pulumi.output_property("rollingUpgradePolicy")
    """
    ...
    """
    secrets: pulumi.Output[Optional[List['outputs.WindowsVirtualMachineScaleSetSecret']]] = pulumi.output_property("secrets")
    """
    ...
    """
    source_image_reference: pulumi.Output[Optional['outputs.WindowsVirtualMachineScaleSetSourceImageReference']] = pulumi.output_property("sourceImageReference")
    """
    ...
    """
    terminate_notification: pulumi.Output['outputs.WindowsVirtualMachineScaleSetTerminateNotification'] = pulumi.output_property("terminateNotification")
    """
    ...
    """
    winrm_listeners: pulumi.Output[Optional[List['outputs.WindowsVirtualMachineScaleSetWinrmListener']]] = pulumi.output_property("winrmListeners")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, additional_capabilities: Optional[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetAdditionalCapabilitiesArgs']]] = None, additional_unattend_contents: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetAdditionalUnattendContentArgs']]]]] = None, admin_password: Optional[pulumi.Input[str]] = None, admin_username: Optional[pulumi.Input[str]] = None, automatic_instance_repair: Optional[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetAutomaticInstanceRepairArgs']]] = None, automatic_os_upgrade_policy: Optional[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetAutomaticOsUpgradePolicyArgs']]] = None, boot_diagnostics: Optional[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetBootDiagnosticsArgs']]] = None, computer_name_prefix: Optional[pulumi.Input[str]] = None, custom_data: Optional[pulumi.Input[str]] = None, data_disks: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetDataDiskArgs']]]]] = None, do_not_run_extensions_on_overprovisioned_machines: Optional[pulumi.Input[bool]] = None, enable_automatic_updates: Optional[pulumi.Input[bool]] = None, eviction_policy: Optional[pulumi.Input[str]] = None, health_probe_id: Optional[pulumi.Input[str]] = None, identity: Optional[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetIdentityArgs']]] = None, instances: Optional[pulumi.Input[float]] = None, license_type: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, max_bid_price: Optional[pulumi.Input[float]] = None, name: Optional[pulumi.Input[str]] = None, network_interfaces: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetNetworkInterfaceArgs']]]]] = None, os_disk: Optional[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetOsDiskArgs']]] = None, overprovision: Optional[pulumi.Input[bool]] = None, plan: Optional[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetPlanArgs']]] = None, priority: Optional[pulumi.Input[str]] = None, provision_vm_agent: Optional[pulumi.Input[bool]] = None, proximity_placement_group_id: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, rolling_upgrade_policy: Optional[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetRollingUpgradePolicyArgs']]] = None, scale_in_policy: Optional[pulumi.Input[str]] = None, secrets: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetSecretArgs']]]]] = None, single_placement_group: Optional[pulumi.Input[bool]] = None, sku: Optional[pulumi.Input[str]] = None, source_image_id: Optional[pulumi.Input[str]] = None, source_image_reference: Optional[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetSourceImageReferenceArgs']]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, terminate_notification: Optional[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetTerminateNotificationArgs']]] = None, timezone: Optional[pulumi.Input[str]] = None, upgrade_mode: Optional[pulumi.Input[str]] = None, winrm_listeners: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetWinrmListenerArgs']]]]] = None, zone_balance: Optional[pulumi.Input[bool]] = None, zones: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetAdditionalUnattendContentArgs']]]] additional_unattend_contents: One or more `additional_unattend_content` blocks as defined below.
        ...
        :param pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetAutomaticOsUpgradePolicyArgs']] automatic_os_upgrade_policy: A `automatic_os_upgrade_policy` block as defined below. This is Required and can only be specified when `upgrade_mode` is set to `Automatic`.
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetDataDiskArgs']]]] data_disks: One or more `data_disk` blocks as defined below.
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetNetworkInterfaceArgs']]]] network_interfaces: One or more `network_interface` blocks as defined below.
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetSecretArgs']]]] secrets: One or more `secret` blocks as defined below.
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetWinrmListenerArgs']]]] winrm_listeners: One or more `winrm_listener` blocks as defined below.
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, additional_capabilities: Optional[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetAdditionalCapabilitiesArgs']]] = None, additional_unattend_contents: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetAdditionalUnattendContentArgs']]]]] = None, admin_password: Optional[pulumi.Input[str]] = None, admin_username: Optional[pulumi.Input[str]] = None, automatic_instance_repair: Optional[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetAutomaticInstanceRepairArgs']]] = None, automatic_os_upgrade_policy: Optional[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetAutomaticOsUpgradePolicyArgs']]] = None, boot_diagnostics: Optional[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetBootDiagnosticsArgs']]] = None, computer_name_prefix: Optional[pulumi.Input[str]] = None, custom_data: Optional[pulumi.Input[str]] = None, data_disks: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetDataDiskArgs']]]]] = None, do_not_run_extensions_on_overprovisioned_machines: Optional[pulumi.Input[bool]] = None, enable_automatic_updates: Optional[pulumi.Input[bool]] = None, eviction_policy: Optional[pulumi.Input[str]] = None, health_probe_id: Optional[pulumi.Input[str]] = None, identity: Optional[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetIdentityArgs']]] = None, instances: Optional[pulumi.Input[float]] = None, license_type: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, max_bid_price: Optional[pulumi.Input[float]] = None, name: Optional[pulumi.Input[str]] = None, network_interfaces: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetNetworkInterfaceArgs']]]]] = None, os_disk: Optional[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetOsDiskArgs']]] = None, overprovision: Optional[pulumi.Input[bool]] = None, plan: Optional[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetPlanArgs']]] = None, priority: Optional[pulumi.Input[str]] = None, provision_vm_agent: Optional[pulumi.Input[bool]] = None, proximity_placement_group_id: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, rolling_upgrade_policy: Optional[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetRollingUpgradePolicyArgs']]] = None, scale_in_policy: Optional[pulumi.Input[str]] = None, secrets: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetSecretArgs']]]]] = None, single_placement_group: Optional[pulumi.Input[bool]] = None, sku: Optional[pulumi.Input[str]] = None, source_image_id: Optional[pulumi.Input[str]] = None, source_image_reference: Optional[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetSourceImageReferenceArgs']]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, terminate_notification: Optional[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetTerminateNotificationArgs']]] = None, timezone: Optional[pulumi.Input[str]] = None, unique_id: Optional[pulumi.Input[str]] = None, upgrade_mode: Optional[pulumi.Input[str]] = None, winrm_listeners: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['WindowsVirtualMachineScaleSetWinrmListenerArgs']]]]] = None, zone_balance: Optional[pulumi.Input[bool]] = None, zones: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None) -> 'WindowsVirtualMachineScaleSet':
        """
