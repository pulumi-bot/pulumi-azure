...
class DedicatedHost(pulumi.CustomResource):
    auto_replace_on_failure: pulumi.Output[Optional[bool]] = pulumi.property("autoReplaceOnFailure")
    """
    Should the Dedicated Host automatically be replaced in case of a Hardware Failure? Defaults to `true`.
    """

    dedicated_host_group_id: pulumi.Output[str] = pulumi.property("dedicatedHostGroupId")
    """
    ...
    platform_fault_domain: pulumi.Output[float] = pulumi.property("platformFaultDomain")
    """
