...
class VirtualMachineScaleSetExtension(pulumi.CustomResource):
    auto_upgrade_minor_version: pulumi.Output[Optional[bool]] = pulumi.output_property("autoUpgradeMinorVersion")
    """
    Should the latest version of the Extension be used at Deployment Time, if one is available? This won't auto-update the extension on existing installation. Defaults to `true`.
    """
    force_update_tag: pulumi.Output[Optional[str]] = pulumi.output_property("forceUpdateTag")
    """
    ...
    """
    protected_settings: pulumi.Output[Optional[str]] = pulumi.output_property("protectedSettings")
    """
    A JSON String which specifies Sensitive Settings (such as Passwords) for the Extension.
    """
    provision_after_extensions: pulumi.Output[Optional[List[str]]] = pulumi.output_property("provisionAfterExtensions")
    """
    ...
    """
    settings: pulumi.Output[Optional[str]] = pulumi.output_property("settings")
    """
    ...
    """
    type_handler_version: pulumi.Output[str] = pulumi.output_property("typeHandlerVersion")
    """
    Specifies the version of the extension to use, available versions can be found using the Azure CLI.
    """
    virtual_machine_scale_set_id: pulumi.Output[str] = pulumi.output_property("virtualMachineScaleSetId")
    """
    The ID of the Virtual Machine Scale Set. Changing this forces a new resource to be created.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, auto_upgrade_minor_version: Optional[pulumi.Input[bool]] = None, force_update_tag: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, protected_settings: Optional[pulumi.Input[str]] = None, provision_after_extensions: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, publisher: Optional[pulumi.Input[str]] = None, settings: Optional[pulumi.Input[str]] = None, type: Optional[pulumi.Input[str]] = None, type_handler_version: Optional[pulumi.Input[str]] = None, virtual_machine_scale_set_id: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, auto_upgrade_minor_version: Optional[pulumi.Input[bool]] = None, force_update_tag: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, protected_settings: Optional[pulumi.Input[str]] = None, provision_after_extensions: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, publisher: Optional[pulumi.Input[str]] = None, settings: Optional[pulumi.Input[str]] = None, type: Optional[pulumi.Input[str]] = None, type_handler_version: Optional[pulumi.Input[str]] = None, virtual_machine_scale_set_id: Optional[pulumi.Input[str]] = None) -> 'VirtualMachineScaleSetExtension':
        """
