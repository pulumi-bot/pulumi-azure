...
@pulumi.output_type
class _GetVirtualMachineScaleSetResult(dict):
    id: str = pulumi.property("id")
    identities: List['outputs.GetVirtualMachineScaleSetIdentityResult'] = pulumi.property("identities")
...
def get_virtual_machine_scale_set(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure:compute/getVirtualMachineScaleSet:getVirtualMachineScaleSet', __args__, opts=opts, typ=_GetVirtualMachineScaleSetResult).value
