...
class GetSharedImageVersionsImage(dict):
    ...
    def target_regions(self) -> List['outputs.GetSharedImageVersionsImageTargetRegion']:
        """
...
class GetSnapshotEncryptionSetting(dict):
    ...
    def disk_encryption_keys(self) -> List['outputs.GetSnapshotEncryptionSettingDiskEncryptionKey']:
        ...
    ...
    def key_encryption_keys(self) -> List['outputs.GetSnapshotEncryptionSettingKeyEncryptionKey']:
        ...
