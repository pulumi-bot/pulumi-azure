...
class WindowsVirtualMachineSourceImageReference(dict):
    def __init__(__self__, *,
                 ...
                 version: str):
        """
        :param str offer: (Optional) Specifies the offer of the image used to create the virtual machines.
        :param str publisher: Specifies the Publisher of the Marketplace Image this Virtual Machine should be created from. Changing this forces a new resource to be created.
        :param str sku: (Optional) Specifies the SKU of the image used to create the virtual machines.
        :param str version: (Optional) Specifies the version of the image used to create the virtual machines.
        """
        pulumi.set(__self__, "offer", offer)
        pulumi.set(__self__, "publisher", publisher)
        pulumi.set(__self__, "sku", sku)
