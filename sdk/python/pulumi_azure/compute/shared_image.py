...
class SharedImage(pulumi.CustomResource):
    ...
    """
    eula: pulumi.Output[Optional[str]] = pulumi.output_property("eula")
    """
    ...
    """
    identifier: pulumi.Output['outputs.SharedImageIdentifier'] = pulumi.output_property("identifier")
    """
    ...
    """
    privacy_statement_uri: pulumi.Output[Optional[str]] = pulumi.output_property("privacyStatementUri")
    """
    The URI containing the Privacy Statement associated with this Shared Image.
    """
    release_note_uri: pulumi.Output[Optional[str]] = pulumi.output_property("releaseNoteUri")
    """
    ...
    """
    specialized: pulumi.Output[Optional[bool]] = pulumi.output_property("specialized")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, description: Optional[pulumi.Input[str]] = None, eula: Optional[pulumi.Input[str]] = None, gallery_name: Optional[pulumi.Input[str]] = None, hyper_v_generation: Optional[pulumi.Input[str]] = None, identifier: Optional[pulumi.Input[pulumi.InputType['SharedImageIdentifierArgs']]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, os_type: Optional[pulumi.Input[str]] = None, privacy_statement_uri: Optional[pulumi.Input[str]] = None, release_note_uri: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, specialized: Optional[pulumi.Input[bool]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        :param pulumi.Input[Dict[str, pulumi.Input[str]]] tags: A mapping of tags to assign to the Shared Image.
        """
