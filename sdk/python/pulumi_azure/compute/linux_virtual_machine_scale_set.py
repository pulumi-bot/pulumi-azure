...
class LinuxVirtualMachineScaleSet(pulumi.CustomResource):
    additional_capabilities: pulumi.Output[Optional['outputs.LinuxVirtualMachineScaleSetAdditionalCapabilities']] = pulumi.property("additionalCapabilities")
    """
    A `additional_capabilities` block as defined below.
    """

    admin_password: pulumi.Output[Optional[str]] = pulumi.property("adminPassword")
    """
    The Password which should be used for the local-administrator on this Virtual Machine. Changing this forces a new resource to be created.
    """

    admin_ssh_keys: pulumi.Output[Optional[List['outputs.LinuxVirtualMachineScaleSetAdminSshKey']]] = pulumi.property("adminSshKeys")
    """
    ...
    automatic_instance_repair: pulumi.Output['outputs.LinuxVirtualMachineScaleSetAutomaticInstanceRepair'] = pulumi.property("automaticInstanceRepair")
    """
    ...
    automatic_os_upgrade_policy: pulumi.Output[Optional['outputs.LinuxVirtualMachineScaleSetAutomaticOsUpgradePolicy']] = pulumi.property("automaticOsUpgradePolicy")
    """
    ...
    boot_diagnostics: pulumi.Output[Optional['outputs.LinuxVirtualMachineScaleSetBootDiagnostics']] = pulumi.property("bootDiagnostics")
    """
    ...
    data_disks: pulumi.Output[Optional[List['outputs.LinuxVirtualMachineScaleSetDataDisk']]] = pulumi.property("dataDisks")
    """
    One or more `data_disk` blocks as defined below.
    """

    disable_password_authentication: pulumi.Output[Optional[bool]] = pulumi.property("disablePasswordAuthentication")
    """
    ...
    identity: pulumi.Output[Optional['outputs.LinuxVirtualMachineScaleSetIdentity']] = pulumi.property("identity")
    """
    ...
    network_interfaces: pulumi.Output[List['outputs.LinuxVirtualMachineScaleSetNetworkInterface']] = pulumi.property("networkInterfaces")
    """
    One or more `network_interface` blocks as defined below.
    """

    os_disk: pulumi.Output['outputs.LinuxVirtualMachineScaleSetOsDisk'] = pulumi.property("osDisk")
    """
    ...
    plan: pulumi.Output[Optional['outputs.LinuxVirtualMachineScaleSetPlan']] = pulumi.property("plan")
    ...
    rolling_upgrade_policy: pulumi.Output[Optional['outputs.LinuxVirtualMachineScaleSetRollingUpgradePolicy']] = pulumi.property("rollingUpgradePolicy")
    """
    ...
    secrets: pulumi.Output[Optional[List['outputs.LinuxVirtualMachineScaleSetSecret']]] = pulumi.property("secrets")
    """
    ...
    source_image_reference: pulumi.Output[Optional['outputs.LinuxVirtualMachineScaleSetSourceImageReference']] = pulumi.property("sourceImageReference")
    """
    ...
    terminate_notification: pulumi.Output['outputs.LinuxVirtualMachineScaleSetTerminateNotification'] = pulumi.property("terminateNotification")
    """
    ...
    def __init__(__self__,
                 ...
                 admin_ssh_keys: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['LinuxVirtualMachineScaleSetAdminSshKeyArgs']]]]] = None,
                 ...
                 network_interfaces: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['LinuxVirtualMachineScaleSetNetworkInterfaceArgs']]]]] = None,
                 ...
                 secrets: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['LinuxVirtualMachineScaleSetSecretArgs']]]]] = None,
    ...
    def get(resource_name: str,
            ...
            upgrade_mode: Optional[pulumi.Input[str]] = None,
            zone_balance: Optional[pulumi.Input[bool]] = None,
            zones: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None) -> 'LinuxVirtualMachineScaleSet':
        """
