...
class AnalyticsSolution(pulumi.CustomResource):
    ...
    plan: pulumi.Output['outputs.AnalyticsSolutionPlan'] = pulumi.property("plan")
    """
    ...
    solution_name: pulumi.Output[str] = pulumi.property("solutionName")
    """
    ...
    workspace_name: pulumi.Output[str] = pulumi.property("workspaceName")
    """
    The full name of the Log Analytics workspace with which the solution will be linked. Changing this forces a new resource to be created.
    """

    workspace_resource_id: pulumi.Output[str] = pulumi.property("workspaceResourceId")
    """
