...
@pulumi.output_type
class _GetConfigurationStoreResult(dict):
...
def get_configuration_store(name: Optional[str] = None,
    ...
    return AwaitableGetConfigurationStoreResult(
        ...
        primary_read_keys=_utilities.get_dict_value(__ret__, 'primaryReadKeys'),
        primary_write_keys=_utilities.get_dict_value(__ret__, 'primaryWriteKeys'),
        resource_group_name=_utilities.get_dict_value(__ret__, 'resourceGroupName'),
        secondary_read_keys=_utilities.get_dict_value(__ret__, 'secondaryReadKeys'),
        secondary_write_keys=_utilities.get_dict_value(__ret__, 'secondaryWriteKeys'),
