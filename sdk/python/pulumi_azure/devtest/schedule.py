...
class Schedule(pulumi.CustomResource):
    daily_recurrence: pulumi.Output[Optional['outputs.ScheduleDailyRecurrence']] = pulumi.property("dailyRecurrence")

    hourly_recurrence: pulumi.Output[Optional['outputs.ScheduleHourlyRecurrence']] = pulumi.property("hourlyRecurrence")
    ...
    notification_settings: pulumi.Output['outputs.ScheduleNotificationSettings'] = pulumi.property("notificationSettings")
    ...
    time_zone_id: pulumi.Output[str] = pulumi.property("timeZoneId")
    """
    The time zone ID (e.g. Pacific Standard time).
    """

    weekly_recurrence: pulumi.Output[Optional['outputs.ScheduleWeeklyRecurrence']] = pulumi.property("weeklyRecurrence")
