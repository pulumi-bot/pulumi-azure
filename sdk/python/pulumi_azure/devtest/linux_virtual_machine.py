...
class LinuxVirtualMachine(pulumi.CustomResource):
    allow_claim: pulumi.Output[Optional[bool]] = pulumi.property("allowClaim")
    """
    Can this Virtual Machine be claimed by users? Defaults to `true`.
    """

    disallow_public_ip_address: pulumi.Output[Optional[bool]] = pulumi.property("disallowPublicIpAddress")
    """
    ...
    gallery_image_reference: pulumi.Output['outputs.LinuxVirtualMachineGalleryImageReference'] = pulumi.property("galleryImageReference")
    """
    A `gallery_image_reference` block as defined below.
    """

    inbound_nat_rules: pulumi.Output[Optional[List['outputs.LinuxVirtualMachineInboundNatRule']]] = pulumi.property("inboundNatRules")
    """
    ...
    lab_subnet_name: pulumi.Output[str] = pulumi.property("labSubnetName")
    """
    The name of a Subnet within the Dev Test Virtual Network where this machine should exist. Changing this forces a new resource to be created.
    """

    lab_virtual_network_id: pulumi.Output[str] = pulumi.property("labVirtualNetworkId")
    """
    ...
    notes: pulumi.Output[Optional[str]] = pulumi.property("notes")
    """
    ...
    ssh_key: pulumi.Output[Optional[str]] = pulumi.property("sshKey")
    """
