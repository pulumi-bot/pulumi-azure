...
class WindowsVirtualMachine(pulumi.CustomResource):
    ...
    gallery_image_reference: pulumi.Output['outputs.WindowsVirtualMachineGalleryImageReference'] = pulumi.property("galleryImageReference")
    """
    A `gallery_image_reference` block as defined below.
    """

    inbound_nat_rules: pulumi.Output[Optional[List['outputs.WindowsVirtualMachineInboundNatRule']]] = pulumi.property("inboundNatRules")
    """
