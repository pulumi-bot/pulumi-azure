...
class WindowsVirtualMachine(pulumi.CustomResource):
    ...
    """
    gallery_image_reference: pulumi.Output['outputs.WindowsVirtualMachineGalleryImageReference'] = pulumi.output_property("galleryImageReference")
    """
    A `gallery_image_reference` block as defined below.
    """
    inbound_nat_rules: pulumi.Output[Optional[List['outputs.WindowsVirtualMachineInboundNatRule']]] = pulumi.output_property("inboundNatRules")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, allow_claim: Optional[pulumi.Input[bool]] = None, disallow_public_ip_address: Optional[pulumi.Input[bool]] = None, gallery_image_reference: Optional[pulumi.Input[pulumi.InputType['WindowsVirtualMachineGalleryImageReferenceArgs']]] = None, inbound_nat_rules: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['WindowsVirtualMachineInboundNatRuleArgs']]]]] = None, lab_name: Optional[pulumi.Input[str]] = None, lab_subnet_name: Optional[pulumi.Input[str]] = None, lab_virtual_network_id: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, notes: Optional[pulumi.Input[str]] = None, password: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, size: Optional[pulumi.Input[str]] = None, storage_type: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, username: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, allow_claim: Optional[pulumi.Input[bool]] = None, disallow_public_ip_address: Optional[pulumi.Input[bool]] = None, fqdn: Optional[pulumi.Input[str]] = None, gallery_image_reference: Optional[pulumi.Input[pulumi.InputType['WindowsVirtualMachineGalleryImageReferenceArgs']]] = None, inbound_nat_rules: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['WindowsVirtualMachineInboundNatRuleArgs']]]]] = None, lab_name: Optional[pulumi.Input[str]] = None, lab_subnet_name: Optional[pulumi.Input[str]] = None, lab_virtual_network_id: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, notes: Optional[pulumi.Input[str]] = None, password: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, size: Optional[pulumi.Input[str]] = None, storage_type: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, unique_identifier: Optional[pulumi.Input[str]] = None, username: Optional[pulumi.Input[str]] = None) -> 'WindowsVirtualMachine':
        """
