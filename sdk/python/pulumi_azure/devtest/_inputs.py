...
class GlobalVMShutdownScheduleNotificationSettingsArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "timeInMinutes", time_in_minutes)
        pulumi.set(__self__, "webhookUrl", webhook_url)
...
class LinuxVirtualMachineInboundNatRuleArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "frontendPort", frontend_port)
...
class ScheduleWeeklyRecurrenceArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "time", time)
        pulumi.set(__self__, "weekDays", week_days)
...
class VirtualNetworkSubnetArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "useInVirtualMachineCreation", use_in_virtual_machine_creation)
        pulumi.set(__self__, "usePublicIpAddress", use_public_ip_address)
