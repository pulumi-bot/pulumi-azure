...
class GlobalVMShutdownSchedule(pulumi.CustomResource):
    daily_recurrence_time: pulumi.Output[str] = pulumi.property("dailyRecurrenceTime")
    """
    ...
    notification_settings: pulumi.Output['outputs.GlobalVMShutdownScheduleNotificationSettings'] = pulumi.property("notificationSettings")
