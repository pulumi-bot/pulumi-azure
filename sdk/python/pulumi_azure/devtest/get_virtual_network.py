...
def get_virtual_network(lab_name: Optional[str] = None,
    ...
    return AwaitableGetVirtualNetworkResult(
        allowed_subnets=_utilities.get_dict_value(__ret__, 'allowedSubnets'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        lab_name=_utilities.get_dict_value(__ret__, 'labName'),
        name=_utilities.get_dict_value(__ret__, 'name'),
        resource_group_name=_utilities.get_dict_value(__ret__, 'resourceGroupName'),
        subnet_overrides=_utilities.get_dict_value(__ret__, 'subnetOverrides'),
