...
class Policy(pulumi.CustomResource):
    ...
    """
    evaluator_type: pulumi.Output[str] = pulumi.output_property("evaluatorType")
    """
    The Evaluation Type used for this Policy. Possible values include: 'AllowedValuesPolicy', 'MaxValuePolicy'. Changing this forces a new resource to be created.
    """
    fact_data: pulumi.Output[Optional[str]] = pulumi.output_property("factData")
    """
    ...
    """
    policy_set_name: pulumi.Output[str] = pulumi.output_property("policySetName")
    """
    ...
    """
    threshold: pulumi.Output[str] = pulumi.output_property("threshold")
    """
    The Threshold for this Policy.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, description: Optional[pulumi.Input[str]] = None, evaluator_type: Optional[pulumi.Input[str]] = None, fact_data: Optional[pulumi.Input[str]] = None, lab_name: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, policy_set_name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, threshold: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, description: Optional[pulumi.Input[str]] = None, evaluator_type: Optional[pulumi.Input[str]] = None, fact_data: Optional[pulumi.Input[str]] = None, lab_name: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, policy_set_name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, threshold: Optional[pulumi.Input[str]] = None) -> 'Policy':
        """
