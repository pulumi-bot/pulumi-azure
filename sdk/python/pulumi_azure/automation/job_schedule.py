...
class JobSchedule(pulumi.CustomResource):
    ...
    job_schedule_id: pulumi.Output[str] = pulumi.property("jobScheduleId")
    """
    ...
    run_on: pulumi.Output[Optional[str]] = pulumi.property("runOn")
    """
    Name of a Hybrid Worker Group the Runbook will be executed on. Changing this forces a new resource to be created.
    """

    runbook_name: pulumi.Output[str] = pulumi.property("runbookName")
    """
    ...
    schedule_name: pulumi.Output[str] = pulumi.property("scheduleName")
