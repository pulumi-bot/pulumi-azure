...
class Schedule(pulumi.CustomResource):
    ...
    """
    expiry_time: pulumi.Output[str] = pulumi.output_property("expiryTime")
    """
    ...
    """
    month_days: pulumi.Output[Optional[List[float]]] = pulumi.output_property("monthDays")
    """
    List of days of the month that the job should execute on. Must be between `1` and `31`. `-1` for last day of the month. Only valid when frequency is `Month`.
    """
    monthly_occurrences: pulumi.Output[Optional[List['outputs.ScheduleMonthlyOccurrence']]] = pulumi.output_property("monthlyOccurrences")
    """
    ...
    """
    week_days: pulumi.Output[Optional[List[str]]] = pulumi.output_property("weekDays")
    """
    List of days of the week that the job should execute on. Only valid when frequency is `Week`.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, automation_account_name: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, expiry_time: Optional[pulumi.Input[str]] = None, frequency: Optional[pulumi.Input[str]] = None, interval: Optional[pulumi.Input[float]] = None, month_days: Optional[pulumi.Input[List[pulumi.Input[float]]]] = None, monthly_occurrences: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ScheduleMonthlyOccurrenceArgs']]]]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, start_time: Optional[pulumi.Input[str]] = None, timezone: Optional[pulumi.Input[str]] = None, week_days: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, automation_account_name: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, expiry_time: Optional[pulumi.Input[str]] = None, frequency: Optional[pulumi.Input[str]] = None, interval: Optional[pulumi.Input[float]] = None, month_days: Optional[pulumi.Input[List[pulumi.Input[float]]]] = None, monthly_occurrences: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ScheduleMonthlyOccurrenceArgs']]]]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, start_time: Optional[pulumi.Input[str]] = None, timezone: Optional[pulumi.Input[str]] = None, week_days: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None) -> 'Schedule':
        """
