...
class Schedule(pulumi.CustomResource):
    ...
    expiry_time: pulumi.Output[str] = pulumi.property("expiryTime")
    """
    The end time of the schedule.
    """

    frequency: pulumi.Output[str] = pulumi.property("frequency")
    """
    The frequency of the schedule. - can be either `OneTime`, `Day`, `Hour`, `Week`, or `Month`.
    """

    interval: pulumi.Output[float] = pulumi.property("interval")
    """
    The number of `frequency`s between runs. Only valid when frequency is `Day`, `Hour`, `Week`, or `Month` and defaults to `1`.
    """

    month_days: pulumi.Output[Optional[List[float]]] = pulumi.property("monthDays")
    """
    List of days of the month that the job should execute on. Must be between `1` and `31`. `-1` for last day of the month. Only valid when frequency is `Month`.
    """

    monthly_occurrences: pulumi.Output[Optional[List['outputs.ScheduleMonthlyOccurrence']]] = pulumi.property("monthlyOccurrences")
    """
    ...
    week_days: pulumi.Output[Optional[List[str]]] = pulumi.property("weekDays")
    """
