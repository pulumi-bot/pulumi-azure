...
class Schedule(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 month_days: Optional[pulumi.Input[Sequence[pulumi.Input[float]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[float]]] month_days: List of days of the month that the job should execute on. Must be between `1` and `31`. `-1` for last day of the month. Only valid when frequency is `Month`.
    ...
    def month_days(self) -> pulumi.Output[Optional[Sequence[float]]]:
        """
