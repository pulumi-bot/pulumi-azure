...
class ConnectionClassicCertificate(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, automation_account_name=None, certificate_asset_name=None, description=None, name=None, resource_group_name=None, subscription_id=None, subscription_name=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
