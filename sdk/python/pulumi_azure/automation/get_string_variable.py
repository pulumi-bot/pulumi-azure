...
@pulumi.output_type
class _GetStringVariableResult(dict):
...
def get_string_variable(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure:automation/getStringVariable:getStringVariable', __args__, opts=opts, typ=_GetStringVariableResult).value
