...
@pulumi.output_type
class _GetBoolVariableResult(dict):
    ...
    value: bool = pulumi.property("value")
...
def get_bool_variable(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure:automation/getBoolVariable:getBoolVariable', __args__, opts=opts, typ=_GetBoolVariableResult).value

    return AwaitableGetBoolVariableResult(
        automation_account_name=_utilities.get_dict_value(__ret__, 'automationAccountName'),
