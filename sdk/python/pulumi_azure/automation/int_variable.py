...
__all__ = ['IntVariableArgs', 'IntVariable']
...
class IntVariable(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name_: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(IntVariableArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = IntVariableArgs.__new__(IntVariableArgs)
    ...
    def get(resource_name_: str,
        ...
        __props__ = _IntVariableState.__new__(_IntVariableState)
        ...
        __props__.__dict__["resource_group_name"] = resource_group_name
        __props__.__dict__["value"] = value
        return IntVariable(resource_name_, opts=opts, __props__=__props__)
