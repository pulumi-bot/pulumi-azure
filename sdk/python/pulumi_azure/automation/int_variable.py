...
class IntVariable(pulumi.CustomResource):
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, automation_account_name: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, encrypted: Optional[pulumi.Input[bool]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, value: Optional[pulumi.Input[float]] = None) -> 'IntVariable':
        """
        ...
        __props__["resource_group_name"] = resource_group_name
        __props__["value"] = value
        return IntVariable(resource_name, opts=opts, __props__=__props__)
