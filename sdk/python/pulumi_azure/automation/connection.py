...
class Connection(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, automation_account_name=None, description=None, name=None, resource_group_name=None, type=None, values=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
