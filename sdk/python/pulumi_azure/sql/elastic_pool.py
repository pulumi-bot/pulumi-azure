...
class ElasticPool(pulumi.CustomResource):
    ...
    """
    pool_size: pulumi.Output[float] = pulumi.output_property("poolSize")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, db_dtu_max: Optional[pulumi.Input[float]] = None, db_dtu_min: Optional[pulumi.Input[float]] = None, dtu: Optional[pulumi.Input[float]] = None, edition: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, pool_size: Optional[pulumi.Input[float]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, server_name: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, creation_date: Optional[pulumi.Input[str]] = None, db_dtu_max: Optional[pulumi.Input[float]] = None, db_dtu_min: Optional[pulumi.Input[float]] = None, dtu: Optional[pulumi.Input[float]] = None, edition: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, pool_size: Optional[pulumi.Input[float]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, server_name: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None) -> 'ElasticPool':
        """
