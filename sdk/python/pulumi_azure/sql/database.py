...
class Database(pulumi.CustomResource):
    ...
    default_secondary_location: pulumi.Output[str] = pulumi.property("defaultSecondaryLocation")
    """
    ...
    elastic_pool_name: pulumi.Output[str] = pulumi.property("elasticPoolName")
    """
    The name of the elastic database pool.
    """

    encryption: pulumi.Output[str] = pulumi.property("encryption")

    extended_auditing_policy: pulumi.Output[Optional['outputs.DatabaseExtendedAuditingPolicy']] = pulumi.property("extendedAuditingPolicy")
    """
    A `extended_auditing_policy` block as defined below.
    """

    import_: pulumi.Output[Optional['outputs.DatabaseImport']] = pulumi.property("import")
    """
    ...
    max_size_bytes: pulumi.Output[str] = pulumi.property("maxSizeBytes")
    """
    ...
    max_size_gb: pulumi.Output[str] = pulumi.property("maxSizeGb")
    ...
    read_scale: pulumi.Output[Optional[bool]] = pulumi.property("readScale")
    """
    ...
    requested_service_objective_id: pulumi.Output[str] = pulumi.property("requestedServiceObjectiveId")
    """
    ...
    requested_service_objective_name: pulumi.Output[str] = pulumi.property("requestedServiceObjectiveName")
    """
    ...
    restore_point_in_time: pulumi.Output[str] = pulumi.property("restorePointInTime")
    """
    ...
    source_database_deletion_date: pulumi.Output[str] = pulumi.property("sourceDatabaseDeletionDate")
    """
    The deletion date time of the source database. Only applies to deleted databases where `create_mode` is `PointInTimeRestore`.
    """

    source_database_id: pulumi.Output[str] = pulumi.property("sourceDatabaseId")
    """
    ...
    threat_detection_policy: pulumi.Output['outputs.DatabaseThreatDetectionPolicy'] = pulumi.property("threatDetectionPolicy")
    """
    Threat detection policy configuration. The `threat_detection_policy` block supports fields documented below.
    """

    zone_redundant: pulumi.Output[Optional[bool]] = pulumi.property("zoneRedundant")
    """
