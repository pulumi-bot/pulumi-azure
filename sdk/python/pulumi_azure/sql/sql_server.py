...
class SqlServer(pulumi.CustomResource):
    ...
    extended_auditing_policy: pulumi.Output[Optional['outputs.SqlServerExtendedAuditingPolicy']] = pulumi.property("extendedAuditingPolicy")
    """
    ...
    identity: pulumi.Output[Optional['outputs.SqlServerIdentity']] = pulumi.property("identity")
    """
