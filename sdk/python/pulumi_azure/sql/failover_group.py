...
class FailoverGroup(pulumi.CustomResource):
    databases: pulumi.Output[Optional[List[str]]] = pulumi.property("databases")
    """
    ...
    partner_servers: pulumi.Output[List['outputs.FailoverGroupPartnerServer']] = pulumi.property("partnerServers")
    """
    A list of secondary servers as documented below
    """

    read_write_endpoint_failover_policy: pulumi.Output['outputs.FailoverGroupReadWriteEndpointFailoverPolicy'] = pulumi.property("readWriteEndpointFailoverPolicy")
    """
    A read/write policy as documented below
    """

    readonly_endpoint_failover_policy: pulumi.Output['outputs.FailoverGroupReadonlyEndpointFailoverPolicy'] = pulumi.property("readonlyEndpointFailoverPolicy")
    """
