...
def get_database(name: Optional[str] = None,
    ...
    return AwaitableGetDatabaseResult(
        collation=_utilities.get_dict_value(__ret__, 'collation'),
        default_secondary_location=_utilities.get_dict_value(__ret__, 'defaultSecondaryLocation'),
        edition=_utilities.get_dict_value(__ret__, 'edition'),
        elastic_pool_name=_utilities.get_dict_value(__ret__, 'elasticPoolName'),
        failover_group_id=_utilities.get_dict_value(__ret__, 'failoverGroupId'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        location=_utilities.get_dict_value(__ret__, 'location'),
        name=_utilities.get_dict_value(__ret__, 'name'),
        read_scale=_utilities.get_dict_value(__ret__, 'readScale'),
