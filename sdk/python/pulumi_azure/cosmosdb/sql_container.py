...
class SqlContainer(pulumi.CustomResource):
    ...
    default_ttl: pulumi.Output[float] = pulumi.property("defaultTtl")
    """
    ...
    unique_keys: pulumi.Output[Optional[List['outputs.SqlContainerUniqueKey']]] = pulumi.property("uniqueKeys")
    """
