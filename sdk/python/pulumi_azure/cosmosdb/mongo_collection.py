...
class MongoCollection(pulumi.CustomResource):
    ...
    default_ttl_seconds: pulumi.Output[Optional[float]] = pulumi.property("defaultTtlSeconds")
    """
    The default Time To Live in seconds. If the value is `-1` or `0`, items are not automatically expired.
    """

    indices: pulumi.Output[Optional[List['outputs.MongoCollectionIndex']]] = pulumi.property("indices")
    """
    ...
    shard_key: pulumi.Output[Optional[str]] = pulumi.property("shardKey")
    """
    The name of the key to partition on for sharding. There must not be any other unique index keys.
    """

    system_indexes: pulumi.Output[List['outputs.MongoCollectionSystemIndex']] = pulumi.property("systemIndexes")
    """
