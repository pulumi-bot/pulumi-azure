...
class MongoCollection(pulumi.CustomResource):
    ...
    """
    default_ttl_seconds: pulumi.Output[Optional[float]] = pulumi.output_property("defaultTtlSeconds")
    """
    The default Time To Live in seconds. If the value is `0` items are not automatically expired.
    """
    indices: pulumi.Output[Optional[List['outputs.MongoCollectionIndex']]] = pulumi.output_property("indices")
    """
    ...
    """
    shard_key: pulumi.Output[Optional[str]] = pulumi.output_property("shardKey")
    """
    The name of the key to partition on for sharding. There must not be any other unique index keys.
    """
    system_indexes: pulumi.Output[List['outputs.MongoCollectionSystemIndex']] = pulumi.output_property("systemIndexes")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, account_name: Optional[pulumi.Input[str]] = None, database_name: Optional[pulumi.Input[str]] = None, default_ttl_seconds: Optional[pulumi.Input[float]] = None, indices: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['MongoCollectionIndexArgs']]]]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, shard_key: Optional[pulumi.Input[str]] = None, throughput: Optional[pulumi.Input[float]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, account_name: Optional[pulumi.Input[str]] = None, database_name: Optional[pulumi.Input[str]] = None, default_ttl_seconds: Optional[pulumi.Input[float]] = None, indices: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['MongoCollectionIndexArgs']]]]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, shard_key: Optional[pulumi.Input[str]] = None, system_indexes: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['MongoCollectionSystemIndexArgs']]]]] = None, throughput: Optional[pulumi.Input[float]] = None) -> 'MongoCollection':
        """
