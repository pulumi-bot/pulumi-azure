...
class AccountConsistencyPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "consistencyLevel", consistency_level)
        pulumi.set(__self__, "maxIntervalInSeconds", max_interval_in_seconds)
        pulumi.set(__self__, "maxStalenessPrefix", max_staleness_prefix)
...
class AccountGeoLocationArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "failoverPriority", failover_priority)
...
class GremlinGraphConflictResolutionPolicyArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "conflictResolutionPath", conflict_resolution_path)
        pulumi.set(__self__, "conflictResolutionProcedure", conflict_resolution_procedure)
...
class GremlinGraphIndexPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "indexingMode", indexing_mode)
        pulumi.set(__self__, "automatic", automatic)
        pulumi.set(__self__, "excludedPaths", excluded_paths)
        pulumi.set(__self__, "includedPaths", included_paths)
