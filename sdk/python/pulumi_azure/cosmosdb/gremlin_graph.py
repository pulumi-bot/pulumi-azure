...
class GremlinGraph(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, account_name: Optional[pulumi.Input[str]] = None, conflict_resolution_policies: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['GremlinGraphConflictResolutionPolicyArgs']]]]] = None, database_name: Optional[pulumi.Input[str]] = None, index_policies: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['GremlinGraphIndexPolicyArgs']]]]] = None, name: Optional[pulumi.Input[str]] = None, partition_key_path: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, throughput: Optional[pulumi.Input[float]] = None, unique_keys: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['GremlinGraphUniqueKeyArgs']]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, account_name: Optional[pulumi.Input[str]] = None, conflict_resolution_policies: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['GremlinGraphConflictResolutionPolicyArgs']]]]] = None, database_name: Optional[pulumi.Input[str]] = None, index_policies: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['GremlinGraphIndexPolicyArgs']]]]] = None, name: Optional[pulumi.Input[str]] = None, partition_key_path: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, throughput: Optional[pulumi.Input[float]] = None, unique_keys: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['GremlinGraphUniqueKeyArgs']]]]] = None) -> 'GremlinGraph':
        """
