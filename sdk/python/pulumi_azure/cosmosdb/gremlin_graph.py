...
class GremlinGraph(pulumi.CustomResource):
    ...
    conflict_resolution_policies: pulumi.Output[List['outputs.GremlinGraphConflictResolutionPolicy']] = pulumi.property("conflictResolutionPolicies")
    """
    ...
    index_policies: pulumi.Output[List['outputs.GremlinGraphIndexPolicy']] = pulumi.property("indexPolicies")
    """
    ...
    partition_key_path: pulumi.Output[Optional[str]] = pulumi.property("partitionKeyPath")
    """
    ...
    throughput: pulumi.Output[float] = pulumi.property("throughput")
    """
    ...
    unique_keys: pulumi.Output[Optional[List['outputs.GremlinGraphUniqueKey']]] = pulumi.property("uniqueKeys")
    """
