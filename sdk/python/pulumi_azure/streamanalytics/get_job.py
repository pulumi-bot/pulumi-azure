...
def get_job(name: Optional[str] = None,
    ...
    return AwaitableGetJobResult(
        compatibility_level=_utilities.get_dict_value(__ret__, 'compatibilityLevel'),
        data_locale=_utilities.get_dict_value(__ret__, 'dataLocale'),
        events_late_arrival_max_delay_in_seconds=_utilities.get_dict_value(__ret__, 'eventsLateArrivalMaxDelayInSeconds'),
        events_out_of_order_max_delay_in_seconds=_utilities.get_dict_value(__ret__, 'eventsOutOfOrderMaxDelayInSeconds'),
        events_out_of_order_policy=_utilities.get_dict_value(__ret__, 'eventsOutOfOrderPolicy'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        job_id=_utilities.get_dict_value(__ret__, 'jobId'),
        location=_utilities.get_dict_value(__ret__, 'location'),
        name=_utilities.get_dict_value(__ret__, 'name'),
        output_error_policy=_utilities.get_dict_value(__ret__, 'outputErrorPolicy'),
        resource_group_name=_utilities.get_dict_value(__ret__, 'resourceGroupName'),
        streaming_units=_utilities.get_dict_value(__ret__, 'streamingUnits'),
        transformation_query=_utilities.get_dict_value(__ret__, 'transformationQuery'))
