...
class Job(pulumi.CustomResource):
    compatibility_level: pulumi.Output[str] = pulumi.property("compatibilityLevel")
    """
    ...
    data_locale: pulumi.Output[str] = pulumi.property("dataLocale")
    """
    ...
    events_late_arrival_max_delay_in_seconds: pulumi.Output[Optional[float]] = pulumi.property("eventsLateArrivalMaxDelayInSeconds")
    """
    ...
    events_out_of_order_max_delay_in_seconds: pulumi.Output[Optional[float]] = pulumi.property("eventsOutOfOrderMaxDelayInSeconds")
    """
    ...
    events_out_of_order_policy: pulumi.Output[Optional[str]] = pulumi.property("eventsOutOfOrderPolicy")
    """
    ...
    output_error_policy: pulumi.Output[Optional[str]] = pulumi.property("outputErrorPolicy")
    """
    ...
    streaming_units: pulumi.Output[float] = pulumi.property("streamingUnits")
    """
    ...
    transformation_query: pulumi.Output[str] = pulumi.property("transformationQuery")
    """
