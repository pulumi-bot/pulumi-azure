...
class StreamInputIotHub(pulumi.CustomResource):
    ...
    eventhub_consumer_group_name: pulumi.Output[str] = pulumi.property("eventhubConsumerGroupName")
    """
    The name of an Event Hub Consumer Group that should be used to read events from the Event Hub. Specifying distinct consumer group names for multiple inputs allows each of those inputs to receive the same events from the Event Hub.
    """

    iothub_namespace: pulumi.Output[str] = pulumi.property("iothubNamespace")
    """
    ...
    serialization: pulumi.Output['outputs.StreamInputIotHubSerialization'] = pulumi.property("serialization")
    """
