...
class FunctionJavaScriptUDF(pulumi.CustomResource):
    inputs: pulumi.Output[List['outputs.FunctionJavaScriptUDFInput']] = pulumi.property("inputs")
    """
    ...
    output: pulumi.Output['outputs.FunctionJavaScriptUDFOutput'] = pulumi.property("output")
    """
    ...
    script: pulumi.Output[str] = pulumi.property("script")
    """
