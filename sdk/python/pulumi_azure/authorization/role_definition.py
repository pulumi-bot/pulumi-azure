...
class RoleDefinitionArgs:
    def __init__(__self__, *,
                 permissions: pulumi.Input[Sequence[pulumi.Input['RoleDefinitionPermissionArgs']]],
    ...
    @property
    @pulumi.getter
    def permissions(self) -> pulumi.Input[Sequence[pulumi.Input['RoleDefinitionPermissionArgs']]]:
        """
    ...
    @permissions.setter
    def permissions(self, value: pulumi.Input[Sequence[pulumi.Input['RoleDefinitionPermissionArgs']]]):
