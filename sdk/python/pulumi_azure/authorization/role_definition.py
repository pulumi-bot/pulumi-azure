...
class RoleDefinition(pulumi.CustomResource):
    assignable_scopes: pulumi.Output[List[str]] = pulumi.property("assignableScopes")
    """
    ...
    permissions: pulumi.Output[List['outputs.RoleDefinitionPermission']] = pulumi.property("permissions")
    """
