...
@pulumi.output_type
class _GetRoleDefinitionResult:
...
def get_role_definition(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure:authorization/getRoleDefinition:getRoleDefinition', __args__, opts=opts, typ=_GetRoleDefinitionResult).value
