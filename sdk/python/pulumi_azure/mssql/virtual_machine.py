...
class VirtualMachine(pulumi.CustomResource):
    auto_patching: pulumi.Output[Optional['outputs.VirtualMachineAutoPatching']] = pulumi.property("autoPatching")
    """
    An `auto_patching` block as defined below.
    """

    key_vault_credential: pulumi.Output[Optional['outputs.VirtualMachineKeyVaultCredential']] = pulumi.property("keyVaultCredential")
    """
    (Optional) An `key_vault_credential` block as defined below.
    """

    r_services_enabled: pulumi.Output[Optional[bool]] = pulumi.property("rServicesEnabled")
    """
    Should R Services be enabled?
    """

    sql_connectivity_port: pulumi.Output[Optional[float]] = pulumi.property("sqlConnectivityPort")
    """
    The SQL Server port. Defaults to `1433`.
    """

    sql_connectivity_type: pulumi.Output[Optional[str]] = pulumi.property("sqlConnectivityType")
    """
    The connectivity type used for this SQL Server. Defaults to `PRIVATE`.
    """

    sql_connectivity_update_password: pulumi.Output[Optional[str]] = pulumi.property("sqlConnectivityUpdatePassword")
    """
    The SQL Server sysadmin login password.
    """

    sql_connectivity_update_username: pulumi.Output[Optional[str]] = pulumi.property("sqlConnectivityUpdateUsername")
    """
    The SQL Server sysadmin login to create.
    """

    sql_license_type: pulumi.Output[str] = pulumi.property("sqlLicenseType")
    """
