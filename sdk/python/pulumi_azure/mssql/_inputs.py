...
class DatabaseVulnerabilityAssessmentRuleBaselineBaselineResultArgs:
    def __init__(__self__, *,
                 results: pulumi.Input[List[pulumi.Input[str]]]):
        """
    ...
    @property
    @pulumi.getter
    def results(self) -> pulumi.Input[List[pulumi.Input[str]]]:
        """
    ...
    @results.setter
    def results(self, value: pulumi.Input[List[pulumi.Input[str]]]):
        ...
...
class ServerAzureadAdministratorArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "loginUsername", login_username)
...
class ServerVulnerabilityAssessmentRecurringScansArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "emailSubscriptionAdmins", email_subscription_admins)
...
class VirtualMachineAutoPatchingArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "maintenanceWindowDurationInMinutes", maintenance_window_duration_in_minutes)
        pulumi.set(__self__, "maintenanceWindowStartingHour", maintenance_window_starting_hour)
...
class VirtualMachineKeyVaultCredentialArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "keyVaultUrl", key_vault_url)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "servicePrincipalName", service_principal_name)
        pulumi.set(__self__, "servicePrincipalSecret", service_principal_secret)
