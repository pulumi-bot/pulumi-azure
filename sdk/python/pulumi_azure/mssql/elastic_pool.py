...
class ElasticPool(pulumi.CustomResource):
    ...
    max_size_bytes: pulumi.Output[float] = pulumi.property("maxSizeBytes")
    """
    ...
    per_database_settings: pulumi.Output['outputs.ElasticPoolPerDatabaseSettings'] = pulumi.property("perDatabaseSettings")
    """
    ...
    sku: pulumi.Output['outputs.ElasticPoolSku'] = pulumi.property("sku")
    """
