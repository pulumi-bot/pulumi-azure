...
class Server(pulumi.CustomResource):
    ...
    administrator_login_password: pulumi.Output[str] = pulumi.property("administratorLoginPassword")
    """
    The password associated with the `administrator_login` user. Needs to comply with Azure's [Password Policy](https://msdn.microsoft.com/library/ms161959.aspx)
    """

    azuread_administrator: pulumi.Output[Optional['outputs.ServerAzureadAdministrator']] = pulumi.property("azureadAdministrator")
    """
    An `azuread_administrator` block as defined below.
    """

    connection_policy: pulumi.Output[Optional[str]] = pulumi.property("connectionPolicy")
    """
    The connection policy the server will use. Possible values are `Default`, `Proxy`, and `Redirect`. Defaults to `Default`.
    """

    extended_auditing_policy: pulumi.Output[Optional['outputs.ServerExtendedAuditingPolicy']] = pulumi.property("extendedAuditingPolicy")
    """
    A `extended_auditing_policy` block as defined below.
    """

    fully_qualified_domain_name: pulumi.Output[str] = pulumi.property("fullyQualifiedDomainName")
    """
    The fully qualified domain name of the Azure SQL Server (e.g. myServerName.database.windows.net)
    """

    identity: pulumi.Output[Optional['outputs.ServerIdentity']] = pulumi.property("identity")
    """
