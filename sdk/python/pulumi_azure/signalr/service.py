...
class Service(pulumi.CustomResource):
    cors: pulumi.Output[List['outputs.ServiceCor']] = pulumi.output_property("cors")
    """
    A `cors` block as documented below.
    """
    features: pulumi.Output[List['outputs.ServiceFeature']] = pulumi.output_property("features")
    """
    ...
    """
    public_port: pulumi.Output[float] = pulumi.output_property("publicPort")
    """
    ...
    """
    server_port: pulumi.Output[float] = pulumi.output_property("serverPort")
    """
    The publicly accessible port of the SignalR service which is designed for customer server side use.
    """
    sku: pulumi.Output['outputs.ServiceSku'] = pulumi.output_property("sku")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, cors: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ServiceCorArgs']]]]] = None, features: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ServiceFeatureArgs']]]]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, sku: Optional[pulumi.Input[pulumi.InputType['ServiceSkuArgs']]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, cors: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ServiceCorArgs']]]]] = None, features: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ServiceFeatureArgs']]]]] = None, hostname: Optional[pulumi.Input[str]] = None, ip_address: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, primary_access_key: Optional[pulumi.Input[str]] = None, primary_connection_string: Optional[pulumi.Input[str]] = None, public_port: Optional[pulumi.Input[float]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, secondary_access_key: Optional[pulumi.Input[str]] = None, secondary_connection_string: Optional[pulumi.Input[str]] = None, server_port: Optional[pulumi.Input[float]] = None, sku: Optional[pulumi.Input[pulumi.InputType['ServiceSkuArgs']]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None) -> 'Service':
        """
