...
class CacheNfsTarget(pulumi.CustomResource):
    cache_name: pulumi.Output[str] = pulumi.output_property("cacheName")
    """
    ...
    """
    namespace_junctions: pulumi.Output[List['outputs.CacheNfsTargetNamespaceJunction']] = pulumi.output_property("namespaceJunctions")
    """
    ...
    """
    target_host_name: pulumi.Output[str] = pulumi.output_property("targetHostName")
    """
    The IP address or fully qualified domain name (FQDN) of the HPC Cache NFS target. Changing this forces a new resource to be created.
    """
    usage_model: pulumi.Output[str] = pulumi.output_property("usageModel")
    """
    The type of usage of the HPC Cache NFS Target.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, cache_name: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, namespace_junctions: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['CacheNfsTargetNamespaceJunctionArgs']]]]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, target_host_name: Optional[pulumi.Input[str]] = None, usage_model: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, cache_name: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, namespace_junctions: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['CacheNfsTargetNamespaceJunctionArgs']]]]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, target_host_name: Optional[pulumi.Input[str]] = None, usage_model: Optional[pulumi.Input[str]] = None) -> 'CacheNfsTarget':
        """
