...
class CacheNfsTarget(pulumi.CustomResource):
    ...
    namespace_junctions: pulumi.Output[List['outputs.CacheNfsTargetNamespaceJunction']] = pulumi.property("namespaceJunctions")
    """
    ...
    target_host_name: pulumi.Output[str] = pulumi.property("targetHostName")
    """
    The IP address or fully qualified domain name (FQDN) of the HPC Cache NFS target. Changing this forces a new resource to be created.
    """

    usage_model: pulumi.Output[str] = pulumi.property("usageModel")
    """
