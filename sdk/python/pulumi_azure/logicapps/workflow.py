...
class Workflow(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, location: Optional[pulumi.Input[str]] = None, logic_app_integration_account_id: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, parameters: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, workflow_schema: Optional[pulumi.Input[str]] = None, workflow_version: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, access_endpoint: Optional[pulumi.Input[str]] = None, connector_endpoint_ip_addresses: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, connector_outbound_ip_addresses: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, location: Optional[pulumi.Input[str]] = None, logic_app_integration_account_id: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, parameters: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, workflow_endpoint_ip_addresses: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, workflow_outbound_ip_addresses: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, workflow_schema: Optional[pulumi.Input[str]] = None, workflow_version: Optional[pulumi.Input[str]] = None) -> 'Workflow':
        """
