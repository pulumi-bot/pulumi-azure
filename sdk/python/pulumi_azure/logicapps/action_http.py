...
class ActionHttp(pulumi.CustomResource):
    ...
    """
    headers: pulumi.Output[Optional[Dict[str, str]]] = pulumi.output_property("headers")
    """
    ...
    """
    run_afters: pulumi.Output[Optional[List['outputs.ActionHttpRunAfter']]] = pulumi.output_property("runAfters")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, body: Optional[pulumi.Input[str]] = None, headers: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, logic_app_id: Optional[pulumi.Input[str]] = None, method: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, run_afters: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ActionHttpRunAfterArgs']]]]] = None, uri: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        :param pulumi.Input[Dict[str, pulumi.Input[str]]] headers: Specifies a Map of Key-Value Pairs that should be sent to the `uri` when this HTTP Action is triggered.
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, body: Optional[pulumi.Input[str]] = None, headers: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, logic_app_id: Optional[pulumi.Input[str]] = None, method: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, run_afters: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ActionHttpRunAfterArgs']]]]] = None, uri: Optional[pulumi.Input[str]] = None) -> 'ActionHttp':
        """
