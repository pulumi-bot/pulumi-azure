...
class ActionHttp(pulumi.CustomResource):
    ...
    headers: pulumi.Output[Optional[Mapping[str, str]]] = pulumi.property("headers")
    """
    ...
    run_afters: pulumi.Output[Optional[List['outputs.ActionHttpRunAfter']]] = pulumi.property("runAfters")
    """
