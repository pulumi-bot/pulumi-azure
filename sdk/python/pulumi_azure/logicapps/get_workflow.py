...
def get_workflow(name: Optional[str] = None,
    ...
    return AwaitableGetWorkflowResult(
        access_endpoint=_utilities.get_dict_value(__ret__, 'accessEndpoint'),
        connector_endpoint_ip_addresses=_utilities.get_dict_value(__ret__, 'connectorEndpointIpAddresses'),
        connector_outbound_ip_addresses=_utilities.get_dict_value(__ret__, 'connectorOutboundIpAddresses'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        location=_utilities.get_dict_value(__ret__, 'location'),
        logic_app_integration_account_id=_utilities.get_dict_value(__ret__, 'logicAppIntegrationAccountId'),
        ...
        workflow_endpoint_ip_addresses=_utilities.get_dict_value(__ret__, 'workflowEndpointIpAddresses'),
        workflow_outbound_ip_addresses=_utilities.get_dict_value(__ret__, 'workflowOutboundIpAddresses'),
        workflow_schema=_utilities.get_dict_value(__ret__, 'workflowSchema'),
        workflow_version=_utilities.get_dict_value(__ret__, 'workflowVersion'))
