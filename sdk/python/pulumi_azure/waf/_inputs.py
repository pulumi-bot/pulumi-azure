...
class PolicyCustomRuleMatchConditionArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "matchVariables", match_variables)
...
class PolicyCustomRuleMatchConditionMatchVariableArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "variableName", variable_name)
...
class PolicyManagedRulesArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "managedRuleSets", managed_rule_sets)
...
class PolicyManagedRulesManagedRuleSetArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "ruleGroupOverrides", rule_group_overrides)
...
class PolicyManagedRulesManagedRuleSetRuleGroupOverrideArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "disabledRules", disabled_rules)
...
class PolicyPolicySettingsArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "fileUploadLimitInMb", file_upload_limit_in_mb)
        pulumi.set(__self__, "maxRequestBodySizeInKb", max_request_body_size_in_kb)
