...
class Policy(pulumi.CustomResource):
    custom_rules: pulumi.Output[Optional[List['outputs.PolicyCustomRule']]] = pulumi.property("customRules")
    """
    ...
    managed_rules: pulumi.Output['outputs.PolicyManagedRules'] = pulumi.property("managedRules")
    """
    ...
    policy_settings: pulumi.Output[Optional['outputs.PolicyPolicySettings']] = pulumi.property("policySettings")
    """
