...
class DataSourceWindowsPerformanceCounter(pulumi.CustomResource):
    counter_name: pulumi.Output[str] = pulumi.output_property("counterName")
    """
    ...
    """
    interval_seconds: pulumi.Output[float] = pulumi.output_property("intervalSeconds")
    """
    ...
    """
    object_name: pulumi.Output[str] = pulumi.output_property("objectName")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, counter_name: Optional[pulumi.Input[str]] = None, instance_name: Optional[pulumi.Input[str]] = None, interval_seconds: Optional[pulumi.Input[float]] = None, name: Optional[pulumi.Input[str]] = None, object_name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, workspace_name: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, counter_name: Optional[pulumi.Input[str]] = None, instance_name: Optional[pulumi.Input[str]] = None, interval_seconds: Optional[pulumi.Input[float]] = None, name: Optional[pulumi.Input[str]] = None, object_name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, workspace_name: Optional[pulumi.Input[str]] = None) -> 'DataSourceWindowsPerformanceCounter':
        """
