...
class DataSourceWindowsPerformanceCounter(pulumi.CustomResource):
    counter_name: pulumi.Output[str] = pulumi.property("counterName")
    """
    ...
    interval_seconds: pulumi.Output[float] = pulumi.property("intervalSeconds")
    """
    ...
    object_name: pulumi.Output[str] = pulumi.property("objectName")
    """
