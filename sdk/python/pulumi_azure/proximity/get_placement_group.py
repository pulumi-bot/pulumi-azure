...
@pulumi.output_type
class _GetPlacementGroupResult(dict):
...
def get_placement_group(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure:proximity/getPlacementGroup:getPlacementGroup', __args__, opts=opts, typ=_GetPlacementGroupResult).value
