...
class OutboundRule(pulumi.CustomResource):
    allocated_outbound_ports: pulumi.Output[Optional[float]] = pulumi.property("allocatedOutboundPorts")
    """
    ...
    frontend_ip_configurations: pulumi.Output[Optional[List['outputs.OutboundRuleFrontendIpConfiguration']]] = pulumi.property("frontendIpConfigurations")
    """
