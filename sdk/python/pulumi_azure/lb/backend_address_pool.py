...
class BackendAddressPool(pulumi.CustomResource):
    backend_ip_configurations: pulumi.Output[List[str]] = pulumi.property("backendIpConfigurations")
    """
    The Backend IP Configurations associated with this Backend Address Pool.
    """

    load_balancing_rules: pulumi.Output[List[str]] = pulumi.property("loadBalancingRules")
    """
