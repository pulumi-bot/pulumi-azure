...
class NatRule(pulumi.CustomResource):
    backend_ip_configuration_id: pulumi.Output[str] = pulumi.output_property("backendIpConfigurationId")
    backend_port: pulumi.Output[float] = pulumi.output_property("backendPort")
    """
    The port used for internal connections on the endpoint. Possible values range between 1 and 65535, inclusive.
    """
    enable_floating_ip: pulumi.Output[bool] = pulumi.output_property("enableFloatingIp")
    """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, backend_ip_configuration_id: Optional[pulumi.Input[str]] = None, backend_port: Optional[pulumi.Input[float]] = None, enable_floating_ip: Optional[pulumi.Input[bool]] = None, enable_tcp_reset: Optional[pulumi.Input[bool]] = None, frontend_ip_configuration_id: Optional[pulumi.Input[str]] = None, frontend_ip_configuration_name: Optional[pulumi.Input[str]] = None, frontend_port: Optional[pulumi.Input[float]] = None, idle_timeout_in_minutes: Optional[pulumi.Input[float]] = None, loadbalancer_id: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, protocol: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None) -> 'NatRule':
        """
