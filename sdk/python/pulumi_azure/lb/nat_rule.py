...
class NatRule(pulumi.CustomResource):
    backend_ip_configuration_id: pulumi.Output[str] = pulumi.property("backendIpConfigurationId")
    ...
    enable_floating_ip: pulumi.Output[bool] = pulumi.property("enableFloatingIp")
    """
