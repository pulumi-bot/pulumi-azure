...
class LoadBalancerFrontendIpConfigurationArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "inboundNatRules", inbound_nat_rules)
        pulumi.set(__self__, "loadBalancerRules", load_balancer_rules)
        pulumi.set(__self__, "outboundRules", outbound_rules)
