...
class Probe(pulumi.CustomResource):
    ...
    load_balancer_rules: pulumi.Output[List[str]] = pulumi.property("loadBalancerRules")
    ...
    number_of_probes: pulumi.Output[Optional[float]] = pulumi.property("numberOfProbes")
    """
