...
class GetBackendAddressPoolResult:
    ...
    def __init__(__self__, backend_ip_configurations=None, id=None, loadbalancer_id=None, name=None) -> None:
...
def get_backend_address_pool(loadbalancer_id: Optional[str] = None, name: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBackendAddressPoolResult:
    """
