...
@pulumi.output_type
class _GetBackendAddressPoolResult(dict):
    backend_ip_configurations: List['outputs.GetBackendAddressPoolBackendIpConfigurationResult'] = pulumi.property("backendIpConfigurations")
    id: str = pulumi.property("id")
    loadbalancer_id: str = pulumi.property("loadbalancerId")
...
def get_backend_address_pool(loadbalancer_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure:lb/getBackendAddressPool:getBackendAddressPool', __args__, opts=opts, typ=_GetBackendAddressPoolResult).value

    return AwaitableGetBackendAddressPoolResult(
        backend_ip_configurations=_utilities.get_dict_value(__ret__, 'backendIpConfigurations'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        loadbalancer_id=_utilities.get_dict_value(__ret__, 'loadbalancerId'),
