...
class ProviderFeatures(dict):
    def __init__(__self__, *,
                 key_vault: Optional[pulumi.Input['outputs.ProviderFeaturesKeyVault']] = None,
                 log_analytics_workspace: Optional[pulumi.Input['outputs.ProviderFeaturesLogAnalyticsWorkspace']] = None,
                 network: Optional[pulumi.Input['outputs.ProviderFeaturesNetwork']] = None,
                 template_deployment: Optional[pulumi.Input['outputs.ProviderFeaturesTemplateDeployment']] = None,
                 virtual_machine: Optional[pulumi.Input['outputs.ProviderFeaturesVirtualMachine']] = None,
                 virtual_machine_scale_set: Optional[pulumi.Input['outputs.ProviderFeaturesVirtualMachineScaleSet']] = None):
    ...
    def key_vault(self) -> Optional[pulumi.Input['outputs.ProviderFeaturesKeyVault']]:
        return pulumi.get(self, "key_vault")

    @property
    @pulumi.getter(name="logAnalyticsWorkspace")
    def log_analytics_workspace(self) -> Optional[pulumi.Input['outputs.ProviderFeaturesLogAnalyticsWorkspace']]:
        return pulumi.get(self, "log_analytics_workspace")

    @property
    @pulumi.getter
    def network(self) -> Optional[pulumi.Input['outputs.ProviderFeaturesNetwork']]:
        return pulumi.get(self, "network")

    @property
    @pulumi.getter(name="templateDeployment")
    def template_deployment(self) -> Optional[pulumi.Input['outputs.ProviderFeaturesTemplateDeployment']]:
        return pulumi.get(self, "template_deployment")

    @property
    @pulumi.getter(name="virtualMachine")
    def virtual_machine(self) -> Optional[pulumi.Input['outputs.ProviderFeaturesVirtualMachine']]:
        return pulumi.get(self, "virtual_machine")

    @property
    @pulumi.getter(name="virtualMachineScaleSet")
    def virtual_machine_scale_set(self) -> Optional[pulumi.Input['outputs.ProviderFeaturesVirtualMachineScaleSet']]:
