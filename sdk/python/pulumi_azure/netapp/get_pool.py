...
class _GetPoolResult(dict):
    ...
    size_in_tb: float = pulumi.property("sizeInTb")
...
def get_pool(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure:netapp/getPool:getPool', __args__, opts=opts, typ=_GetPoolResult).value
    ...
    return AwaitableGetPoolResult(
        ...
        size_in_tb=_utilities.get_dict_value(__ret__, 'sizeInTb'))
