...
class Volume(pulumi.CustomResource):
    ...
    export_policy_rules: pulumi.Output[Optional[List['outputs.VolumeExportPolicyRule']]] = pulumi.property("exportPolicyRules")
    """
    ...
    mount_ip_addresses: pulumi.Output[List[str]] = pulumi.property("mountIpAddresses")
    """
    ...
    pool_name: pulumi.Output[str] = pulumi.property("poolName")
    """
    ...
    service_level: pulumi.Output[str] = pulumi.property("serviceLevel")
    """
    The target performance of the file system. Valid values include `Premium`, `Standard`, or `Ultra`.
    """

    storage_quota_in_gb: pulumi.Output[float] = pulumi.property("storageQuotaInGb")
    """
    ...
    volume_path: pulumi.Output[str] = pulumi.property("volumePath")
    """
