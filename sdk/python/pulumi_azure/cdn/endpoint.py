...
class Endpoint(pulumi.CustomResource):
    content_types_to_compresses: pulumi.Output[List[str]] = pulumi.property("contentTypesToCompresses")
    """
    An array of strings that indicates a content types on which compression will be applied. The value for the elements should be MIME types.
    """

    delivery_rules: pulumi.Output[Optional[List['outputs.EndpointDeliveryRule']]] = pulumi.property("deliveryRules")
    """
    ...
    geo_filters: pulumi.Output[Optional[List['outputs.EndpointGeoFilter']]] = pulumi.property("geoFilters")
    """
    A set of Geo Filters for this CDN Endpoint. Each `geo_filter` block supports fields documented below.
    """

    global_delivery_rule: pulumi.Output[Optional['outputs.EndpointGlobalDeliveryRule']] = pulumi.property("globalDeliveryRule")
    """
    Actions that are valid for all resources regardless of any conditions. A `global_delivery_rule` block as defined below.
    """

    host_name: pulumi.Output[str] = pulumi.property("hostName")
    """
    A string that determines the hostname/IP address of the origin server. This string can be a domain name, Storage Account endpoint, Web App endpoint, IPv4 address or IPv6 address. Changing this forces a new resource to be created.
    """

    is_compression_enabled: pulumi.Output[Optional[bool]] = pulumi.property("isCompressionEnabled")
    """
    Indicates whether compression is to be enabled. Defaults to false.
    """

    is_http_allowed: pulumi.Output[Optional[bool]] = pulumi.property("isHttpAllowed")
    """
    Defaults to `true`.
    """

    is_https_allowed: pulumi.Output[Optional[bool]] = pulumi.property("isHttpsAllowed")
    """
    Defaults to `true`.
    """
    ...
    optimization_type: pulumi.Output[Optional[str]] = pulumi.property("optimizationType")
    """
    What types of optimization should this CDN Endpoint optimize for? Possible values include `DynamicSiteAcceleration`, `GeneralMediaStreaming`, `GeneralWebDelivery`, `LargeFileDownload` and `VideoOnDemandMediaStreaming`.
    """

    origin_host_header: pulumi.Output[Optional[str]] = pulumi.property("originHostHeader")
    """
    The host header CDN provider will send along with content requests to origins. Defaults to the host name of the origin.
    """

    origin_path: pulumi.Output[str] = pulumi.property("originPath")
    """
    The path used at for origin requests.
    """

    origins: pulumi.Output[List['outputs.EndpointOrigin']] = pulumi.property("origins")
    """
    The set of origins of the CDN endpoint. When multiple origins exist, the first origin will be used as primary and rest will be used as failover options. Each `origin` block supports fields documented below.
    """

    probe_path: pulumi.Output[str] = pulumi.property("probePath")
    """
    ...
    querystring_caching_behaviour: pulumi.Output[Optional[str]] = pulumi.property("querystringCachingBehaviour")
    """
