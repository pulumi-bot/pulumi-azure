...
class GetKubernetesServiceVersionsResult:
    ...
    def __init__(__self__, id=None, include_preview=None, latest_version=None, location=None, version_prefix=None, versions=None) -> None:
...
def get_kubernetes_service_versions(include_preview: Optional[bool] = None, location: Optional[str] = None, version_prefix: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetKubernetesServiceVersionsResult:
    """
