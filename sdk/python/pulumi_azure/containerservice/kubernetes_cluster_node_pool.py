...
class KubernetesClusterNodePool(pulumi.CustomResource):
    ...
    enable_auto_scaling: pulumi.Output[Optional[bool]] = pulumi.property("enableAutoScaling")
    """
    Whether to enable [auto-scaler](https://docs.microsoft.com/en-us/azure/aks/cluster-autoscaler). Defaults to `false`.
    """

    enable_node_public_ip: pulumi.Output[Optional[bool]] = pulumi.property("enableNodePublicIp")
    """
    ...
    kubernetes_cluster_id: pulumi.Output[str] = pulumi.property("kubernetesClusterId")
    """
    The ID of the Kubernetes Cluster where this Node Pool should exist. Changing this forces a new resource to be created.
    """

    max_count: pulumi.Output[Optional[float]] = pulumi.property("maxCount")
    """
    ...
    max_pods: pulumi.Output[float] = pulumi.property("maxPods")
    """
    The maximum number of pods that can run on each agent. Changing this forces a new resource to be created.
    """

    min_count: pulumi.Output[Optional[float]] = pulumi.property("minCount")
    """
    ...
    node_labels: pulumi.Output[Optional[Mapping[str, str]]] = pulumi.property("nodeLabels")
    """
    ...
    node_taints: pulumi.Output[Optional[List[str]]] = pulumi.property("nodeTaints")
    """
    A list of Kubernetes taints which should be applied to nodes in the agent pool (e.g `key=value:NoSchedule`). Changing this forces a new resource to be created.
    """

    orchestrator_version: pulumi.Output[str] = pulumi.property("orchestratorVersion")
    """
    Version of Kubernetes used for the Agents. If not specified, the latest recommended version will be used at provisioning time (but won't auto-upgrade)
    """

    os_disk_size_gb: pulumi.Output[float] = pulumi.property("osDiskSizeGb")
    """
    ...
    spot_max_price: pulumi.Output[Optional[float]] = pulumi.property("spotMaxPrice")
    """
    ...
    vnet_subnet_id: pulumi.Output[Optional[str]] = pulumi.property("vnetSubnetId")
    """
