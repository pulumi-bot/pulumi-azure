...
class RegistryWebhook(pulumi.CustomResource):
    actions: pulumi.Output[List[str]] = pulumi.property("actions")
    """
    ...
    custom_headers: pulumi.Output[Optional[Mapping[str, str]]] = pulumi.property("customHeaders")
    """
    ...
    registry_name: pulumi.Output[str] = pulumi.property("registryName")
    """
    ...
    scope: pulumi.Output[Optional[str]] = pulumi.property("scope")
    """
    ...
    service_uri: pulumi.Output[str] = pulumi.property("serviceUri")
    """
