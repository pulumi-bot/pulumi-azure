...
class GroupContainerArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "secureEnvironmentVariables", secure_environment_variables)
...
class GroupContainerLivenessProbeArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "httpGets", http_gets)
...
class GroupContainerVolumeArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "storageAccountKey", storage_account_key)
...
class GroupDiagnosticsArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "logAnalytics", log_analytics)
...
class GroupDiagnosticsLogAnalyticsArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "workspaceKey", workspace_key)
...
class KubernetesClusterAddonProfileArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "aciConnectorLinux", aci_connector_linux)
        pulumi.set(__self__, "azurePolicy", azure_policy)
        pulumi.set(__self__, "httpApplicationRouting", http_application_routing)
        pulumi.set(__self__, "kubeDashboard", kube_dashboard)
        pulumi.set(__self__, "omsAgent", oms_agent)
...
class KubernetesClusterAddonProfileHttpApplicationRoutingArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "enabled", enabled)
        pulumi.set(__self__, "httpApplicationRoutingZoneName", http_application_routing_zone_name)
...
class KubernetesClusterAddonProfileOmsAgentArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "enabled", enabled)
        pulumi.set(__self__, "logAnalyticsWorkspaceId", log_analytics_workspace_id)
        pulumi.set(__self__, "omsAgentIdentities", oms_agent_identities)
...
class KubernetesClusterAddonProfileOmsAgentOmsAgentIdentityArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "objectId", object_id)
        pulumi.set(__self__, "userAssignedIdentityId", user_assigned_identity_id)
...
class KubernetesClusterAutoScalerProfileArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "balanceSimilarNodeGroups", balance_similar_node_groups)
        pulumi.set(__self__, "maxGracefulTerminationSec", max_graceful_termination_sec)
        pulumi.set(__self__, "scaleDownDelayAfterAdd", scale_down_delay_after_add)
        pulumi.set(__self__, "scaleDownDelayAfterDelete", scale_down_delay_after_delete)
        pulumi.set(__self__, "scaleDownDelayAfterFailure", scale_down_delay_after_failure)
        pulumi.set(__self__, "scaleDownUnneeded", scale_down_unneeded)
        pulumi.set(__self__, "scaleDownUnready", scale_down_unready)
        pulumi.set(__self__, "scaleDownUtilizationThreshold", scale_down_utilization_threshold)
        pulumi.set(__self__, "scanInterval", scan_interval)
...
class KubernetesClusterDefaultNodePoolArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "vmSize", vm_size)
        pulumi.set(__self__, "availabilityZones", availability_zones)
        pulumi.set(__self__, "enableAutoScaling", enable_auto_scaling)
        pulumi.set(__self__, "enableNodePublicIp", enable_node_public_ip)
        pulumi.set(__self__, "maxCount", max_count)
        pulumi.set(__self__, "maxPods", max_pods)
        pulumi.set(__self__, "minCount", min_count)
        pulumi.set(__self__, "nodeCount", node_count)
        pulumi.set(__self__, "nodeLabels", node_labels)
        pulumi.set(__self__, "nodeTaints", node_taints)
        pulumi.set(__self__, "orchestratorVersion", orchestrator_version)
        pulumi.set(__self__, "osDiskSizeGb", os_disk_size_gb)
        pulumi.set(__self__, "tags", tags)
        pulumi.set(__self__, "type", type)
        pulumi.set(__self__, "vnetSubnetId", vnet_subnet_id)
...
class KubernetesClusterNetworkProfileArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "networkPlugin", network_plugin)
        pulumi.set(__self__, "dnsServiceIp", dns_service_ip)
        pulumi.set(__self__, "dockerBridgeCidr", docker_bridge_cidr)
        pulumi.set(__self__, "loadBalancerProfile", load_balancer_profile)
        pulumi.set(__self__, "loadBalancerSku", load_balancer_sku)
        pulumi.set(__self__, "networkPolicy", network_policy)
        pulumi.set(__self__, "outboundType", outbound_type)
        pulumi.set(__self__, "podCidr", pod_cidr)
        pulumi.set(__self__, "serviceCidr", service_cidr)
...
class KubernetesClusterNetworkProfileLoadBalancerProfileArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "effectiveOutboundIps", effective_outbound_ips)
        pulumi.set(__self__, "idleTimeoutInMinutes", idle_timeout_in_minutes)
        pulumi.set(__self__, "managedOutboundIpCount", managed_outbound_ip_count)
        pulumi.set(__self__, "outboundIpAddressIds", outbound_ip_address_ids)
        pulumi.set(__self__, "outboundIpPrefixIds", outbound_ip_prefix_ids)
        pulumi.set(__self__, "outboundPortsAllocated", outbound_ports_allocated)
...
class KubernetesClusterRoleBasedAccessControlArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "enabled", enabled)
        pulumi.set(__self__, "azureActiveDirectory", azure_active_directory)
...
class KubernetesClusterRoleBasedAccessControlAzureActiveDirectoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] tenant_id: The Tenant ID used for Azure Active Directory Application. If this isn't specified the Tenant ID of the current Subscription is used.
        """
        pulumi.set(__self__, "adminGroupObjectIds", admin_group_object_ids)
        pulumi.set(__self__, "clientAppId", client_app_id)
        pulumi.set(__self__, "managed", managed)
        pulumi.set(__self__, "serverAppId", server_app_id)
        pulumi.set(__self__, "serverAppSecret", server_app_secret)
        pulumi.set(__self__, "tenantId", tenant_id)
...
class RegistryNetworkRuleSetArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "virtualNetworks", virtual_networks)
