...
class Assignment(pulumi.CustomResource):
    blueprint_name: pulumi.Output[str] = pulumi.output_property("blueprintName")
    """
    ...
    """
    identity: pulumi.Output[Optional['outputs.AssignmentIdentity']] = pulumi.output_property("identity")
    location: pulumi.Output[str] = pulumi.output_property("location")
    """
    The Azure location of the Assignment.
    """
    lock_exclude_principals: pulumi.Output[Optional[List[str]]] = pulumi.output_property("lockExcludePrincipals")
    """
    a list of up to 5 Principal IDs that are permitted to bypass the locks applied by the Blueprint.
    """
    lock_mode: pulumi.Output[Optional[str]] = pulumi.output_property("lockMode")
    """
    ...
    """
    parameter_values: pulumi.Output[Optional[str]] = pulumi.output_property("parameterValues")
    """
    a JSON string to supply Blueprint Assignment parameter values.
    """
    resource_groups: pulumi.Output[Optional[str]] = pulumi.output_property("resourceGroups")
    """
    a JSON string to supply the Blueprint Resource Group information.
    """
    target_subscription_id: pulumi.Output[str] = pulumi.output_property("targetSubscriptionId")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, identity: Optional[pulumi.Input[pulumi.InputType['AssignmentIdentityArgs']]] = None, location: Optional[pulumi.Input[str]] = None, lock_exclude_principals: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, lock_mode: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, parameter_values: Optional[pulumi.Input[str]] = None, resource_groups: Optional[pulumi.Input[str]] = None, target_subscription_id: Optional[pulumi.Input[str]] = None, version_id: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, blueprint_name: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, display_name: Optional[pulumi.Input[str]] = None, identity: Optional[pulumi.Input[pulumi.InputType['AssignmentIdentityArgs']]] = None, location: Optional[pulumi.Input[str]] = None, lock_exclude_principals: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, lock_mode: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, parameter_values: Optional[pulumi.Input[str]] = None, resource_groups: Optional[pulumi.Input[str]] = None, target_subscription_id: Optional[pulumi.Input[str]] = None, type: Optional[pulumi.Input[str]] = None, version_id: Optional[pulumi.Input[str]] = None) -> 'Assignment':
        """
