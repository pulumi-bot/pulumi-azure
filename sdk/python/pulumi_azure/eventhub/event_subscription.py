...
class EventSubscription(pulumi.CustomResource):
    advanced_filter: pulumi.Output[Optional['outputs.EventSubscriptionAdvancedFilter']] = pulumi.property("advancedFilter")
    """
    A `advanced_filter` block as defined below.
    """

    azure_function_endpoint: pulumi.Output[Optional['outputs.EventSubscriptionAzureFunctionEndpoint']] = pulumi.property("azureFunctionEndpoint")
    """
    An `azure_function_endpoint` block as defined below.
    """

    event_delivery_schema: pulumi.Output[Optional[str]] = pulumi.property("eventDeliverySchema")
    """
    Specifies the event delivery schema for the event subscription. Possible values include: `EventGridSchema`, `CloudEventSchemaV1_0`, `CustomInputSchema`. Defaults to `EventGridSchema`. Changing this forces a new resource to be created.
    """

    eventhub_endpoint: pulumi.Output['outputs.EventSubscriptionEventhubEndpoint'] = pulumi.property("eventhubEndpoint")
    """
    A `eventhub_endpoint` block as defined below.
    """

    eventhub_endpoint_id: pulumi.Output[str] = pulumi.property("eventhubEndpointId")
    """
    Specifies the id where the Event Hub is located.
    """

    expiration_time_utc: pulumi.Output[Optional[str]] = pulumi.property("expirationTimeUtc")
    """
    Specifies the expiration time of the event subscription (Datetime Format `RFC 3339`).
    """

    hybrid_connection_endpoint: pulumi.Output['outputs.EventSubscriptionHybridConnectionEndpoint'] = pulumi.property("hybridConnectionEndpoint")
    """
    A `hybrid_connection_endpoint` block as defined below.
    """

    hybrid_connection_endpoint_id: pulumi.Output[str] = pulumi.property("hybridConnectionEndpointId")
    """
    Specifies the id where the Hybrid Connection is located.
    """

    included_event_types: pulumi.Output[List[str]] = pulumi.property("includedEventTypes")
    """
    A list of applicable event types that need to be part of the event subscription.
    """

    labels: pulumi.Output[Optional[List[str]]] = pulumi.property("labels")
    """
    ...
    retry_policy: pulumi.Output['outputs.EventSubscriptionRetryPolicy'] = pulumi.property("retryPolicy")
    """
    ...
    service_bus_queue_endpoint_id: pulumi.Output[Optional[str]] = pulumi.property("serviceBusQueueEndpointId")
    """
    Specifies the id where the Service Bus Queue is located.
    """

    service_bus_topic_endpoint_id: pulumi.Output[Optional[str]] = pulumi.property("serviceBusTopicEndpointId")
    """
    Specifies the id where the Service Bus Topic is located.
    """

    storage_blob_dead_letter_destination: pulumi.Output[Optional['outputs.EventSubscriptionStorageBlobDeadLetterDestination']] = pulumi.property("storageBlobDeadLetterDestination")
    """
    A `storage_blob_dead_letter_destination` block as defined below.
    """

    storage_queue_endpoint: pulumi.Output[Optional['outputs.EventSubscriptionStorageQueueEndpoint']] = pulumi.property("storageQueueEndpoint")
    """
    A `storage_queue_endpoint` block as defined below.
    """

    subject_filter: pulumi.Output[Optional['outputs.EventSubscriptionSubjectFilter']] = pulumi.property("subjectFilter")
    """
    ...
    webhook_endpoint: pulumi.Output[Optional['outputs.EventSubscriptionWebhookEndpoint']] = pulumi.property("webhookEndpoint")
    """
