...
class EventGridTopic(pulumi.CustomResource):
    ...
    input_mapping_default_values: pulumi.Output[Optional['outputs.EventGridTopicInputMappingDefaultValues']] = pulumi.property("inputMappingDefaultValues")
    """
    A `input_mapping_default_values` block as defined below.
    """

    input_mapping_fields: pulumi.Output[Optional['outputs.EventGridTopicInputMappingFields']] = pulumi.property("inputMappingFields")
    """
