...
class EventHub(pulumi.CustomResource):
    capture_description: pulumi.Output[Optional['outputs.EventHubCaptureDescription']] = pulumi.output_property("captureDescription")
    """
    A `capture_description` block as defined below.
    """
    message_retention: pulumi.Output[float] = pulumi.output_property("messageRetention")
    """
    ...
    """
    partition_ids: pulumi.Output[List[str]] = pulumi.output_property("partitionIds")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, capture_description: Optional[pulumi.Input[pulumi.InputType['EventHubCaptureDescriptionArgs']]] = None, message_retention: Optional[pulumi.Input[float]] = None, name: Optional[pulumi.Input[str]] = None, namespace_name: Optional[pulumi.Input[str]] = None, partition_count: Optional[pulumi.Input[float]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, capture_description: Optional[pulumi.Input[pulumi.InputType['EventHubCaptureDescriptionArgs']]] = None, message_retention: Optional[pulumi.Input[float]] = None, name: Optional[pulumi.Input[str]] = None, namespace_name: Optional[pulumi.Input[str]] = None, partition_count: Optional[pulumi.Input[float]] = None, partition_ids: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, resource_group_name: Optional[pulumi.Input[str]] = None) -> 'EventHub':
        """
