...
class EventHub(pulumi.CustomResource):
    capture_description: pulumi.Output[Optional['outputs.EventHubCaptureDescription']] = pulumi.property("captureDescription")
    """
    A `capture_description` block as defined below.
    """

    message_retention: pulumi.Output[float] = pulumi.property("messageRetention")
    """
    ...
    partition_count: pulumi.Output[float] = pulumi.property("partitionCount")
    """
    Specifies the current number of shards on the Event Hub. Changing this forces a new resource to be created.
    """

    partition_ids: pulumi.Output[List[str]] = pulumi.property("partitionIds")
    """
