...
class Domain(pulumi.CustomResource):
    ...
    input_mapping_default_values: pulumi.Output[Optional['outputs.DomainInputMappingDefaultValues']] = pulumi.property("inputMappingDefaultValues")
    """
    A `input_mapping_default_values` block as defined below.
    """

    input_mapping_fields: pulumi.Output[Optional['outputs.DomainInputMappingFields']] = pulumi.property("inputMappingFields")
    """
