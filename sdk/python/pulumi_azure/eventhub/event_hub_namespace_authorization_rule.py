...
class EventHubNamespaceAuthorizationRule(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        __props__ = _EventHubNamespaceAuthorizationRuleState.__new__(_EventHubNamespaceAuthorizationRuleState)
        ...
        __props__.__dict__["send"] = send
        return EventHubNamespaceAuthorizationRule(resource_name_, opts=opts, __props__=__props__)
