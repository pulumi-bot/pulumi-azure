...
class EventHubNamespace(pulumi.CustomResource):
    auto_inflate_enabled: pulumi.Output[Optional[bool]] = pulumi.property("autoInflateEnabled")
    """
    Is Auto Inflate enabled for the EventHub Namespace?
    """

    capacity: pulumi.Output[Optional[float]] = pulumi.property("capacity")
    """
    Specifies the Capacity / Throughput Units for a `Standard` SKU namespace. Valid values range from `1` - `20`.
    """

    dedicated_cluster_id: pulumi.Output[Optional[str]] = pulumi.property("dedicatedClusterId")
    """
    Specifies the ID of the EventHub Dedicated Cluster where this Namespace should created. Changing this forces a new resource to be created.
    """

    default_primary_connection_string: pulumi.Output[str] = pulumi.property("defaultPrimaryConnectionString")
    """
    The primary connection string for the authorization
    rule `RootManageSharedAccessKey`.
    """

    default_primary_connection_string_alias: pulumi.Output[str] = pulumi.property("defaultPrimaryConnectionStringAlias")
    """
    ...
    default_primary_key: pulumi.Output[str] = pulumi.property("defaultPrimaryKey")
    """
    The primary access key for the authorization rule `RootManageSharedAccessKey`.
    """

    default_secondary_connection_string: pulumi.Output[str] = pulumi.property("defaultSecondaryConnectionString")
    """
    The secondary connection string for the
    authorization rule `RootManageSharedAccessKey`.
    """

    default_secondary_connection_string_alias: pulumi.Output[str] = pulumi.property("defaultSecondaryConnectionStringAlias")
    """
    ...
    default_secondary_key: pulumi.Output[str] = pulumi.property("defaultSecondaryKey")
    """
    The secondary access key for the authorization rule `RootManageSharedAccessKey`.
    """

    identity: pulumi.Output[Optional['outputs.EventHubNamespaceIdentity']] = pulumi.property("identity")
    """
    ...
    maximum_throughput_units: pulumi.Output[float] = pulumi.property("maximumThroughputUnits")
    """
    ...
    network_rulesets: pulumi.Output['outputs.EventHubNamespaceNetworkRulesets'] = pulumi.property("networkRulesets")
    """
