...
class AssignmentDedicatedHost(pulumi.CustomResource):
    dedicated_host_id: pulumi.Output[str] = pulumi.output_property("dedicatedHostId")
    """
    ...
    """
    maintenance_configuration_id: pulumi.Output[str] = pulumi.output_property("maintenanceConfigurationId")
    """
    Specifies the ID of the Maintenance Configuration Resource. Changing this forces a new resource to be created.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, dedicated_host_id: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, maintenance_configuration_id: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, dedicated_host_id: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, maintenance_configuration_id: Optional[pulumi.Input[str]] = None) -> 'AssignmentDedicatedHost':
        """
