...
class NetworkInterface(pulumi.CustomResource):
    applied_dns_servers: pulumi.Output[List[str]] = pulumi.property("appliedDnsServers")
    """
    If the Virtual Machine using this Network Interface is part of an Availability Set, then this list will have the union of all DNS servers from all Network Interfaces that are part of the Availability Set.
    """

    dns_servers: pulumi.Output[List[str]] = pulumi.property("dnsServers")
    """
    A list of IP Addresses defining the DNS Servers which should be used for this Network Interface.
    """

    enable_accelerated_networking: pulumi.Output[Optional[bool]] = pulumi.property("enableAcceleratedNetworking")
    """
    Should Accelerated Networking be enabled? Defaults to `false`.
    """

    enable_ip_forwarding: pulumi.Output[Optional[bool]] = pulumi.property("enableIpForwarding")
    """
    Should IP Forwarding be enabled? Defaults to `false`.
    """

    internal_dns_name_label: pulumi.Output[str] = pulumi.property("internalDnsNameLabel")
    """
    The (relative) DNS Name used for internal communications between Virtual Machines in the same Virtual Network.
    """

    internal_domain_name_suffix: pulumi.Output[str] = pulumi.property("internalDomainNameSuffix")
    """
    ...
    ip_configurations: pulumi.Output[List['outputs.NetworkInterfaceIpConfiguration']] = pulumi.property("ipConfigurations")
    """
