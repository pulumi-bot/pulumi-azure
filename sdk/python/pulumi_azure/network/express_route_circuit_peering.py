...
class ExpressRouteCircuitPeering(pulumi.CustomResource):
    azure_asn: pulumi.Output[float] = pulumi.property("azureAsn")
    """
    The ASN used by Azure.
    """

    express_route_circuit_name: pulumi.Output[str] = pulumi.property("expressRouteCircuitName")
    """
    The name of the ExpressRoute Circuit in which to create the Peering.
    """

    microsoft_peering_config: pulumi.Output[Optional['outputs.ExpressRouteCircuitPeeringMicrosoftPeeringConfig']] = pulumi.property("microsoftPeeringConfig")
    """
    ...
    peering_type: pulumi.Output[str] = pulumi.property("peeringType")
    """
    The type of the ExpressRoute Circuit Peering. Acceptable values include `AzurePrivatePeering`, `AzurePublicPeering` and `MicrosoftPeering`. Changing this forces a new resource to be created.
    """

    primary_azure_port: pulumi.Output[str] = pulumi.property("primaryAzurePort")
    """
    The Primary Port used by Azure for this Peering.
    """

    primary_peer_address_prefix: pulumi.Output[str] = pulumi.property("primaryPeerAddressPrefix")
    """
    ...
    route_filter_id: pulumi.Output[Optional[str]] = pulumi.property("routeFilterId")
    """
    The ID of the Route Filter. Only available when `peering_type` is set to `MicrosoftPeering`.
    """

    secondary_azure_port: pulumi.Output[str] = pulumi.property("secondaryAzurePort")
    """
    The Secondary Port used by Azure for this Peering.
    """

    secondary_peer_address_prefix: pulumi.Output[str] = pulumi.property("secondaryPeerAddressPrefix")
    """
    ...
    vlan_id: pulumi.Output[float] = pulumi.property("vlanId")
    """
