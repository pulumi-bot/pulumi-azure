...
class TrafficManagerEndpoint(pulumi.CustomResource):
    custom_headers: pulumi.Output[Optional[List['outputs.TrafficManagerEndpointCustomHeader']]] = pulumi.output_property("customHeaders")
    """
    ...
    """
    subnets: pulumi.Output[Optional[List['outputs.TrafficManagerEndpointSubnet']]] = pulumi.output_property("subnets")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, custom_headers: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['TrafficManagerEndpointCustomHeaderArgs']]]]] = None, endpoint_location: Optional[pulumi.Input[str]] = None, endpoint_status: Optional[pulumi.Input[str]] = None, geo_mappings: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, min_child_endpoints: Optional[pulumi.Input[float]] = None, name: Optional[pulumi.Input[str]] = None, priority: Optional[pulumi.Input[float]] = None, profile_name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, subnets: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['TrafficManagerEndpointSubnetArgs']]]]] = None, target: Optional[pulumi.Input[str]] = None, target_resource_id: Optional[pulumi.Input[str]] = None, type: Optional[pulumi.Input[str]] = None, weight: Optional[pulumi.Input[float]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, custom_headers: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['TrafficManagerEndpointCustomHeaderArgs']]]]] = None, endpoint_location: Optional[pulumi.Input[str]] = None, endpoint_monitor_status: Optional[pulumi.Input[str]] = None, endpoint_status: Optional[pulumi.Input[str]] = None, geo_mappings: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, min_child_endpoints: Optional[pulumi.Input[float]] = None, name: Optional[pulumi.Input[str]] = None, priority: Optional[pulumi.Input[float]] = None, profile_name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, subnets: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['TrafficManagerEndpointSubnetArgs']]]]] = None, target: Optional[pulumi.Input[str]] = None, target_resource_id: Optional[pulumi.Input[str]] = None, type: Optional[pulumi.Input[str]] = None, weight: Optional[pulumi.Input[float]] = None) -> 'TrafficManagerEndpoint':
        """
