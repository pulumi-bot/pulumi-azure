...
class VirtualNetworkGateway(pulumi.CustomResource):
    active_active: pulumi.Output[bool] = pulumi.property("activeActive")
    """
    ...
    bgp_settings: pulumi.Output['outputs.VirtualNetworkGatewayBgpSettings'] = pulumi.property("bgpSettings")

    default_local_network_gateway_id: pulumi.Output[Optional[str]] = pulumi.property("defaultLocalNetworkGatewayId")
    """
    ...
    generation: pulumi.Output[str] = pulumi.property("generation")
    """
    The Generation of the Virtual Network gateway. Possible values include `Generation1`, `Generation2` or `None`.
    """

    ip_configurations: pulumi.Output[List['outputs.VirtualNetworkGatewayIpConfiguration']] = pulumi.property("ipConfigurations")
    """
    ...
    vpn_client_configuration: pulumi.Output[Optional['outputs.VirtualNetworkGatewayVpnClientConfiguration']] = pulumi.property("vpnClientConfiguration")
    """
    ...
    vpn_type: pulumi.Output[Optional[str]] = pulumi.property("vpnType")
    """
