...
class VirtualNetworkGateway(pulumi.CustomResource):
    active_active: pulumi.Output[bool] = pulumi.output_property("activeActive")
    """
    ...
    Defaults to `false`.
    """
    bgp_settings: pulumi.Output['outputs.VirtualNetworkGatewayBgpSettings'] = pulumi.output_property("bgpSettings")
    default_local_network_gateway_id: pulumi.Output[Optional[str]] = pulumi.output_property("defaultLocalNetworkGatewayId")
    """
    ...
    """
    generation: pulumi.Output[str] = pulumi.output_property("generation")
    """
    The Generation of the Virtual Network gateway. Possible values include `Generation1`, `Generation2` or `None`.
    """
    ip_configurations: pulumi.Output[List['outputs.VirtualNetworkGatewayIpConfiguration']] = pulumi.output_property("ipConfigurations")
    """
    ...
    """
    vpn_client_configuration: pulumi.Output[Optional['outputs.VirtualNetworkGatewayVpnClientConfiguration']] = pulumi.output_property("vpnClientConfiguration")
    """
    A `vpn_client_configuration` block which
    is documented below. In this block the Virtual Network Gateway can be configured
    to accept IPSec point-to-site connections.
    """
    vpn_type: pulumi.Output[Optional[str]] = pulumi.output_property("vpnType")
    """
    The routing type of the Virtual Network Gateway. Valid
    options are `RouteBased` or `PolicyBased`. Defaults to `RouteBased`.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, active_active: Optional[pulumi.Input[bool]] = None, bgp_settings: Optional[pulumi.Input[pulumi.InputType['VirtualNetworkGatewayBgpSettingsArgs']]] = None, default_local_network_gateway_id: Optional[pulumi.Input[str]] = None, enable_bgp: Optional[pulumi.Input[bool]] = None, generation: Optional[pulumi.Input[str]] = None, ip_configurations: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['VirtualNetworkGatewayIpConfigurationArgs']]]]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, sku: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, type: Optional[pulumi.Input[str]] = None, vpn_client_configuration: Optional[pulumi.Input[pulumi.InputType['VirtualNetworkGatewayVpnClientConfigurationArgs']]] = None, vpn_type: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, active_active: Optional[pulumi.Input[bool]] = None, bgp_settings: Optional[pulumi.Input[pulumi.InputType['VirtualNetworkGatewayBgpSettingsArgs']]] = None, default_local_network_gateway_id: Optional[pulumi.Input[str]] = None, enable_bgp: Optional[pulumi.Input[bool]] = None, generation: Optional[pulumi.Input[str]] = None, ip_configurations: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['VirtualNetworkGatewayIpConfigurationArgs']]]]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, sku: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, type: Optional[pulumi.Input[str]] = None, vpn_client_configuration: Optional[pulumi.Input[pulumi.InputType['VirtualNetworkGatewayVpnClientConfigurationArgs']]] = None, vpn_type: Optional[pulumi.Input[str]] = None) -> 'VirtualNetworkGateway':
        """
