...
class _GetNatGatewayResult(dict):
    ...
    public_ip_address_ids: List[str] = pulumi.property("publicIpAddressIds")
    public_ip_prefix_ids: List[str] = pulumi.property("publicIpPrefixIds")
...
def get_nat_gateway(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure:network/getNatGateway:getNatGateway', __args__, opts=opts, typ=_GetNatGatewayResult).value

    return AwaitableGetNatGatewayResult(
        id=_utilities.get_dict_value(__ret__, 'id'),
        idle_timeout_in_minutes=_utilities.get_dict_value(__ret__, 'idleTimeoutInMinutes'),
        location=_utilities.get_dict_value(__ret__, 'location'),
        name=_utilities.get_dict_value(__ret__, 'name'),
        public_ip_address_ids=_utilities.get_dict_value(__ret__, 'publicIpAddressIds'),
        public_ip_prefix_ids=_utilities.get_dict_value(__ret__, 'publicIpPrefixIds'),
