...
class VirtualNetwork(pulumi.CustomResource):
    address_spaces: pulumi.Output[List[str]] = pulumi.property("addressSpaces")
    """
    The address space that is used the virtual network. You can supply more than one address space.
    """

    ddos_protection_plan: pulumi.Output[Optional['outputs.VirtualNetworkDdosProtectionPlan']] = pulumi.property("ddosProtectionPlan")
    """
    ...
    guid: pulumi.Output[str] = pulumi.property("guid")
    """
    ...
    subnets: pulumi.Output[List['outputs.VirtualNetworkSubnet']] = pulumi.property("subnets")
    """
