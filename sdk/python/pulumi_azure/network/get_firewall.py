...
class GetFirewallResult:
    ...
    def __init__(__self__, id=None, ip_configurations=None, location=None, name=None, resource_group_name=None, tags=None) -> None:
...
def get_firewall(name: Optional[str] = None, resource_group_name: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFirewallResult:
    """
