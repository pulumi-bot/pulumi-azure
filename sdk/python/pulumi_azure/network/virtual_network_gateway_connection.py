...
class VirtualNetworkGatewayConnection(pulumi.CustomResource):
    ...
    """
    traffic_selector_policy: pulumi.Output[Optional['outputs.VirtualNetworkGatewayConnectionTrafficSelectorPolicy']] = pulumi.output_property("trafficSelectorPolicy")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, authorization_key: Optional[pulumi.Input[str]] = None, connection_protocol: Optional[pulumi.Input[str]] = None, enable_bgp: Optional[pulumi.Input[bool]] = None, express_route_circuit_id: Optional[pulumi.Input[str]] = None, express_route_gateway_bypass: Optional[pulumi.Input[bool]] = None, ipsec_policy: Optional[pulumi.Input[pulumi.InputType['VirtualNetworkGatewayConnectionIpsecPolicyArgs']]] = None, local_network_gateway_id: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, peer_virtual_network_gateway_id: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, routing_weight: Optional[pulumi.Input[float]] = None, shared_key: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, traffic_selector_policy: Optional[pulumi.Input[pulumi.InputType['VirtualNetworkGatewayConnectionTrafficSelectorPolicyArgs']]] = None, type: Optional[pulumi.Input[str]] = None, use_policy_based_traffic_selectors: Optional[pulumi.Input[bool]] = None, virtual_network_gateway_id: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, authorization_key: Optional[pulumi.Input[str]] = None, connection_protocol: Optional[pulumi.Input[str]] = None, enable_bgp: Optional[pulumi.Input[bool]] = None, express_route_circuit_id: Optional[pulumi.Input[str]] = None, express_route_gateway_bypass: Optional[pulumi.Input[bool]] = None, ipsec_policy: Optional[pulumi.Input[pulumi.InputType['VirtualNetworkGatewayConnectionIpsecPolicyArgs']]] = None, local_network_gateway_id: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, peer_virtual_network_gateway_id: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, routing_weight: Optional[pulumi.Input[float]] = None, shared_key: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, traffic_selector_policy: Optional[pulumi.Input[pulumi.InputType['VirtualNetworkGatewayConnectionTrafficSelectorPolicyArgs']]] = None, type: Optional[pulumi.Input[str]] = None, use_policy_based_traffic_selectors: Optional[pulumi.Input[bool]] = None, virtual_network_gateway_id: Optional[pulumi.Input[str]] = None) -> 'VirtualNetworkGatewayConnection':
        """
