...
class VirtualNetworkGatewayConnection(pulumi.CustomResource):
    authorization_key: pulumi.Output[Optional[str]] = pulumi.property("authorizationKey")
    """
    ...
    connection_protocol: pulumi.Output[str] = pulumi.property("connectionProtocol")
    """
    ...
    enable_bgp: pulumi.Output[bool] = pulumi.property("enableBgp")
    """
    If `true`, BGP (Border Gateway Protocol) is enabled
    for this connection. Defaults to `false`.
    """

    express_route_circuit_id: pulumi.Output[Optional[str]] = pulumi.property("expressRouteCircuitId")
    """
    ...
    express_route_gateway_bypass: pulumi.Output[bool] = pulumi.property("expressRouteGatewayBypass")
    """
    If `true`, data packets will bypass ExpressRoute Gateway for data forwarding This is only valid for ExpressRoute connections.
    """

    ipsec_policy: pulumi.Output[Optional['outputs.VirtualNetworkGatewayConnectionIpsecPolicy']] = pulumi.property("ipsecPolicy")
    """
    ...
    local_network_gateway_id: pulumi.Output[Optional[str]] = pulumi.property("localNetworkGatewayId")
    """
    ...
    peer_virtual_network_gateway_id: pulumi.Output[Optional[str]] = pulumi.property("peerVirtualNetworkGatewayId")
    """
    ...
    routing_weight: pulumi.Output[float] = pulumi.property("routingWeight")
    """
    The routing weight. Defaults to `10`.
    """

    shared_key: pulumi.Output[Optional[str]] = pulumi.property("sharedKey")
    """
    ...
    traffic_selector_policy: pulumi.Output[Optional['outputs.VirtualNetworkGatewayConnectionTrafficSelectorPolicy']] = pulumi.property("trafficSelectorPolicy")
    """
    ...
    use_policy_based_traffic_selectors: pulumi.Output[bool] = pulumi.property("usePolicyBasedTrafficSelectors")
    """
    ...
    virtual_network_gateway_id: pulumi.Output[str] = pulumi.property("virtualNetworkGatewayId")
    """
