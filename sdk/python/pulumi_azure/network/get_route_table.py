...
class GetRouteTableResult:
    ...
    def __init__(__self__, id=None, location=None, name=None, resource_group_name=None, routes=None, subnets=None, tags=None) -> None:
...
def get_route_table(name: Optional[str] = None, resource_group_name: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRouteTableResult:
    """
