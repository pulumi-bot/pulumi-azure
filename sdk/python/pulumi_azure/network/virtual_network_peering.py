...
class VirtualNetworkPeering(pulumi.CustomResource):
    allow_forwarded_traffic: pulumi.Output[bool] = pulumi.property("allowForwardedTraffic")
    """
    Controls if forwarded traffic from  VMs
    in the remote virtual network is allowed. Defaults to false.
    """

    allow_gateway_transit: pulumi.Output[bool] = pulumi.property("allowGatewayTransit")
    """
    Controls gatewayLinks can be used in the
    remote virtual network’s link to the local virtual network.
    """

    allow_virtual_network_access: pulumi.Output[Optional[bool]] = pulumi.property("allowVirtualNetworkAccess")
    """
    ...
    use_remote_gateways: pulumi.Output[bool] = pulumi.property("useRemoteGateways")
    """
