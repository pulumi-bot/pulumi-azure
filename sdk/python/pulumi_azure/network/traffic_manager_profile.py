...
class TrafficManagerProfile(pulumi.CustomResource):
    dns_config: pulumi.Output['outputs.TrafficManagerProfileDnsConfig'] = pulumi.property("dnsConfig")
    """
    ...
    monitor_config: pulumi.Output['outputs.TrafficManagerProfileMonitorConfig'] = pulumi.property("monitorConfig")
    """
    ...
    profile_status: pulumi.Output[str] = pulumi.property("profileStatus")
    """
    ...
    traffic_routing_method: pulumi.Output[str] = pulumi.property("trafficRoutingMethod")
    """
