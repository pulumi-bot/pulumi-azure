...
class VirtualHubConnection(pulumi.CustomResource):
    hub_to_vitual_network_traffic_allowed: pulumi.Output[Optional[bool]] = pulumi.output_property("hubToVitualNetworkTrafficAllowed")
    """
    ...
    """
    internet_security_enabled: pulumi.Output[Optional[bool]] = pulumi.output_property("internetSecurityEnabled")
    """
    ...
    """
    vitual_network_to_hub_gateways_traffic_allowed: pulumi.Output[Optional[bool]] = pulumi.output_property("vitualNetworkToHubGatewaysTrafficAllowed")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, hub_to_vitual_network_traffic_allowed: Optional[pulumi.Input[bool]] = None, internet_security_enabled: Optional[pulumi.Input[bool]] = None, name: Optional[pulumi.Input[str]] = None, remote_virtual_network_id: Optional[pulumi.Input[str]] = None, virtual_hub_id: Optional[pulumi.Input[str]] = None, vitual_network_to_hub_gateways_traffic_allowed: Optional[pulumi.Input[bool]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, hub_to_vitual_network_traffic_allowed: Optional[pulumi.Input[bool]] = None, internet_security_enabled: Optional[pulumi.Input[bool]] = None, name: Optional[pulumi.Input[str]] = None, remote_virtual_network_id: Optional[pulumi.Input[str]] = None, virtual_hub_id: Optional[pulumi.Input[str]] = None, vitual_network_to_hub_gateways_traffic_allowed: Optional[pulumi.Input[bool]] = None) -> 'VirtualHubConnection':
        """
