...
@pulumi.output_type
class _GetExpressRouteCircuitResult(dict):
...
def get_express_route_circuit(name: Optional[str] = None,
    ...
    return AwaitableGetExpressRouteCircuitResult(
        ...
        peerings=_utilities.get_dict_value(__ret__, 'peerings'),
        resource_group_name=_utilities.get_dict_value(__ret__, 'resourceGroupName'),
        service_key=_utilities.get_dict_value(__ret__, 'serviceKey'),
        service_provider_properties=_utilities.get_dict_value(__ret__, 'serviceProviderProperties'),
        service_provider_provisioning_state=_utilities.get_dict_value(__ret__, 'serviceProviderProvisioningState'),
