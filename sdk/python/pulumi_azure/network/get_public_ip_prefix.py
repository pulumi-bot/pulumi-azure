...
class GetPublicIpPrefixResult:
    ...
    def __init__(__self__, id=None, ip_prefix=None, location=None, name=None, prefix_length=None, resource_group_name=None, sku=None, tags=None, zones=None) -> None:
...
def get_public_ip_prefix(name: Optional[str] = None, resource_group_name: Optional[str] = None, zones: Optional[List[str]] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPublicIpPrefixResult:
    """
