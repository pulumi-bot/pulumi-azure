...
class VpnServerConfiguration(pulumi.CustomResource):
    azure_active_directory_authentications: pulumi.Output[Optional[List['outputs.VpnServerConfigurationAzureActiveDirectoryAuthentication']]] = pulumi.output_property("azureActiveDirectoryAuthentications")
    """
    A `azure_active_directory_authentication` block as defined below.
    """
    client_revoked_certificates: pulumi.Output[Optional[List['outputs.VpnServerConfigurationClientRevokedCertificate']]] = pulumi.output_property("clientRevokedCertificates")
    """
    One or more `client_revoked_certificate` blocks as defined below.
    """
    client_root_certificates: pulumi.Output[Optional[List['outputs.VpnServerConfigurationClientRootCertificate']]] = pulumi.output_property("clientRootCertificates")
    """
    One or more `client_root_certificate` blocks as defined below.
    """
    ipsec_policy: pulumi.Output[Optional['outputs.VpnServerConfigurationIpsecPolicy']] = pulumi.output_property("ipsecPolicy")
    """
    ...
    """
    radius_server: pulumi.Output[Optional['outputs.VpnServerConfigurationRadiusServer']] = pulumi.output_property("radiusServer")
    """
    ...
    """
    vpn_authentication_types: pulumi.Output[str] = pulumi.output_property("vpnAuthenticationTypes")
    """
    ...
    """
    vpn_protocols: pulumi.Output[List[str]] = pulumi.output_property("vpnProtocols")
    """
    A list of VPN Protocols to use for this Server Configuration. Possible values are `IkeV2` and `OpenVPN`.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, azure_active_directory_authentications: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['VpnServerConfigurationAzureActiveDirectoryAuthenticationArgs']]]]] = None, client_revoked_certificates: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['VpnServerConfigurationClientRevokedCertificateArgs']]]]] = None, client_root_certificates: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['VpnServerConfigurationClientRootCertificateArgs']]]]] = None, ipsec_policy: Optional[pulumi.Input[pulumi.InputType['VpnServerConfigurationIpsecPolicyArgs']]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, radius_server: Optional[pulumi.Input[pulumi.InputType['VpnServerConfigurationRadiusServerArgs']]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, vpn_authentication_types: Optional[pulumi.Input[str]] = None, vpn_protocols: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, azure_active_directory_authentications: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['VpnServerConfigurationAzureActiveDirectoryAuthenticationArgs']]]]] = None, client_revoked_certificates: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['VpnServerConfigurationClientRevokedCertificateArgs']]]]] = None, client_root_certificates: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['VpnServerConfigurationClientRootCertificateArgs']]]]] = None, ipsec_policy: Optional[pulumi.Input[pulumi.InputType['VpnServerConfigurationIpsecPolicyArgs']]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, radius_server: Optional[pulumi.Input[pulumi.InputType['VpnServerConfigurationRadiusServerArgs']]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, vpn_authentication_types: Optional[pulumi.Input[str]] = None, vpn_protocols: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None) -> 'VpnServerConfiguration':
        """
