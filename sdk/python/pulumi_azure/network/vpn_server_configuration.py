...
class VpnServerConfiguration(pulumi.CustomResource):
    azure_active_directory_authentications: pulumi.Output[Optional[List['outputs.VpnServerConfigurationAzureActiveDirectoryAuthentication']]] = pulumi.property("azureActiveDirectoryAuthentications")
    """
    A `azure_active_directory_authentication` block as defined below.
    """

    client_revoked_certificates: pulumi.Output[Optional[List['outputs.VpnServerConfigurationClientRevokedCertificate']]] = pulumi.property("clientRevokedCertificates")
    """
    One or more `client_revoked_certificate` blocks as defined below.
    """

    client_root_certificates: pulumi.Output[Optional[List['outputs.VpnServerConfigurationClientRootCertificate']]] = pulumi.property("clientRootCertificates")
    """
    One or more `client_root_certificate` blocks as defined below.
    """

    ipsec_policy: pulumi.Output[Optional['outputs.VpnServerConfigurationIpsecPolicy']] = pulumi.property("ipsecPolicy")
    """
    ...
    radius_server: pulumi.Output[Optional['outputs.VpnServerConfigurationRadiusServer']] = pulumi.property("radiusServer")
    """
    ...
    vpn_authentication_types: pulumi.Output[str] = pulumi.property("vpnAuthenticationTypes")
    """
    ...
    vpn_protocols: pulumi.Output[List[str]] = pulumi.property("vpnProtocols")
    """
