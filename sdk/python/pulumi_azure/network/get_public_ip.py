...
def get_public_ip(name: Optional[str] = None,
    ...
    return AwaitableGetPublicIPResult(
        allocation_method=_utilities.get_dict_value(__ret__, 'allocationMethod'),
        domain_name_label=_utilities.get_dict_value(__ret__, 'domainNameLabel'),
        ...
        ip_version=_utilities.get_dict_value(__ret__, 'ipVersion'),
        ...
        reverse_fqdn=_utilities.get_dict_value(__ret__, 'reverseFqdn'),
