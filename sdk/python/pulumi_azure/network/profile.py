...
class Profile(pulumi.CustomResource):
    container_network_interface: pulumi.Output['outputs.ProfileContainerNetworkInterface'] = pulumi.property("containerNetworkInterface")
    """
    A `container_network_interface` block as documented below.
    """

    container_network_interface_ids: pulumi.Output[List[str]] = pulumi.property("containerNetworkInterfaceIds")
    """
