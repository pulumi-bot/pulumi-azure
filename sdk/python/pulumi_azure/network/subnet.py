...
class Subnet(pulumi.CustomResource):
    address_prefix: pulumi.Output[str] = pulumi.output_property("addressPrefix")
    """
    The address prefix to use for the subnet.
    """
    address_prefixes: pulumi.Output[List[str]] = pulumi.output_property("addressPrefixes")
    """
    The address prefixes to use for the subnet.
    """
    delegations: pulumi.Output[Optional[List['outputs.SubnetDelegation']]] = pulumi.output_property("delegations")
    """
    One or more `delegation` blocks as defined below.
    """
    enforce_private_link_endpoint_network_policies: pulumi.Output[Optional[bool]] = pulumi.output_property("enforcePrivateLinkEndpointNetworkPolicies")
    """
    ...
    """
    enforce_private_link_service_network_policies: pulumi.Output[Optional[bool]] = pulumi.output_property("enforcePrivateLinkServiceNetworkPolicies")
    """
    ...
    """
    service_endpoints: pulumi.Output[Optional[List[str]]] = pulumi.output_property("serviceEndpoints")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, address_prefix: Optional[pulumi.Input[str]] = None, address_prefixes: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, delegations: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['SubnetDelegationArgs']]]]] = None, enforce_private_link_endpoint_network_policies: Optional[pulumi.Input[bool]] = None, enforce_private_link_service_network_policies: Optional[pulumi.Input[bool]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, service_endpoints: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, virtual_network_name: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, address_prefix: Optional[pulumi.Input[str]] = None, address_prefixes: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, delegations: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['SubnetDelegationArgs']]]]] = None, enforce_private_link_endpoint_network_policies: Optional[pulumi.Input[bool]] = None, enforce_private_link_service_network_policies: Optional[pulumi.Input[bool]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, service_endpoints: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, virtual_network_name: Optional[pulumi.Input[str]] = None) -> 'Subnet':
        """
