...
class Route(pulumi.CustomResource):
    ...
    next_hop_in_ip_address: pulumi.Output[Optional[str]] = pulumi.property("nextHopInIpAddress")
    """
    Contains the IP address packets should be forwarded to. Next hop values are only allowed in routes where the next hop type is `VirtualAppliance`.
    """

    next_hop_type: pulumi.Output[str] = pulumi.property("nextHopType")
    """
    ...
    route_table_name: pulumi.Output[str] = pulumi.property("routeTableName")
    """
