...
class NetworkPacketCapture(pulumi.CustomResource):
    filters: pulumi.Output[Optional[List['outputs.NetworkPacketCaptureFilter']]] = pulumi.output_property("filters")
    """
    ...
    """
    storage_location: pulumi.Output['outputs.NetworkPacketCaptureStorageLocation'] = pulumi.output_property("storageLocation")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, filters: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['NetworkPacketCaptureFilterArgs']]]]] = None, maximum_bytes_per_packet: Optional[pulumi.Input[float]] = None, maximum_bytes_per_session: Optional[pulumi.Input[float]] = None, maximum_capture_duration: Optional[pulumi.Input[float]] = None, name: Optional[pulumi.Input[str]] = None, network_watcher_name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, storage_location: Optional[pulumi.Input[pulumi.InputType['NetworkPacketCaptureStorageLocationArgs']]] = None, target_resource_id: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['NetworkPacketCaptureFilterArgs']]]] filters: One or more `filter` blocks as defined below. Changing this forces a new resource to be created.
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, filters: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['NetworkPacketCaptureFilterArgs']]]]] = None, maximum_bytes_per_packet: Optional[pulumi.Input[float]] = None, maximum_bytes_per_session: Optional[pulumi.Input[float]] = None, maximum_capture_duration: Optional[pulumi.Input[float]] = None, name: Optional[pulumi.Input[str]] = None, network_watcher_name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, storage_location: Optional[pulumi.Input[pulumi.InputType['NetworkPacketCaptureStorageLocationArgs']]] = None, target_resource_id: Optional[pulumi.Input[str]] = None) -> 'NetworkPacketCapture':
        """
