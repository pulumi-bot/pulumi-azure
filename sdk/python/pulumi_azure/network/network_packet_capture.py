...
class NetworkPacketCapture(pulumi.CustomResource):
    filters: pulumi.Output[Optional[List['outputs.NetworkPacketCaptureFilter']]] = pulumi.property("filters")
    """
    One or more `filter` blocks as defined below. Changing this forces a new resource to be created.
    """

    maximum_bytes_per_packet: pulumi.Output[Optional[float]] = pulumi.property("maximumBytesPerPacket")
    """
    The number of bytes captured per packet. The remaining bytes are truncated. Defaults to `0` (Entire Packet Captured). Changing this forces a new resource to be created.
    """

    maximum_bytes_per_session: pulumi.Output[Optional[float]] = pulumi.property("maximumBytesPerSession")
    """
    Maximum size of the capture in Bytes. Defaults to `1073741824` (1GB). Changing this forces a new resource to be created.
    """

    maximum_capture_duration: pulumi.Output[Optional[float]] = pulumi.property("maximumCaptureDuration")
    """
    ...
    storage_location: pulumi.Output['outputs.NetworkPacketCaptureStorageLocation'] = pulumi.property("storageLocation")
    """
    A `storage_location` block as defined below. Changing this forces a new resource to be created.
    """

    target_resource_id: pulumi.Output[str] = pulumi.property("targetResourceId")
    """
