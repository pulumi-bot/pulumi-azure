...
class VpnGateway(pulumi.CustomResource):
    bgp_settings: pulumi.Output[List['outputs.VpnGatewayBgpSetting']] = pulumi.property("bgpSettings")
    """
    ...
    scale_unit: pulumi.Output[Optional[float]] = pulumi.property("scaleUnit")
    """
