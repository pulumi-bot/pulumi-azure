...
class GetServiceTagsResult:
    ...
    def __init__(__self__, address_prefixes=None, id=None, location=None, location_filter=None, service=None) -> None:
...
def get_service_tags(location: Optional[str] = None, location_filter: Optional[str] = None, service: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetServiceTagsResult:
    """
