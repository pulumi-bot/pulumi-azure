...
class NetworkConnectionMonitor(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, auto_start=None, destination=None, interval_in_seconds=None, location=None, name=None, network_watcher_name=None, resource_group_name=None, source=None, tags=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        :param pulumi.Input['NetworkConnectionMonitorDestinationArgs'] destination: A `destination` block as defined below.
        ...
        :param pulumi.Input['NetworkConnectionMonitorSourceArgs'] source: A `source` block as defined below.
