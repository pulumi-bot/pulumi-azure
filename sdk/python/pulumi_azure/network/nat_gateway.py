...
class NatGateway(pulumi.CustomResource):
    ...
    public_ip_address_ids: pulumi.Output[List[str]] = pulumi.property("publicIpAddressIds")
    """
    A list of Public IP Address ID's which should be associated with the NAT Gateway resource.
    """

    public_ip_prefix_ids: pulumi.Output[Optional[List[str]]] = pulumi.property("publicIpPrefixIds")
    """
    ...
    resource_guid: pulumi.Output[str] = pulumi.property("resourceGuid")
    """
