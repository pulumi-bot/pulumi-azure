...
class NatGateway(pulumi.CustomResource):
    ...
    """
    public_ip_address_ids: pulumi.Output[List[str]] = pulumi.output_property("publicIpAddressIds")
    """
    A list of Public IP Address ID's which should be associated with the NAT Gateway resource.
    """
    public_ip_prefix_ids: pulumi.Output[Optional[List[str]]] = pulumi.output_property("publicIpPrefixIds")
    """
    ...
    """
    resource_guid: pulumi.Output[str] = pulumi.output_property("resourceGuid")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, idle_timeout_in_minutes: Optional[pulumi.Input[float]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, public_ip_address_ids: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, public_ip_prefix_ids: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, sku_name: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, zones: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, idle_timeout_in_minutes: Optional[pulumi.Input[float]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, public_ip_address_ids: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, public_ip_prefix_ids: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, resource_guid: Optional[pulumi.Input[str]] = None, sku_name: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, zones: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None) -> 'NatGateway':
        """
