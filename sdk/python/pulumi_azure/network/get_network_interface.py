...
def get_network_interface(name: Optional[str] = None,
    ...
    return AwaitableGetNetworkInterfaceResult(
        applied_dns_servers=_utilities.get_dict_value(__ret__, 'appliedDnsServers'),
        dns_servers=_utilities.get_dict_value(__ret__, 'dnsServers'),
        enable_accelerated_networking=_utilities.get_dict_value(__ret__, 'enableAcceleratedNetworking'),
        enable_ip_forwarding=_utilities.get_dict_value(__ret__, 'enableIpForwarding'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        internal_dns_name_label=_utilities.get_dict_value(__ret__, 'internalDnsNameLabel'),
        ...
        private_ip_addresses=_utilities.get_dict_value(__ret__, 'privateIpAddresses'),
        resource_group_name=_utilities.get_dict_value(__ret__, 'resourceGroupName'),
        tags=_utilities.get_dict_value(__ret__, 'tags'),
        virtual_machine_id=_utilities.get_dict_value(__ret__, 'virtualMachineId'))
