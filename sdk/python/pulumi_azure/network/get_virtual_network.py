...
@pulumi.output_type
class _GetVirtualNetworkResult(dict):
...
def get_virtual_network(name: Optional[str] = None,
    ...
    return AwaitableGetVirtualNetworkResult(
        address_spaces=_utilities.get_dict_value(__ret__, 'addressSpaces'),
        dns_servers=_utilities.get_dict_value(__ret__, 'dnsServers'),
        guid=_utilities.get_dict_value(__ret__, 'guid'),
        ...
        vnet_peerings=_utilities.get_dict_value(__ret__, 'vnetPeerings'))
