...
@pulumi.output_type
class _GetApplicationSecurityGroupResult(dict):
...
def get_application_security_group(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure:network/getApplicationSecurityGroup:getApplicationSecurityGroup', __args__, opts=opts, typ=_GetApplicationSecurityGroupResult).value
