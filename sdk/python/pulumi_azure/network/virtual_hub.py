...
class VirtualHub(pulumi.CustomResource):
    ...
    """
    routes: pulumi.Output[Optional[List['outputs.VirtualHubRoute']]] = pulumi.output_property("routes")
    """
    ...
    """
    virtual_wan_id: pulumi.Output[str] = pulumi.output_property("virtualWanId")
    """
    The ID of a Virtual WAN within which the Virtual Hub should be created. Changing this forces a new resource to be created.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, address_prefix: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, routes: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['VirtualHubRouteArgs']]]]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, virtual_wan_id: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        :param pulumi.Input[Dict[str, pulumi.Input[str]]] tags: A mapping of tags to assign to the Virtual Hub.
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, address_prefix: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, routes: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['VirtualHubRouteArgs']]]]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, virtual_wan_id: Optional[pulumi.Input[str]] = None) -> 'VirtualHub':
        """
