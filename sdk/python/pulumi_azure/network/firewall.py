...
class Firewall(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, ip_configurations=None, location=None, name=None, resource_group_name=None, tags=None, threat_intel_mode=None, zones=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        :param pulumi.Input[List[pulumi.Input['FirewallIpConfigurationArgs']]] ip_configurations: A `ip_configuration` block as documented below.
