...
class Firewall(pulumi.CustomResource):
    ip_configurations: pulumi.Output[List['outputs.FirewallIpConfiguration']] = pulumi.property("ipConfigurations")
    """
    ...
    threat_intel_mode: pulumi.Output[Optional[str]] = pulumi.property("threatIntelMode")
    """
