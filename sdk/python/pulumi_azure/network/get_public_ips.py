...
@pulumi.output_type
class _GetPublicIPsResult(dict):
    allocation_type: Optional[str] = pulumi.property("allocationType")
    attached: Optional[bool] = pulumi.property("attached")
    id: str = pulumi.property("id")
    name_prefix: Optional[str] = pulumi.property("namePrefix")
    public_ips: List['outputs.GetPublicIPsPublicIpResult'] = pulumi.property("publicIps")
...
def get_public_ips(allocation_type: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure:network/getPublicIPs:getPublicIPs', __args__, opts=opts, typ=_GetPublicIPsResult).value

    return AwaitableGetPublicIPsResult(
        allocation_type=_utilities.get_dict_value(__ret__, 'allocationType'),
        attached=_utilities.get_dict_value(__ret__, 'attached'),
