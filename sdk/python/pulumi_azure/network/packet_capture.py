...
class PacketCapture(pulumi.CustomResource):
    filters: pulumi.Output[Optional[List['outputs.PacketCaptureFilter']]] = pulumi.output_property("filters")
    """
    One or more `filter` blocks as defined below. Changing this forces a new resource to be created.
    """
    maximum_bytes_per_packet: pulumi.Output[Optional[float]] = pulumi.output_property("maximumBytesPerPacket")
    """
    The number of bytes captured per packet. The remaining bytes are truncated. Defaults to `0` (Entire Packet Captured). Changing this forces a new resource to be created.
    """
    maximum_bytes_per_session: pulumi.Output[Optional[float]] = pulumi.output_property("maximumBytesPerSession")
    """
    Maximum size of the capture in Bytes. Defaults to `1073741824` (1GB). Changing this forces a new resource to be created.
    """
    maximum_capture_duration: pulumi.Output[Optional[float]] = pulumi.output_property("maximumCaptureDuration")
    """
    ...
    """
    network_watcher_name: pulumi.Output[str] = pulumi.output_property("networkWatcherName")
    """
    ...
    """
    storage_location: pulumi.Output['outputs.PacketCaptureStorageLocation'] = pulumi.output_property("storageLocation")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, filters: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['PacketCaptureFilterArgs']]]]] = None, maximum_bytes_per_packet: Optional[pulumi.Input[float]] = None, maximum_bytes_per_session: Optional[pulumi.Input[float]] = None, maximum_capture_duration: Optional[pulumi.Input[float]] = None, name: Optional[pulumi.Input[str]] = None, network_watcher_name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, storage_location: Optional[pulumi.Input[pulumi.InputType['PacketCaptureStorageLocationArgs']]] = None, target_resource_id: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, filters: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['PacketCaptureFilterArgs']]]]] = None, maximum_bytes_per_packet: Optional[pulumi.Input[float]] = None, maximum_bytes_per_session: Optional[pulumi.Input[float]] = None, maximum_capture_duration: Optional[pulumi.Input[float]] = None, name: Optional[pulumi.Input[str]] = None, network_watcher_name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, storage_location: Optional[pulumi.Input[pulumi.InputType['PacketCaptureStorageLocationArgs']]] = None, target_resource_id: Optional[pulumi.Input[str]] = None) -> 'PacketCapture':
        """
