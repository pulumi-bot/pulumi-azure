...
class PacketCapture(pulumi.CustomResource):
    filters: pulumi.Output[Optional[List['outputs.PacketCaptureFilter']]] = pulumi.property("filters")
    """
    ...
    storage_location: pulumi.Output['outputs.PacketCaptureStorageLocation'] = pulumi.property("storageLocation")
    """
