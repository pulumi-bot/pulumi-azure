...
class VirtualWan(pulumi.CustomResource):
    allow_branch_to_branch_traffic: pulumi.Output[Optional[bool]] = pulumi.property("allowBranchToBranchTraffic")
    """
    Boolean flag to specify whether branch to branch traffic is allowed. Defaults to `true`.
    """

    allow_vnet_to_vnet_traffic: pulumi.Output[Optional[bool]] = pulumi.property("allowVnetToVnetTraffic")
    """
    Boolean flag to specify whether VNet to VNet traffic is allowed. Defaults to `false`.
    """

    disable_vpn_encryption: pulumi.Output[Optional[bool]] = pulumi.property("disableVpnEncryption")
    """
    ...
    office365_local_breakout_category: pulumi.Output[Optional[str]] = pulumi.property("office365LocalBreakoutCategory")
    """
