...
class NetworkInterfaceNatRuleAssociation(pulumi.CustomResource):
    ...
    """
    nat_rule_id: pulumi.Output[str] = pulumi.output_property("natRuleId")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, ip_configuration_name: Optional[pulumi.Input[str]] = None, nat_rule_id: Optional[pulumi.Input[str]] = None, network_interface_id: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, ip_configuration_name: Optional[pulumi.Input[str]] = None, nat_rule_id: Optional[pulumi.Input[str]] = None, network_interface_id: Optional[pulumi.Input[str]] = None) -> 'NetworkInterfaceNatRuleAssociation':
        """
