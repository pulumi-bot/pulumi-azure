...
class NetworkWatcherFlowLog(pulumi.CustomResource):
    ...
    """
    network_security_group_id: pulumi.Output[str] = pulumi.output_property("networkSecurityGroupId")
    """
    ...
    """
    retention_policy: pulumi.Output['outputs.NetworkWatcherFlowLogRetentionPolicy'] = pulumi.output_property("retentionPolicy")
    """
    ...
    """
    traffic_analytics: pulumi.Output[Optional['outputs.NetworkWatcherFlowLogTrafficAnalytics']] = pulumi.output_property("trafficAnalytics")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, enabled: Optional[pulumi.Input[bool]] = None, network_security_group_id: Optional[pulumi.Input[str]] = None, network_watcher_name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, retention_policy: Optional[pulumi.Input[pulumi.InputType['NetworkWatcherFlowLogRetentionPolicyArgs']]] = None, storage_account_id: Optional[pulumi.Input[str]] = None, traffic_analytics: Optional[pulumi.Input[pulumi.InputType['NetworkWatcherFlowLogTrafficAnalyticsArgs']]] = None, version: Optional[pulumi.Input[float]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
