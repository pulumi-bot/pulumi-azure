...
class NetworkWatcherFlowLog(pulumi.CustomResource):
    ...
    network_security_group_id: pulumi.Output[str] = pulumi.property("networkSecurityGroupId")
    """
    ...
    retention_policy: pulumi.Output['outputs.NetworkWatcherFlowLogRetentionPolicy'] = pulumi.property("retentionPolicy")
    """
    ...
    traffic_analytics: pulumi.Output[Optional['outputs.NetworkWatcherFlowLogTrafficAnalytics']] = pulumi.property("trafficAnalytics")
    """
