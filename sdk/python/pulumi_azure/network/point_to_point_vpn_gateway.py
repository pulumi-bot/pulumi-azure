...
class PointToPointVpnGateway(pulumi.CustomResource):
    connection_configuration: pulumi.Output['outputs.PointToPointVpnGatewayConnectionConfiguration'] = pulumi.property("connectionConfiguration")
    """
    ...
    scale_unit: pulumi.Output[float] = pulumi.property("scaleUnit")
    """
    ...
    vpn_server_configuration_id: pulumi.Output[str] = pulumi.property("vpnServerConfigurationId")
    """
