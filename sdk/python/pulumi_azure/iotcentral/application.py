...
class Application(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, display_name=None, location=None, name=None, resource_group_name=None, sku=None, sub_domain=None, tags=None, template=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
