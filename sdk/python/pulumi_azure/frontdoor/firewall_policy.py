...
class FirewallPolicy(pulumi.CustomResource):
    custom_block_response_body: pulumi.Output[Optional[str]] = pulumi.output_property("customBlockResponseBody")
    """
    If a `custom_rule` block's action type is `block`, this is the response body. The body must be specified in base64 encoding.
    """
    custom_block_response_status_code: pulumi.Output[Optional[float]] = pulumi.output_property("customBlockResponseStatusCode")
    """
    If a `custom_rule` block's action type is `block`, this is the response status code. Possible values are `200`, `403`, `405`, `406`, or `429`.
    """
    custom_rules: pulumi.Output[Optional[List['outputs.FirewallPolicyCustomRule']]] = pulumi.output_property("customRules")
    """
    ...
    """
    frontend_endpoint_ids: pulumi.Output[List[str]] = pulumi.output_property("frontendEndpointIds")
    """
    ...
    Resource location.
    """
    managed_rules: pulumi.Output[Optional[List['outputs.FirewallPolicyManagedRule']]] = pulumi.output_property("managedRules")
    """
    ...
    """
    redirect_url: pulumi.Output[Optional[str]] = pulumi.output_property("redirectUrl")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, custom_block_response_body: Optional[pulumi.Input[str]] = None, custom_block_response_status_code: Optional[pulumi.Input[float]] = None, custom_rules: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['FirewallPolicyCustomRuleArgs']]]]] = None, enabled: Optional[pulumi.Input[bool]] = None, managed_rules: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['FirewallPolicyManagedRuleArgs']]]]] = None, mode: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, redirect_url: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        :param pulumi.Input[Dict[str, pulumi.Input[str]]] tags: A mapping of tags to assign to the Web Application Firewall Policy.
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, custom_block_response_body: Optional[pulumi.Input[str]] = None, custom_block_response_status_code: Optional[pulumi.Input[float]] = None, custom_rules: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['FirewallPolicyCustomRuleArgs']]]]] = None, enabled: Optional[pulumi.Input[bool]] = None, frontend_endpoint_ids: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, location: Optional[pulumi.Input[str]] = None, managed_rules: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['FirewallPolicyManagedRuleArgs']]]]] = None, mode: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, redirect_url: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None) -> 'FirewallPolicy':
        """
