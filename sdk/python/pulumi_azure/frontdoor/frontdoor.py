...
class Frontdoor(pulumi.CustomResource):
    backend_pool_health_probes: pulumi.Output[List['outputs.FrontdoorBackendPoolHealthProbe']] = pulumi.property("backendPoolHealthProbes")
    """
    A `backend_pool_health_probe` block as defined below.
    """

    backend_pool_load_balancings: pulumi.Output[List['outputs.FrontdoorBackendPoolLoadBalancing']] = pulumi.property("backendPoolLoadBalancings")
    """
    A `backend_pool_load_balancing` block as defined below.
    """

    backend_pools: pulumi.Output[List['outputs.FrontdoorBackendPool']] = pulumi.property("backendPools")
    """
    A `backend_pool` block as defined below.
    """

    backend_pools_send_receive_timeout_seconds: pulumi.Output[Optional[float]] = pulumi.property("backendPoolsSendReceiveTimeoutSeconds")
    """
    ...
    enforce_backend_pools_certificate_name_check: pulumi.Output[bool] = pulumi.property("enforceBackendPoolsCertificateNameCheck")
    """
    ...
    frontend_endpoints: pulumi.Output[List['outputs.FrontdoorFrontendEndpoint']] = pulumi.property("frontendEndpoints")
    """
    A `frontend_endpoint` block as defined below.
    """

    header_frontdoor_id: pulumi.Output[str] = pulumi.property("headerFrontdoorId")
    """
    The unique ID of the Front Door which is embedded into the incoming headers `X-Azure-FDID` attribute and maybe used to filter traffic sent by the Front Door to your backend.
    """

    load_balancer_enabled: pulumi.Output[Optional[bool]] = pulumi.property("loadBalancerEnabled")
    """
    ...
    routing_rules: pulumi.Output[List['outputs.FrontdoorRoutingRule']] = pulumi.property("routingRules")
    """
