...
class CustomHttpsConfiguration(pulumi.CustomResource):
    custom_https_configuration: pulumi.Output[Optional['outputs.CustomHttpsConfigurationCustomHttpsConfiguration']] = pulumi.property("customHttpsConfiguration")

    custom_https_provisioning_enabled: pulumi.Output[bool] = pulumi.property("customHttpsProvisioningEnabled")
    """
    Should the HTTPS protocol be enabled for this custom domain associated with the Front Door?
    """

    frontend_endpoint_id: pulumi.Output[str] = pulumi.property("frontendEndpointId")
    """
