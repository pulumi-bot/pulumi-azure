...
class FrontdoorFrontendEndpointArgs:
    ...
    """
    custom_https_provisioning_enabled: Optional[pulumi.Input[bool]] = pulumi.input_property("customHttpsProvisioningEnabled")
    """
