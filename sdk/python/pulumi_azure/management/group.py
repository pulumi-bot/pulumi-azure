    ...
    def __init__(__self__, resource_name, opts=None, display_name=None, group_id=None, name=None, parent_management_group_id=None, subscription_ids=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            if group_id is not None:
                warnings.warn("Deprecated in favour of `[name](#/resources/azure:management%2Fgroup:Group/inputProperties/name)`", DeprecationWarning)
                pulumi.log.warn("group_id is deprecated: Deprecated in favour of `[name](#/resources/azure:management%2Fgroup:Group/inputProperties/name)`")
