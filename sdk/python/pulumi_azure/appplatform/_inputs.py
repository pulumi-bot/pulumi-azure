...
class SpringCloudServiceConfigServerGitSettingArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "httpBasicAuth", http_basic_auth)
        pulumi.set(__self__, "label", label)
        pulumi.set(__self__, "repositories", repositories)
        pulumi.set(__self__, "searchPaths", search_paths)
        pulumi.set(__self__, "sshAuth", ssh_auth)
...
class SpringCloudServiceConfigServerGitSettingRepositorySshAuthArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "hostKey", host_key)
        pulumi.set(__self__, "hostKeyAlgorithm", host_key_algorithm)
        pulumi.set(__self__, "strictHostKeyCheckingEnabled", strict_host_key_checking_enabled)
