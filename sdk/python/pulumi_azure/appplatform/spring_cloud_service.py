...
class SpringCloudService(pulumi.CustomResource):
    config_server_git_setting: pulumi.Output[Optional['outputs.SpringCloudServiceConfigServerGitSetting']] = pulumi.property("configServerGitSetting")
    """
    ...
    trace: pulumi.Output[Optional['outputs.SpringCloudServiceTrace']] = pulumi.property("trace")
    """
