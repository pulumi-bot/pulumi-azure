...
class GetSpringCloudServiceResult:
    ...
    def __init__(__self__, config_server_git_settings=None, id=None, location=None, name=None, resource_group_name=None, tags=None) -> None:
...
def get_spring_cloud_service(name: Optional[str] = None, resource_group_name: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSpringCloudServiceResult:
    """
