...
class DatasetHttp(pulumi.CustomResource):
    ...
    relative_url: pulumi.Output[Optional[str]] = pulumi.property("relativeUrl")
    """
    The relative URL based on the URL in the HTTP Linked Service.
    """

    request_body: pulumi.Output[Optional[str]] = pulumi.property("requestBody")
    """
    The body for the HTTP request.
    """

    request_method: pulumi.Output[Optional[str]] = pulumi.property("requestMethod")
    """
    ...
    schema_columns: pulumi.Output[Optional[List['outputs.DatasetHttpSchemaColumn']]] = pulumi.property("schemaColumns")
    """
