...
class DatasetJson(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, additional_properties=None, annotations=None, azure_blob_storage_location=None, data_factory_name=None, description=None, encoding=None, folder=None, http_server_location=None, linked_service_name=None, name=None, parameters=None, resource_group_name=None, schema_columns=None, __props__=None, __name__=None, __opts__=None) -> None:
        ...
        :param pulumi.Input[List[pulumi.Input['DatasetJsonSchemaColumnArgs']]] schema_columns: A `schema_column` block as defined below.
        """
