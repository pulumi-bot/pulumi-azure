...
class DatasetAzureBlob(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, additional_properties=None, annotations=None, data_factory_name=None, description=None, filename=None, folder=None, linked_service_name=None, name=None, parameters=None, path=None, resource_group_name=None, schema_columns=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
        ...
        :param pulumi.Input[List[pulumi.Input['DatasetAzureBlobSchemaColumnArgs']]] schema_columns: A `schema_column` block as defined below.
        """
