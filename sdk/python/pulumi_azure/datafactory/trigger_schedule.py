...
class TriggerSchedule(pulumi.CustomResource):
    ...
    interval: pulumi.Output[Optional[float]] = pulumi.property("interval")
    """
    ...
    pipeline_name: pulumi.Output[str] = pulumi.property("pipelineName")
    """
    The Data Factory Pipeline name that the trigger will act on.
    """

    pipeline_parameters: pulumi.Output[Optional[Mapping[str, str]]] = pulumi.property("pipelineParameters")
    """
