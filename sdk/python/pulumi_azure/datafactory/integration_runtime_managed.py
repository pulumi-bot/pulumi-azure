...
class IntegrationRuntimeManaged(pulumi.CustomResource):
    catalog_info: pulumi.Output[Optional['outputs.IntegrationRuntimeManagedCatalogInfo']] = pulumi.property("catalogInfo")
    """
    A `catalog_info` block as defined below.
    """

    custom_setup_script: pulumi.Output[Optional['outputs.IntegrationRuntimeManagedCustomSetupScript']] = pulumi.property("customSetupScript")
    """
    ...
    edition: pulumi.Output[Optional[str]] = pulumi.property("edition")
    """
    ...
    max_parallel_executions_per_node: pulumi.Output[Optional[float]] = pulumi.property("maxParallelExecutionsPerNode")
    """
    ...
    node_size: pulumi.Output[str] = pulumi.property("nodeSize")
    """
    ...
    vnet_integration: pulumi.Output[Optional['outputs.IntegrationRuntimeManagedVnetIntegration']] = pulumi.property("vnetIntegration")
    """
