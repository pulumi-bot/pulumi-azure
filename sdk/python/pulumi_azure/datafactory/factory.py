...
class Factory(pulumi.CustomResource):
    github_configuration: pulumi.Output[Optional['outputs.FactoryGithubConfiguration']] = pulumi.property("githubConfiguration")
    """
    A `github_configuration` block as defined below.
    """

    identity: pulumi.Output['outputs.FactoryIdentity'] = pulumi.property("identity")
    """
    ...
    vsts_configuration: pulumi.Output[Optional['outputs.FactoryVstsConfiguration']] = pulumi.property("vstsConfiguration")
    """
