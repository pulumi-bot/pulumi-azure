...
class LinkedServiceAzureFunction(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, additional_properties=None, annotations=None, data_factory_name=None, description=None, integration_runtime_name=None, key=None, name=None, parameters=None, resource_group_name=None, url=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
