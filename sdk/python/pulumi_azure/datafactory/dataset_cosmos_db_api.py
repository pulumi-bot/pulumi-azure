...
class DatasetCosmosDBApi(pulumi.CustomResource):
    ...
    collection_name: pulumi.Output[Optional[str]] = pulumi.property("collectionName")
    """
    ...
    schema_columns: pulumi.Output[Optional[List['outputs.DatasetCosmosDBApiSchemaColumn']]] = pulumi.property("schemaColumns")
    """
