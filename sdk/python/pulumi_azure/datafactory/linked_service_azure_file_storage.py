...
class LinkedServiceAzureFileStorage(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, additional_properties=None, annotations=None, connection_string=None, data_factory_name=None, description=None, host=None, integration_runtime_name=None, name=None, parameters=None, password=None, resource_group_name=None, user_id=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
