...
class IntegrationRuntimeSelfHosted(pulumi.CustomResource):
    auth_key1: pulumi.Output[str] = pulumi.output_property("authKey1")
    """
    The primary integration runtime authentication key.
    """
    auth_key2: pulumi.Output[str] = pulumi.output_property("authKey2")
    """
    ...
    """
    rbac_authorizations: pulumi.Output[Optional[List['outputs.IntegrationRuntimeSelfHostedRbacAuthorization']]] = pulumi.output_property("rbacAuthorizations")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, data_factory_name: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, rbac_authorizations: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['IntegrationRuntimeSelfHostedRbacAuthorizationArgs']]]]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, auth_key1: Optional[pulumi.Input[str]] = None, auth_key2: Optional[pulumi.Input[str]] = None, data_factory_name: Optional[pulumi.Input[str]] = None, description: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, rbac_authorizations: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['IntegrationRuntimeSelfHostedRbacAuthorizationArgs']]]]] = None, resource_group_name: Optional[pulumi.Input[str]] = None) -> 'IntegrationRuntimeSelfHosted':
        """
