...
class LinkedServiceCosmosDb(pulumi.CustomResource):
    account_endpoint: pulumi.Output[Optional[str]] = pulumi.property("accountEndpoint")
    """
    The endpoint of he Azure CosmosDB account. Required if `connection_string` is unspecified.
    """

    account_key: pulumi.Output[Optional[str]] = pulumi.property("accountKey")
    """
    ...
    connection_string: pulumi.Output[Optional[str]] = pulumi.property("connectionString")
    """
    ...
    integration_runtime_name: pulumi.Output[Optional[str]] = pulumi.property("integrationRuntimeName")
    """
