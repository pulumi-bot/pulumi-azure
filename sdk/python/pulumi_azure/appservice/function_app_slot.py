...
class FunctionAppSlot(pulumi.CustomResource):
    ...
    auth_settings: pulumi.Output['outputs.FunctionAppSlotAuthSettings'] = pulumi.property("authSettings")
    """
    ...
    connection_strings: pulumi.Output[List['outputs.FunctionAppSlotConnectionString']] = pulumi.property("connectionStrings")
    """
    ...
    function_app_name: pulumi.Output[str] = pulumi.property("functionAppName")
    """
    ...
    identity: pulumi.Output['outputs.FunctionAppSlotIdentity'] = pulumi.property("identity")
    """
    ...
    site_config: pulumi.Output['outputs.FunctionAppSlotSiteConfig'] = pulumi.property("siteConfig")
    """
    A `site_config` object as defined below.
    """

    site_credentials: pulumi.Output[List['outputs.FunctionAppSlotSiteCredential']] = pulumi.property("siteCredentials")
    """
