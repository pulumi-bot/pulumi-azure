...
class Plan(pulumi.CustomResource):
    app_service_environment_id: pulumi.Output[Optional[str]] = pulumi.output_property("appServiceEnvironmentId")
    """
    The ID of the App Service Environment where the App Service Plan should be located. Changing forces a new resource to be created.
    """
    is_xenon: pulumi.Output[Optional[bool]] = pulumi.output_property("isXenon")
    ...
    """
    maximum_elastic_worker_count: pulumi.Output[float] = pulumi.output_property("maximumElasticWorkerCount")
    """
    The maximum number of total workers allowed for this ElasticScaleEnabled App Service Plan.
    """
    maximum_number_of_workers: pulumi.Output[float] = pulumi.output_property("maximumNumberOfWorkers")
    """
    ...
    """
    per_site_scaling: pulumi.Output[Optional[bool]] = pulumi.output_property("perSiteScaling")
    """
    Can Apps assigned to this App Service Plan be scaled independently? If set to `false` apps assigned to this plan will scale to all instances of the plan.  Defaults to `false`.
    """
    reserved: pulumi.Output[Optional[bool]] = pulumi.output_property("reserved")
    """
    ...
    """
    sku: pulumi.Output['outputs.PlanSku'] = pulumi.output_property("sku")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, app_service_environment_id: Optional[pulumi.Input[str]] = None, is_xenon: Optional[pulumi.Input[bool]] = None, kind: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, maximum_elastic_worker_count: Optional[pulumi.Input[float]] = None, name: Optional[pulumi.Input[str]] = None, per_site_scaling: Optional[pulumi.Input[bool]] = None, reserved: Optional[pulumi.Input[bool]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, sku: Optional[pulumi.Input[pulumi.InputType['PlanSkuArgs']]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, app_service_environment_id: Optional[pulumi.Input[str]] = None, is_xenon: Optional[pulumi.Input[bool]] = None, kind: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, maximum_elastic_worker_count: Optional[pulumi.Input[float]] = None, maximum_number_of_workers: Optional[pulumi.Input[float]] = None, name: Optional[pulumi.Input[str]] = None, per_site_scaling: Optional[pulumi.Input[bool]] = None, reserved: Optional[pulumi.Input[bool]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, sku: Optional[pulumi.Input[pulumi.InputType['PlanSkuArgs']]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None) -> 'Plan':
        """
