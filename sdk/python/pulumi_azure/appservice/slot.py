...
class Slot(pulumi.CustomResource):
    ...
    auth_settings: pulumi.Output['outputs.SlotAuthSettings'] = pulumi.property("authSettings")
    """
    ...
    connection_strings: pulumi.Output[List['outputs.SlotConnectionString']] = pulumi.property("connectionStrings")
    """
    ...
    identity: pulumi.Output['outputs.SlotIdentity'] = pulumi.property("identity")
    """
    ...
    logs: pulumi.Output['outputs.SlotLogs'] = pulumi.property("logs")
    ...
    site_config: pulumi.Output['outputs.SlotSiteConfig'] = pulumi.property("siteConfig")
    """
    A `site_config` object as defined below.
    """

    site_credentials: pulumi.Output[List['outputs.SlotSiteCredential']] = pulumi.property("siteCredentials")
    """
