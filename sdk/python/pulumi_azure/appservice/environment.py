...
class Environment(pulumi.CustomResource):
    allowed_user_ip_cidrs: pulumi.Output[List[str]] = pulumi.output_property("allowedUserIpCidrs")
    """
    Allowed user added IP ranges on the ASE database. Use the addresses you want to set as the explicit egress address ranges.
    """
    front_end_scale_factor: pulumi.Output[Optional[float]] = pulumi.output_property("frontEndScaleFactor")
    """
    Scale factor for front end instances. Possible values are between `5` and `15`. Defaults to `15`.
    """
    internal_load_balancing_mode: pulumi.Output[Optional[str]] = pulumi.output_property("internalLoadBalancingMode")
    """
    ...
    """
    pricing_tier: pulumi.Output[Optional[str]] = pulumi.output_property("pricingTier")
    """
    ...
    """
    user_whitelisted_ip_ranges: pulumi.Output[List[str]] = pulumi.output_property("userWhitelistedIpRanges")
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, allowed_user_ip_cidrs: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, front_end_scale_factor: Optional[pulumi.Input[float]] = None, internal_load_balancing_mode: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, pricing_tier: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, subnet_id: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, user_whitelisted_ip_ranges: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, allowed_user_ip_cidrs: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, front_end_scale_factor: Optional[pulumi.Input[float]] = None, internal_load_balancing_mode: Optional[pulumi.Input[str]] = None, location: Optional[pulumi.Input[str]] = None, name: Optional[pulumi.Input[str]] = None, pricing_tier: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, subnet_id: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, user_whitelisted_ip_ranges: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None) -> 'Environment':
        """
