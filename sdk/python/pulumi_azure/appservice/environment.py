...
class Environment(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, allowed_user_ip_cidrs=None, front_end_scale_factor=None, internal_load_balancing_mode=None, name=None, pricing_tier=None, resource_group_name=None, subnet_id=None, tags=None, user_whitelisted_ip_ranges=None, __props__=None, __name__=None, __opts__=None):
        ...
        if opts.id is None:
            ...
            __props__['allowedUserIpCidrs'] = allowed_user_ip_cidrs
            __props__['frontEndScaleFactor'] = front_end_scale_factor
            __props__['internalLoadBalancingMode'] = internal_load_balancing_mode
            __props__['name'] = name
            __props__['pricingTier'] = pricing_tier
            ...
            __props__['userWhitelistedIpRanges'] = user_whitelisted_ip_ranges
