...
class Environment(pulumi.CustomResource):
    allowed_user_ip_cidrs: pulumi.Output[List[str]] = pulumi.property("allowedUserIpCidrs")
    """
    Allowed user added IP ranges on the ASE database. Use the addresses you want to set as the explicit egress address ranges.
    """

    front_end_scale_factor: pulumi.Output[Optional[float]] = pulumi.property("frontEndScaleFactor")
    """
    Scale factor for front end instances. Possible values are between `5` and `15`. Defaults to `15`.
    """

    internal_load_balancing_mode: pulumi.Output[Optional[str]] = pulumi.property("internalLoadBalancingMode")
    """
    ...
    pricing_tier: pulumi.Output[Optional[str]] = pulumi.property("pricingTier")
    """
    ...
    user_whitelisted_ip_ranges: pulumi.Output[List[str]] = pulumi.property("userWhitelistedIpRanges")
