...
@pulumi.output_type
class _GetAppServiceEnvironmentResult(dict):
...
def get_app_service_environment(name: Optional[str] = None,
    ...
    return AwaitableGetAppServiceEnvironmentResult(
        front_end_scale_factor=_utilities.get_dict_value(__ret__, 'frontEndScaleFactor'),
        id=_utilities.get_dict_value(__ret__, 'id'),
        location=_utilities.get_dict_value(__ret__, 'location'),
        name=_utilities.get_dict_value(__ret__, 'name'),
        pricing_tier=_utilities.get_dict_value(__ret__, 'pricingTier'),
