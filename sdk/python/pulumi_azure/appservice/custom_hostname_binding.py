...
class CustomHostnameBinding(pulumi.CustomResource):
    ...
    ssl_state: pulumi.Output[Optional[str]] = pulumi.property("sslState")
    """
    The SSL type. Possible values are `IpBasedEnabled` and `SniEnabled`. Changing this forces a new resource to be created.
    """

    thumbprint: pulumi.Output[Optional[str]] = pulumi.property("thumbprint")
    """
    The SSL certificate thumbprint. Changing this forces a new resource to be created.
    """

    virtual_ip: pulumi.Output[str] = pulumi.property("virtualIp")
    """
