...
class CustomHostnameBinding(pulumi.CustomResource):
    ...
    """
    ssl_state: pulumi.Output[Optional[str]] = pulumi.output_property("sslState")
    """
    The SSL type. Possible values are `IpBasedEnabled` and `SniEnabled`. Changing this forces a new resource to be created.
    """
    thumbprint: pulumi.Output[Optional[str]] = pulumi.output_property("thumbprint")
    """
    The SSL certificate thumbprint. Changing this forces a new resource to be created.
    """
    virtual_ip: pulumi.Output[str] = pulumi.output_property("virtualIp")
    """
    The virtual IP address assigned to the hostname if IP based SSL is enabled.
    """
    # pylint: disable=no-self-argument
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, app_service_name: Optional[pulumi.Input[str]] = None, hostname: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, ssl_state: Optional[pulumi.Input[str]] = None, thumbprint: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, app_service_name: Optional[pulumi.Input[str]] = None, hostname: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, ssl_state: Optional[pulumi.Input[str]] = None, thumbprint: Optional[pulumi.Input[str]] = None, virtual_ip: Optional[pulumi.Input[str]] = None) -> 'CustomHostnameBinding':
        """
