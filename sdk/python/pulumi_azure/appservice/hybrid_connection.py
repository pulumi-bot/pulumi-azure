...
class HybridConnection(pulumi.CustomResource):
    ...
    relay_id: pulumi.Output[str] = pulumi.property("relayId")
    """
    The Resource ID of Service Bus relay. Changing this forces a new resource to be created.
    """

    relay_name: pulumi.Output[str] = pulumi.property("relayName")
    ...
    send_key_name: pulumi.Output[Optional[str]] = pulumi.property("sendKeyName")
    """
    The name of the Service Bus key which has Send permissions. Defaults to `RootManageSharedAccessKey`.
    """

    send_key_value: pulumi.Output[str] = pulumi.property("sendKeyValue")
    """
    The value of the Service Bus Primary Access key.
    """

    service_bus_namespace: pulumi.Output[str] = pulumi.property("serviceBusNamespace")
    """
    The name of the Service Bus namespace.
    """

    service_bus_suffix: pulumi.Output[str] = pulumi.property("serviceBusSuffix")
    """
