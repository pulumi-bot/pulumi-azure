...
class AaaaRecordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] records: List of IPv6 Addresses. Conflicts with `target_resource_id`.
...
class AaaaRecord(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["ttl"] = ttl
        __props__.__dict__["zone_name"] = zone_name
        return AaaaRecord(resource_name_, opts=opts, __props__=__props__)
