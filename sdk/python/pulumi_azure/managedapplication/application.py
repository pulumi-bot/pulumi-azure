...
class Application(pulumi.CustomResource):
    application_definition_id: pulumi.Output[Optional[str]] = pulumi.property("applicationDefinitionId")
    """
    ...
    plan: pulumi.Output[Optional['outputs.ApplicationPlan']] = pulumi.property("plan")
    """
