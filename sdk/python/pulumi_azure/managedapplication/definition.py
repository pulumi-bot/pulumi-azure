...
class Definition(pulumi.CustomResource):
    authorizations: pulumi.Output[Optional[List['outputs.DefinitionAuthorization']]] = pulumi.property("authorizations")
    """
    One or more `authorization` block defined below.
    """

    create_ui_definition: pulumi.Output[Optional[str]] = pulumi.property("createUiDefinition")
    """
    ...
    lock_level: pulumi.Output[str] = pulumi.property("lockLevel")
    """
    ...
    main_template: pulumi.Output[Optional[str]] = pulumi.property("mainTemplate")
    """
    ...
    package_enabled: pulumi.Output[Optional[bool]] = pulumi.property("packageEnabled")
    """
    Is the package enabled? Defaults to `true`.
    """

    package_file_uri: pulumi.Output[Optional[str]] = pulumi.property("packageFileUri")
    """
