...
class ContainerStorageAccount(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, recovery_vault_name=None, resource_group_name=None, storage_account_id=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
