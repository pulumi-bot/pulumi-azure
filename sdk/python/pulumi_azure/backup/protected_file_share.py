...
class ProtectedFileShare(pulumi.CustomResource):
    backup_policy_id: pulumi.Output[str] = pulumi.property("backupPolicyId")
    """
    ...
    source_file_share_name: pulumi.Output[str] = pulumi.property("sourceFileShareName")
    """
    Specifies the name of the file share to backup. Changing this forces a new resource to be created.
    """

    source_storage_account_id: pulumi.Output[str] = pulumi.property("sourceStorageAccountId")
    """
