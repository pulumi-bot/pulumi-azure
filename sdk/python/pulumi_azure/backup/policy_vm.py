...
class PolicyVM(pulumi.CustomResource):
    backup: pulumi.Output['outputs.PolicyVMBackup'] = pulumi.output_property("backup")
    """
    ...
    """
    retention_daily: pulumi.Output[Optional['outputs.PolicyVMRetentionDaily']] = pulumi.output_property("retentionDaily")
    """
    Configures the policy daily retention as documented in the `retention_daily` block below. Required when backup frequency is `Daily`.
    """
    retention_monthly: pulumi.Output[Optional['outputs.PolicyVMRetentionMonthly']] = pulumi.output_property("retentionMonthly")
    """
    Configures the policy monthly retention as documented in the `retention_monthly` block below.
    """
    retention_weekly: pulumi.Output[Optional['outputs.PolicyVMRetentionWeekly']] = pulumi.output_property("retentionWeekly")
    """
    Configures the policy weekly retention as documented in the `retention_weekly` block below. Required when backup frequency is `Weekly`.
    """
    retention_yearly: pulumi.Output[Optional['outputs.PolicyVMRetentionYearly']] = pulumi.output_property("retentionYearly")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, backup: Optional[pulumi.Input[pulumi.InputType['PolicyVMBackupArgs']]] = None, name: Optional[pulumi.Input[str]] = None, recovery_vault_name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, retention_daily: Optional[pulumi.Input[pulumi.InputType['PolicyVMRetentionDailyArgs']]] = None, retention_monthly: Optional[pulumi.Input[pulumi.InputType['PolicyVMRetentionMonthlyArgs']]] = None, retention_weekly: Optional[pulumi.Input[pulumi.InputType['PolicyVMRetentionWeeklyArgs']]] = None, retention_yearly: Optional[pulumi.Input[pulumi.InputType['PolicyVMRetentionYearlyArgs']]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, timezone: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, backup: Optional[pulumi.Input[pulumi.InputType['PolicyVMBackupArgs']]] = None, name: Optional[pulumi.Input[str]] = None, recovery_vault_name: Optional[pulumi.Input[str]] = None, resource_group_name: Optional[pulumi.Input[str]] = None, retention_daily: Optional[pulumi.Input[pulumi.InputType['PolicyVMRetentionDailyArgs']]] = None, retention_monthly: Optional[pulumi.Input[pulumi.InputType['PolicyVMRetentionMonthlyArgs']]] = None, retention_weekly: Optional[pulumi.Input[pulumi.InputType['PolicyVMRetentionWeeklyArgs']]] = None, retention_yearly: Optional[pulumi.Input[pulumi.InputType['PolicyVMRetentionYearlyArgs']]] = None, tags: Optional[pulumi.Input[Dict[str, pulumi.Input[str]]]] = None, timezone: Optional[pulumi.Input[str]] = None) -> 'PolicyVM':
        """
