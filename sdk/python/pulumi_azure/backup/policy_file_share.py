...
class PolicyFileShare(pulumi.CustomResource):
    backup: pulumi.Output['outputs.PolicyFileShareBackup'] = pulumi.property("backup")
    """
    ...
    retention_daily: pulumi.Output['outputs.PolicyFileShareRetentionDaily'] = pulumi.property("retentionDaily")
    """
