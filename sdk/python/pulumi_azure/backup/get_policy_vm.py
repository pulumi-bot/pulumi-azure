...
@pulumi.output_type
class _GetPolicyVMResult(dict):
    id: str = pulumi.property("id")
    name: str = pulumi.property("name")
    recovery_vault_name: str = pulumi.property("recoveryVaultName")
...
def get_policy_vm(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure:backup/getPolicyVM:getPolicyVM', __args__, opts=opts, typ=_GetPolicyVMResult).value

    return AwaitableGetPolicyVMResult(
        id=_utilities.get_dict_value(__ret__, 'id'),
        name=_utilities.get_dict_value(__ret__, 'name'),
        recovery_vault_name=_utilities.get_dict_value(__ret__, 'recoveryVaultName'),
