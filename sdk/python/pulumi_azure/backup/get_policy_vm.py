...
class GetPolicyVMResult:
    ...
    def __init__(__self__, id=None, name=None, recovery_vault_name=None, resource_group_name=None, tags=None) -> None:
...
def get_policy_vm(name: Optional[str] = None, recovery_vault_name: Optional[str] = None, resource_group_name: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPolicyVMResult:
    """
