...
class HybridConnection(pulumi.CustomResource):
    ...
    relay_namespace_name: pulumi.Output[str] = pulumi.property("relayNamespaceName")
    """
    The name of the Azure Relay in which to create the Azure Relay Hybrid Connection. Changing this forces a new resource to be created.
    """

    requires_client_authorization: pulumi.Output[Optional[bool]] = pulumi.property("requiresClientAuthorization")
    """
    ...
    user_metadata: pulumi.Output[Optional[str]] = pulumi.property("userMetadata")
    """
