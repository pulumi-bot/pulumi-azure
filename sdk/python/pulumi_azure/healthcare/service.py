...
class Service(pulumi.CustomResource):
    access_policy_object_ids: pulumi.Output[Optional[List[str]]] = pulumi.property("accessPolicyObjectIds")

    authentication_configuration: pulumi.Output['outputs.ServiceAuthenticationConfiguration'] = pulumi.property("authenticationConfiguration")
    """
    An `authentication_configuration` block as defined below.
    """

    cors_configuration: pulumi.Output['outputs.ServiceCorsConfiguration'] = pulumi.property("corsConfiguration")
    """
    A `cors_configuration` block as defined below.
    """

    cosmosdb_throughput: pulumi.Output[Optional[float]] = pulumi.property("cosmosdbThroughput")
    """
