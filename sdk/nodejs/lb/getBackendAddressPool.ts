...
export function getBackendAddressPoolApply(args: GetBackendAddressPoolApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetBackendAddressPoolResult> {
 ...
 * A collection of arguments for invoking getBackendAddressPool.
 */
export interface GetBackendAddressPoolApplyArgs {
    /**
     * The ID of the Load Balancer in which the Backend Address Pool exists.
     */
