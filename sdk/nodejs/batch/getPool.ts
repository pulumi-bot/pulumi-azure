...
export function getPoolApply(args: GetPoolApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetPoolResult> {
 ...
 * A collection of arguments for invoking getPool.
 */
export interface GetPoolApplyArgs {
    /**
     * The name of the Batch account.
     */
     ...
     * One or more `certificate` blocks that describe the certificates installed on each compute node in the pool.
     */
    certificates?: pulumi.Input<pulumi.Input<inputs.batch.GetPoolCertificate>[]>;
    /**
     * The name of the endpoint.
     */
     ...
     * A `startTask` block that describes the start task settings for the Batch pool.
     */
    startTask?: pulumi.Input<inputs.batch.GetPoolStartTask>;
}
