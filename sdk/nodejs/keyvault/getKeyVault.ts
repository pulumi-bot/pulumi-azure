...
export function getKeyVaultApply(args: GetKeyVaultApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetKeyVaultResult> {
 ...
 * A collection of arguments for invoking getKeyVault.
 */
export interface GetKeyVaultApplyArgs {
    /**
     * Specifies the name of the Key Vault.
     */
