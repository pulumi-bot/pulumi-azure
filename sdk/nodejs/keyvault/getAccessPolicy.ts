...
export function getAccessPolicyApply(args: GetAccessPolicyApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAccessPolicyResult> {
 ...
 * A collection of arguments for invoking getAccessPolicy.
 */
export interface GetAccessPolicyApplyArgs {
    /**
     * Specifies the name of the Management Template. Possible values are: `Key Management`,
     * `Secret Management`, `Certificate Management`, `Key & Secret Management`, `Key & Certificate Management`,
     * `Secret & Certificate Management`,  `Key, Secret, & Certificate Management`
