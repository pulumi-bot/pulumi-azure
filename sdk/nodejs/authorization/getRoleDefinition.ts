...
export function getRoleDefinitionApply(args?: GetRoleDefinitionApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetRoleDefinitionResult> {
 ...
 * A collection of arguments for invoking getRoleDefinition.
 */
export interface GetRoleDefinitionApplyArgs {
    /**
     * Specifies the Name of either a built-in or custom Role Definition.
     */
