...
export function getFlexibleServerApply(args: GetFlexibleServerApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetFlexibleServerResult> {
 ...
 * A collection of arguments for invoking getFlexibleServer.
 */
export interface GetFlexibleServerApplyArgs {
    /**
     * The name of this PostgreSQL Flexible Server.
     */
