...
export function getFunctionAppHostKeysApply(args: GetFunctionAppHostKeysApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetFunctionAppHostKeysResult> {
 ...
 * A collection of arguments for invoking getFunctionAppHostKeys.
 */
export interface GetFunctionAppHostKeysApplyArgs {
    /**
     * The name of the Function App.
     */
