...
export function getAppServiceApply(args: GetAppServiceApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAppServiceResult> {
 ...
 * A collection of arguments for invoking getAppService.
 */
export interface GetAppServiceApplyArgs {
    /**
     * The name of the App Service.
     */
