...
export function getAppServiceEnvironmentApply(args: GetAppServiceEnvironmentApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAppServiceEnvironmentResult> {
 ...
 * A collection of arguments for invoking getAppServiceEnvironment.
 */
export interface GetAppServiceEnvironmentApplyArgs {
    /**
     * The name of this App Service Environment.
     */
