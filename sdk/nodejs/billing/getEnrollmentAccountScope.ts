...
export function getEnrollmentAccountScopeApply(args: GetEnrollmentAccountScopeApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetEnrollmentAccountScopeResult> {
 ...
 * A collection of arguments for invoking getEnrollmentAccountScope.
 */
export interface GetEnrollmentAccountScopeApplyArgs {
    /**
     * The Billing Account Name of the Enterprise Account.
     */
