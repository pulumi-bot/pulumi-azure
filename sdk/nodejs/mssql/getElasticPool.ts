...
export function getElasticPoolApply(args: GetElasticPoolApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetElasticPoolResult> {
 ...
 * A collection of arguments for invoking getElasticPool.
 */
export interface GetElasticPoolApplyArgs {
    /**
     * The name of the elastic pool.
     */
