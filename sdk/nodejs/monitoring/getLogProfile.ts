...
export function getLogProfileApply(args: GetLogProfileApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetLogProfileResult> {
 ...
 * A collection of arguments for invoking getLogProfile.
 */
export interface GetLogProfileApplyArgs {
    /**
     * Specifies the Name of the Log Profile.
     */
