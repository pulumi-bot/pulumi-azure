...
export function getScheduledQueryRulesLogApply(args: GetScheduledQueryRulesLogApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetScheduledQueryRulesLogResult> {
 ...
 * A collection of arguments for invoking getScheduledQueryRulesLog.
 */
export interface GetScheduledQueryRulesLogApplyArgs {
    /**
     * Specifies the name of the scheduled query rule.
     */
