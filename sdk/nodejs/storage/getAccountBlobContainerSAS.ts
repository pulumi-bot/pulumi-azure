...
export function getAccountBlobContainerSASApply(args: GetAccountBlobContainerSASApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAccountBlobContainerSASResult> {
 ...
 * A collection of arguments for invoking getAccountBlobContainerSAS.
 */
export interface GetAccountBlobContainerSASApplyArgs {
    /**
     * The `Cache-Control` response header that is sent when this SAS token is used.
     */
     ...
     * A `permissions` block as defined below.
     */
    permissions: pulumi.Input<inputs.storage.GetAccountBlobContainerSASPermissions>;
    /**
     * The starting time and date of validity of this SAS. Must be a valid ISO-8601 format time/date string.
     */
