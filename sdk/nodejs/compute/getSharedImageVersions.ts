...
export function getSharedImageVersionsApply(args: GetSharedImageVersionsApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetSharedImageVersionsResult> {
 ...
 * A collection of arguments for invoking getSharedImageVersions.
 */
export interface GetSharedImageVersionsApplyArgs {
    /**
     * The name of the Shared Image in which the Shared Image exists.
     */
