...
export function getManagedDiskApply(args: GetManagedDiskApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetManagedDiskResult> {
 ...
 * A collection of arguments for invoking getManagedDisk.
 */
export interface GetManagedDiskApplyArgs {
    /**
     * Specifies the name of the Managed Disk.
     */
