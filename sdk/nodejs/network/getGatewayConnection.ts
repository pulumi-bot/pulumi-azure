...
export function getGatewayConnectionApply(args: GetGatewayConnectionApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetGatewayConnectionResult> {
 ...
 * A collection of arguments for invoking getGatewayConnection.
 */
export interface GetGatewayConnectionApplyArgs {
    /**
     * Specifies the name of the Virtual Network Gateway Connection.
     */
