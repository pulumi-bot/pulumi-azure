...
export function getFirewallApply(args: GetFirewallApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetFirewallResult> {
 ...
 * A collection of arguments for invoking getFirewall.
 */
export interface GetFirewallApplyArgs {
    /**
     * The name of the Azure Firewall.
     */
