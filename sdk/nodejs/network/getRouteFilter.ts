...
export function getRouteFilterApply(args: GetRouteFilterApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetRouteFilterResult> {
 ...
 * A collection of arguments for invoking getRouteFilter.
 */
export interface GetRouteFilterApplyArgs {
    /**
     * The Name of this Route Filter.
     */
