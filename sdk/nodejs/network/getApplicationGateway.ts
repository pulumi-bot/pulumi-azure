...
export function getApplicationGatewayApply(args: GetApplicationGatewayApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetApplicationGatewayResult> {
 ...
 * A collection of arguments for invoking getApplicationGateway.
 */
export interface GetApplicationGatewayApplyArgs {
    /**
     * The name of this Application Gateway.
     */
