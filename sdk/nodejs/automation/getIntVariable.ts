...
export function getIntVariableApply(args: GetIntVariableApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetIntVariableResult> {
 ...
 * A collection of arguments for invoking getIntVariable.
 */
export interface GetIntVariableApplyArgs {
    /**
     * The name of the automation account in which the Automation Variable exists.
     */
