...
export function getBoolVariableApply(args: GetBoolVariableApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetBoolVariableResult> {
 ...
 * A collection of arguments for invoking getBoolVariable.
 */
export interface GetBoolVariableApplyArgs {
    /**
     * The name of the automation account in which the Automation Variable exists.
     */
