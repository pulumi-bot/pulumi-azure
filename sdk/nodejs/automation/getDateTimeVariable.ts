...
export function getDateTimeVariableApply(args: GetDateTimeVariableApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetDateTimeVariableResult> {
 ...
 * A collection of arguments for invoking getDateTimeVariable.
 */
export interface GetDateTimeVariableApplyArgs {
    /**
     * The name of the automation account in which the Automation Variable exists.
     */
