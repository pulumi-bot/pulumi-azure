...
export function getKubernetesServiceVersionsApply(args: GetKubernetesServiceVersionsApplyArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetKubernetesServiceVersionsResult> {
 ...
 * A collection of arguments for invoking getKubernetesServiceVersions.
 */
export interface GetKubernetesServiceVersionsApplyArgs {
    /**
     * Should Preview versions of Kubernetes in AKS be included? Defaults to `true`
     */
