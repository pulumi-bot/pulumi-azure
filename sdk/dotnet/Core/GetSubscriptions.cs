...
namespace Pulumi.Azure.Core
{
    public static class GetSubscriptions
    {
        ...
        public static Output<GetSubscriptionsResult> Invoke(GetSubscriptionsOutputArgs? args = null, InvokeOptions? options = null)
        {
            args = args ?? new GetSubscriptionsOutputArgs();
    ...
    public sealed class GetSubscriptionsOutputArgs
    {
        /// <summary>
        /// A case-insensitive value which must be contained within the `display_name` field, used to filter the results
        /// </summary>
        ...
        public GetSubscriptionsOutputArgs()
        {
        }
    }
