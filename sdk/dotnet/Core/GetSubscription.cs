...
namespace Pulumi.Azure.Core
{
    public static class GetSubscription
    {
        ...
        public static Output<GetSubscriptionResult> Apply(GetSubscriptionApplyArgs? args = null, InvokeOptions? options = null)
        {
            args = args ?? new GetSubscriptionApplyArgs();
    ...
    public sealed class GetSubscriptionApplyArgs
    {
        /// <summary>
        /// Specifies the ID of the subscription. If this argument is omitted, the subscription ID of the current Azure Resource Manager provider is used.
        /// </summary>
        ...
        public GetSubscriptionApplyArgs()
        {
        }
    }
