...
namespace Pulumi.Azure.AppInsights
{
    public static class GetInsights
    {
        ...
        public static Output<GetInsightsResult> Apply(GetInsightsApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetInsightsApplyArgs
    {
        /// <summary>
        /// Specifies the name of the Application Insights component.
        /// </summary>
