...
namespace Pulumi.Azure.PrivateLink
{
    public static class GetServiceEndpointConnections
    {
        ...
        public static Output<GetServiceEndpointConnectionsResult> Invoke(GetServiceEndpointConnectionsOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetServiceEndpointConnectionsOutputArgs
    {
        /// <summary>
        /// The name of the resource group in which the private link service resides.
        /// </summary>
        ...
        public GetServiceEndpointConnectionsOutputArgs()
        {
        }
    }
