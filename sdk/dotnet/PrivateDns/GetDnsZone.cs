...
namespace Pulumi.Azure.PrivateDns
{
    public static class GetDnsZone
    {
        ...
        public static Output<GetDnsZoneResult> Invoke(GetDnsZoneOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetDnsZoneOutputArgs
    {
        /// <summary>
        /// The name of the Private DNS Zone.
        /// </summary>
