...
namespace Pulumi.Azure.MariaDB
{
    public static class GetMariaDbServer
    {
        ...
        public static Output<GetMariaDbServerResult> Apply(GetMariaDbServerApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetMariaDbServerApplyArgs
    {
        /// <summary>
        /// The name of the MariaDB Server to retrieve information about.
        /// </summary>
        ...
        public GetMariaDbServerApplyArgs()
        {
        }
    }
