...
namespace Pulumi.Azure.DataLake
{
    public static class GetStore
    {
        ...
        public static Output<GetStoreResult> Apply(GetStoreApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetStoreApplyArgs
    {
        /// <summary>
        /// The name of the Data Lake Store.
        /// </summary>
