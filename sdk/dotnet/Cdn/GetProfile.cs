...
namespace Pulumi.Azure.Cdn
{
    public static class GetProfile
    {
        ...
        public static Output<GetProfileResult> Apply(GetProfileApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetProfileApplyArgs
    {
        /// <summary>
        /// The name of the CDN Profile.
        /// </summary>
