...
namespace Pulumi.Azure.Sentinel
{
    public static class GetAlertRuleTemplate
    {
        ...
        public static Output<GetAlertRuleTemplateResult> Apply(GetAlertRuleTemplateApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetAlertRuleTemplateApplyArgs
    {
        /// <summary>
        /// The display name of this Sentinel Alert Rule Template. Either `display_name` or `name` have to be specified.
        /// </summary>
        ...
        public GetAlertRuleTemplateApplyArgs()
        {
        }
    }
