...
namespace Pulumi.Azure.Lb
{
    public static class GetLBRule
    {
        ...
        public static Output<GetLBRuleResult> Invoke(GetLBRuleOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetLBRuleOutputArgs
    {
        /// <summary>
        /// The ID of the Load Balancer Rule.
        /// </summary>
