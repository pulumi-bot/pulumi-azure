...
namespace Pulumi.Azure.Lb
{
    public static class GetBackendAddressPool
    {
        ...
        public static Output<GetBackendAddressPoolResult> Invoke(GetBackendAddressPoolOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.LoadbalancerId.Box(),
                args.Name.Box()
            ).Apply(a => {
                    var args = new GetBackendAddressPoolArgs();
    ...
    public sealed class GetBackendAddressPoolOutputArgs
    {
        /// <summary>
        /// The ID of the Load Balancer in which the Backend Address Pool exists.
        /// </summary>
        ...
        public GetBackendAddressPoolOutputArgs()
        {
        }
    }
