...
namespace Pulumi.Azure.Lb
{
    public static class GetLB
    {
        ...
        public static Output<GetLBResult> Invoke(GetLBOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Name.Box(),
                args.ResourceGroupName.Box()
            ).Apply(a => {
                    var args = new GetLBArgs();
    ...
    public sealed class GetLBOutputArgs
    {
        /// <summary>
        /// Specifies the name of the Load Balancer.
        /// </summary>
