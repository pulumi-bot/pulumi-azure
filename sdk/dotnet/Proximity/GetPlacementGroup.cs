...
namespace Pulumi.Azure.Proximity
{
    public static class GetPlacementGroup
    {
        ...
        public static Output<GetPlacementGroupResult> Apply(GetPlacementGroupApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetPlacementGroupApplyArgs
    {
        /// <summary>
        /// The name of the Proximity Placement Group.
        /// </summary>
        ...
        public GetPlacementGroupApplyArgs()
        {
        }
    }
