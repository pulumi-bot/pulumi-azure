...
namespace Pulumi.Azure.Attestation
{
    public static class GetProvider
    {
        ...
        public static Output<GetProviderResult> Invoke(GetProviderOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetProviderOutputArgs
    {
        [Input("name", required: true)]
