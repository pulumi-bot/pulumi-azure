...
namespace Pulumi.Azure.Redis
{
    public static class GetEnterpriseDatabase
    {
        ...
        public static Output<GetEnterpriseDatabaseResult> Invoke(GetEnterpriseDatabaseOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetEnterpriseDatabaseOutputArgs
    {
        /// <summary>
        /// The resource ID of Redis Enterprise Cluster which hosts the Redis Enterprise Database instance.
        /// </summary>
        ...
        public GetEnterpriseDatabaseOutputArgs()
        {
        }
    }
