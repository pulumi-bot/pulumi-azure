...
namespace Pulumi.Azure.Redis
{
    public static class GetCache
    {
        ...
        public static Output<GetCacheResult> Invoke(GetCacheOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetCacheOutputArgs
    {
        /// <summary>
        /// The name of the Redis cache
        /// </summary>
