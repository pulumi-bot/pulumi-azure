...
namespace Pulumi.Azure.Automation
{
    public static class GetStringVariable
    {
        ...
        public static Output<GetStringVariableResult> Apply(GetStringVariableApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetStringVariableApplyArgs
    {
        /// <summary>
        /// The name of the automation account in which the Automation Variable exists.
        /// </summary>
        ...
        public GetStringVariableApplyArgs()
        {
        }
    }
