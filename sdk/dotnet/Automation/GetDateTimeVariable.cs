...
namespace Pulumi.Azure.Automation
{
    public static class GetDateTimeVariable
    {
        ...
        public static Output<GetDateTimeVariableResult> Apply(GetDateTimeVariableApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetDateTimeVariableApplyArgs
    {
        /// <summary>
        /// The name of the automation account in which the Automation Variable exists.
        /// </summary>
        ...
        public GetDateTimeVariableApplyArgs()
        {
        }
    }
