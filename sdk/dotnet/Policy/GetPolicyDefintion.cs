...
namespace Pulumi.Azure.Policy
{
    public static class GetPolicyDefintion
    {
        ...
        public static Output<GetPolicyDefintionResult> Invoke(GetPolicyDefintionOutputArgs? args = null, InvokeOptions? options = null)
        {
            args = args ?? new GetPolicyDefintionOutputArgs();
    ...
    public sealed class GetPolicyDefintionOutputArgs
    {
        /// <summary>
        /// Specifies the display name of the Policy Definition. Conflicts with `name`.
        /// </summary>
        ...
        public GetPolicyDefintionOutputArgs()
        {
        }
    }
