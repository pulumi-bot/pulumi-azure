...
namespace Pulumi.Azure.Policy
{
    public static class GetPolicySetDefinition
    {
        ...
        public static Output<GetPolicySetDefinitionResult> Invoke(GetPolicySetDefinitionOutputArgs? args = null, InvokeOptions? options = null)
        {
            args = args ?? new GetPolicySetDefinitionOutputArgs();
    ...
    public sealed class GetPolicySetDefinitionOutputArgs
    {
        /// <summary>
        /// Specifies the display name of the Policy Set Definition. Conflicts with `name`.
        /// </summary>
        ...
        public GetPolicySetDefinitionOutputArgs()
        {
        }
    }
