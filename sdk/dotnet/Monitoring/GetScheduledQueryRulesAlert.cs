...
namespace Pulumi.Azure.Monitoring
{
    public static class GetScheduledQueryRulesAlert
    {
        ...
        public static Output<GetScheduledQueryRulesAlertResult> Invoke(GetScheduledQueryRulesAlertOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Name.Box(),
                args.ResourceGroupName.Box()
            ).Apply(a => {
                    var args = new GetScheduledQueryRulesAlertArgs();
    ...
    public sealed class GetScheduledQueryRulesAlertOutputArgs
    {
        /// <summary>
        /// Specifies the name of the scheduled query rule.
        /// </summary>
        ...
        public GetScheduledQueryRulesAlertOutputArgs()
        {
        }
    }
