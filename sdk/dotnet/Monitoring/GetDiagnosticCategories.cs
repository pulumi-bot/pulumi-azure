...
namespace Pulumi.Azure.Monitoring
{
    public static class GetDiagnosticCategories
    {
        ...
        public static Output<GetDiagnosticCategoriesResult> Invoke(GetDiagnosticCategoriesOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetDiagnosticCategoriesOutputArgs
    {
        /// <summary>
        /// The ID of an existing Resource which Monitor Diagnostics Categories should be retrieved for.
        /// </summary>
        ...
        public GetDiagnosticCategoriesOutputArgs()
        {
        }
    }
