...
namespace Pulumi.Azure.ServiceBus
{
    public static class GetTopicAuthorizationRule
    {
        ...
        public static Output<GetTopicAuthorizationRuleResult> Apply(GetTopicAuthorizationRuleApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetTopicAuthorizationRuleApplyArgs
    {
        /// <summary>
        /// The name of the ServiceBus Topic Authorization Rule resource.
        /// </summary>
        ...
        public GetTopicAuthorizationRuleApplyArgs()
        {
        }
    }
