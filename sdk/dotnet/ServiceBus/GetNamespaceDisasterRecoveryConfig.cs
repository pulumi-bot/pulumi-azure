...
namespace Pulumi.Azure.ServiceBus
{
    public static class GetNamespaceDisasterRecoveryConfig
    {
        ...
        public static Output<GetNamespaceDisasterRecoveryConfigResult> Invoke(GetNamespaceDisasterRecoveryConfigOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                ...
                args.ResourceGroupName.Box()
                    ...
                    var args = new GetNamespaceDisasterRecoveryConfigArgs();
    ...
    public sealed class GetNamespaceDisasterRecoveryConfigOutputArgs
    {
        [Input("name", required: true)]
        ...
        public GetNamespaceDisasterRecoveryConfigOutputArgs()
        {
        }
    }
