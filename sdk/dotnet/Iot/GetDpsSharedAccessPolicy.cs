...
namespace Pulumi.Azure.Iot
{
    public static class GetDpsSharedAccessPolicy
    {
        ...
        public static Output<GetDpsSharedAccessPolicyResult> Apply(GetDpsSharedAccessPolicyApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetDpsSharedAccessPolicyApplyArgs
    {
        /// <summary>
        /// Specifies the name of the IoT Hub Device Provisioning service to which the Shared Access Policy belongs.
        /// </summary>
        ...
        public GetDpsSharedAccessPolicyApplyArgs()
        {
        }
    }
