...
namespace Pulumi.Azure.DataShare
{
    public static class GetDatasetKustoCluster
    {
        ...
        public static Output<GetDatasetKustoClusterResult> Invoke(GetDatasetKustoClusterOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Name.Box(),
                args.ShareId.Box()
            ).Apply(a => {
                    var args = new GetDatasetKustoClusterArgs();
    ...
    public sealed class GetDatasetKustoClusterOutputArgs
    {
        /// <summary>
        /// The name of this Data Share Kusto Cluster Dataset.
        /// </summary>
        ...
        public GetDatasetKustoClusterOutputArgs()
        {
        }
    }
