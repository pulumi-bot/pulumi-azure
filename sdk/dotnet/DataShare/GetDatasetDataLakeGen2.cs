...
namespace Pulumi.Azure.DataShare
{
    public static class GetDatasetDataLakeGen2
    {
        ...
        public static Output<GetDatasetDataLakeGen2Result> Invoke(GetDatasetDataLakeGen2OutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Name.Box(),
                args.ShareId.Box()
            ).Apply(a => {
                    var args = new GetDatasetDataLakeGen2Args();
    ...
    public sealed class GetDatasetDataLakeGen2OutputArgs
    {
        /// <summary>
        /// The name of this Data Share Data Lake Gen2 Dataset.
        /// </summary>
        ...
        public GetDatasetDataLakeGen2OutputArgs()
        {
        }
    }
