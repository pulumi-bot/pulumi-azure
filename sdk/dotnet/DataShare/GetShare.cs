...
namespace Pulumi.Azure.DataShare
{
    public static class GetShare
    {
        ...
        public static Output<GetShareResult> Invoke(GetShareOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetShareOutputArgs
    {
        /// <summary>
        /// The ID of the Data Share account in which the Data Share is created.
        /// </summary>
