...
namespace Pulumi.Azure.DataShare
{
    public static class GetDatasetBlobStorage
    {
        ...
        public static Output<GetDatasetBlobStorageResult> Invoke(GetDatasetBlobStorageOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetDatasetBlobStorageOutputArgs
    {
        /// <summary>
        /// The ID of the Data Share in which this Data Share Blob Storage Dataset should be created.
        /// </summary>
        ...
        public GetDatasetBlobStorageOutputArgs()
        {
        }
    }
