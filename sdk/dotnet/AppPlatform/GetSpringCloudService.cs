...
namespace Pulumi.Azure.AppPlatform
{
    public static class GetSpringCloudService
    {
        ...
        public static Output<GetSpringCloudServiceResult> Apply(GetSpringCloudServiceApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetSpringCloudServiceApplyArgs
    {
        /// <summary>
        /// Specifies The name of the Spring Cloud Service resource.
        /// </summary>
        ...
        public GetSpringCloudServiceApplyArgs()
        {
        }
    }
