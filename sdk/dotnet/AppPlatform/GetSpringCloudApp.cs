...
namespace Pulumi.Azure.AppPlatform
{
    public static class GetSpringCloudApp
    {
        ...
        public static Output<GetSpringCloudAppResult> Invoke(GetSpringCloudAppOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetSpringCloudAppOutputArgs
    {
        /// <summary>
        /// The name of the Spring Cloud Application.
        /// </summary>
        ...
        public GetSpringCloudAppOutputArgs()
        {
        }
    }
