...
namespace Pulumi.Azure.EventHub
{
    ...
    public static class GetEventhubNamespace
    {
        ...
        public static Output<GetEventhubNamespaceResult> Invoke(GetEventhubNamespaceOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Name.Box(),
                args.ResourceGroupName.Box()
            ).Apply(a => {
                    var args = new GetEventhubNamespaceArgs();
    ...
    public sealed class GetEventhubNamespaceOutputArgs
    {
        /// <summary>
        /// The name of the EventHub Namespace.
        /// </summary>
        ...
        public GetEventhubNamespaceOutputArgs()
        {
        }
    }
