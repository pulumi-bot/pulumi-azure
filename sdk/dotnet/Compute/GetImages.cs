...
namespace Pulumi.Azure.Compute
{
    public static class GetImages
    {
        ...
        public static Output<GetImagesResult> Apply(GetImagesApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetImagesApplyArgs
    {
        /// <summary>
        /// The name of the Resource Group in which the Image exists.
        /// </summary>
