...
namespace Pulumi.Azure.Compute
{
    public static class GetVirtualMachine
    {
        ...
        public static Output<GetVirtualMachineResult> Invoke(GetVirtualMachineOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Name.Box(),
                args.ResourceGroupName.Box()
            ).Apply(a => {
                    var args = new GetVirtualMachineArgs();
    ...
    public sealed class GetVirtualMachineOutputArgs
    {
        /// <summary>
        /// Specifies the name of the Virtual Machine.
        /// </summary>
        ...
        public GetVirtualMachineOutputArgs()
        {
        }
    }
