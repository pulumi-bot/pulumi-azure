...
namespace Pulumi.Azure.Compute
{
    public static class GetAvailabilitySet
    {
        ...
        public static Output<GetAvailabilitySetResult> Invoke(GetAvailabilitySetOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Name.Box(),
                args.ResourceGroupName.Box()
            ).Apply(a => {
                    var args = new GetAvailabilitySetArgs();
    ...
    public sealed class GetAvailabilitySetOutputArgs
    {
        /// <summary>
        /// The name of the Availability Set.
        /// </summary>
        ...
        public GetAvailabilitySetOutputArgs()
        {
        }
    }
