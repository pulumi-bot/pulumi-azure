...
namespace Pulumi.Azure.Compute
{
    public static class GetSharedImageGallery
    {
        ...
        public static Output<GetSharedImageGalleryResult> Invoke(GetSharedImageGalleryOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Name.Box(),
                args.ResourceGroupName.Box()
            ).Apply(a => {
                    var args = new GetSharedImageGalleryArgs();
    ...
    public sealed class GetSharedImageGalleryOutputArgs
    {
        /// <summary>
        /// The name of the Shared Image Gallery.
        /// </summary>
        ...
        public GetSharedImageGalleryOutputArgs()
        {
        }
    }
