...
namespace Pulumi.Azure.AppService
{
    public static class GetAppServicePlan
    {
        ...
        public static Output<GetAppServicePlanResult> Invoke(GetAppServicePlanOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Name.Box(),
                args.ResourceGroupName.Box()
            ).Apply(a => {
                    var args = new GetAppServicePlanArgs();
    ...
    public sealed class GetAppServicePlanOutputArgs
    {
        /// <summary>
        /// The name of the App Service Plan.
        /// </summary>
        ...
        public GetAppServicePlanOutputArgs()
        {
        }
    }
