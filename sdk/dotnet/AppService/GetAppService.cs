...
namespace Pulumi.Azure.AppService
{
    public static class GetAppService
    {
        ...
        public static Output<GetAppServiceResult> Invoke(GetAppServiceOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Name.Box(),
                args.ResourceGroupName.Box()
            ).Apply(a => {
                    var args = new GetAppServiceArgs();
    ...
    public sealed class GetAppServiceOutputArgs
    {
        /// <summary>
        /// The name of the App Service.
        /// </summary>
        ...
        public GetAppServiceOutputArgs()
        {
        }
    }
