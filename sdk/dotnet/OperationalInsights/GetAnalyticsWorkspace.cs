...
namespace Pulumi.Azure.OperationalInsights
{
    public static class GetAnalyticsWorkspace
    {
        ...
        public static Output<GetAnalyticsWorkspaceResult> Invoke(GetAnalyticsWorkspaceOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Name.Box(),
                args.ResourceGroupName.Box()
            ).Apply(a => {
                    var args = new GetAnalyticsWorkspaceArgs();
    ...
    public sealed class GetAnalyticsWorkspaceOutputArgs
    {
        /// <summary>
        /// Specifies the name of the Log Analytics Workspace.
        /// </summary>
        ...
        public GetAnalyticsWorkspaceOutputArgs()
        {
        }
    }
