...
namespace Pulumi.Azure.KeyVault
{
    public static class GetCertificateData
    {
        ...
        public static Output<GetCertificateDataResult> Invoke(GetCertificateDataOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetCertificateDataOutputArgs
    {
        /// <summary>
        /// Specifies the ID of the Key Vault instance where the Secret resides, available on the `azure.keyvault.KeyVault` Data Source / Resource.
        /// </summary>
        ...
        public GetCertificateDataOutputArgs()
        {
        }
    }
