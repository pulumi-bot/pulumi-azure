...
namespace Pulumi.Azure.KeyVault
{
    public static class GetKeyVault
    {
        ...
        public static Output<GetKeyVaultResult> Apply(GetKeyVaultApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetKeyVaultApplyArgs
    {
        /// <summary>
        /// Specifies the name of the Key Vault.
        /// </summary>
