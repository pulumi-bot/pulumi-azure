...
namespace Pulumi.Azure.KeyVault
{
    public static class GetKeyVault
    {
        ...
        public static Output<GetKeyVaultResult> Invoke(GetKeyVaultOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Name.Box(),
                args.ResourceGroupName.Box()
            ).Apply(a => {
                    var args = new GetKeyVaultArgs();
    ...
    public sealed class GetKeyVaultOutputArgs
    {
        /// <summary>
        /// Specifies the name of the Key Vault.
        /// </summary>
