...
namespace Pulumi.Azure.TrafficManager
{
    ...
    public static class GetGeographicalLocation
    {
        ...
        public static Output<GetGeographicalLocationResult> Apply(GetGeographicalLocationApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetGeographicalLocationApplyArgs
    {
        /// <summary>
        /// Specifies the name of the Location, for example `World`, `Europe` or `Germany`.
        /// </summary>
        ...
        public GetGeographicalLocationApplyArgs()
        {
        }
    }
