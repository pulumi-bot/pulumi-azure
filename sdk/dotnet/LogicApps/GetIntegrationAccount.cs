...
namespace Pulumi.Azure.LogicApps
{
    public static class GetIntegrationAccount
    {
        ...
        public static Output<GetIntegrationAccountResult> Invoke(GetIntegrationAccountOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Name.Box(),
                args.ResourceGroupName.Box()
            ).Apply(a => {
                    var args = new GetIntegrationAccountArgs();
    ...
    public sealed class GetIntegrationAccountOutputArgs
    {
        /// <summary>
        /// The name of this Logic App Integration Account.
        /// </summary>
        ...
        public GetIntegrationAccountOutputArgs()
        {
        }
    }
