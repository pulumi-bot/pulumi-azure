...
namespace Pulumi.Azure.LogicApps
{
    public static class GetWorkflow
    {
        ...
        public static Output<GetWorkflowResult> Invoke(GetWorkflowOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetWorkflowOutputArgs
    {
        /// <summary>
        /// The name of the Logic App Workflow.
        /// </summary>
