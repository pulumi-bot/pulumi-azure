...
namespace Pulumi.Azure.Network
{
    public static class GetVirtualHub
    {
        ...
        public static Output<GetVirtualHubResult> Apply(GetVirtualHubApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetVirtualHubApplyArgs
    {
        /// <summary>
        /// The name of the Virtual Hub.
        /// </summary>
