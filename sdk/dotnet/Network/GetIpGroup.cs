...
namespace Pulumi.Azure.Network
{
    public static class GetIpGroup
    {
        ...
        public static Output<GetIpGroupResult> Apply(GetIpGroupApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetIpGroupApplyArgs
    {
        /// <summary>
        /// Specifies the Name of the IP Group.
        /// </summary>
