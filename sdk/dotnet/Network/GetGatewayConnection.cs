...
namespace Pulumi.Azure.Network
{
    public static class GetGatewayConnection
    {
        ...
        public static Output<GetGatewayConnectionResult> Apply(GetGatewayConnectionApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetGatewayConnectionApplyArgs
    {
        /// <summary>
        /// Specifies the name of the Virtual Network Gateway Connection.
        /// </summary>
        ...
        public GetGatewayConnectionApplyArgs()
        {
        }
    }
