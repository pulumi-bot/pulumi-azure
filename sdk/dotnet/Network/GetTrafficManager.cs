...
namespace Pulumi.Azure.Network
{
    public static class GetTrafficManager
    {
        ...
        public static Output<GetTrafficManagerResult> Invoke(GetTrafficManagerOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetTrafficManagerOutputArgs
    {
        /// <summary>
        /// Specifies the name of the Location, for example `World`, `Europe` or `Germany`.
        /// </summary>
        ...
        public GetTrafficManagerOutputArgs()
        {
        }
    }
