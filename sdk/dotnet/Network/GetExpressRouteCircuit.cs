...
namespace Pulumi.Azure.Network
{
    public static class GetExpressRouteCircuit
    {
        ...
        public static Output<GetExpressRouteCircuitResult> Invoke(GetExpressRouteCircuitOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Name.Box(),
                args.ResourceGroupName.Box()
            ).Apply(a => {
                    var args = new GetExpressRouteCircuitArgs();
    ...
    public sealed class GetExpressRouteCircuitOutputArgs
    {
        /// <summary>
        /// The name of the ExpressRoute circuit.
        /// </summary>
        ...
        public GetExpressRouteCircuitOutputArgs()
        {
        }
    }
