...
namespace Pulumi.Azure.Network
{
    public static class GetVirtualNetworkGateway
    {
        ...
        public static Output<GetVirtualNetworkGatewayResult> Invoke(GetVirtualNetworkGatewayOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Name.Box(),
                args.ResourceGroupName.Box()
            ).Apply(a => {
                    var args = new GetVirtualNetworkGatewayArgs();
    ...
    public sealed class GetVirtualNetworkGatewayOutputArgs
    {
        /// <summary>
        /// Specifies the name of the Virtual Network Gateway.
        /// </summary>
        ...
        public GetVirtualNetworkGatewayOutputArgs()
        {
        }
    }
