...
namespace Pulumi.Azure.Network
{
    public static class GetApplicationGateway
    {
        ...
        public static Output<GetApplicationGatewayResult> Invoke(GetApplicationGatewayOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Name.Box(),
                args.ResourceGroupName.Box()
            ).Apply(a => {
                    var args = new GetApplicationGatewayArgs();
    ...
    public sealed class GetApplicationGatewayOutputArgs
    {
        /// <summary>
        /// The name of this Application Gateway.
        /// </summary>
        ...
        public GetApplicationGatewayOutputArgs()
        {
        }
    }
