...
namespace Pulumi.Azure.Network
{
    public static class GetNetworkWatcher
    {
        ...
        public static Output<GetNetworkWatcherResult> Invoke(GetNetworkWatcherOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Name.Box(),
                args.ResourceGroupName.Box()
            ).Apply(a => {
                    var args = new GetNetworkWatcherArgs();
    ...
    public sealed class GetNetworkWatcherOutputArgs
    {
        /// <summary>
        /// Specifies the Name of the Network Watcher.
        /// </summary>
        ...
        public GetNetworkWatcherOutputArgs()
        {
        }
    }
