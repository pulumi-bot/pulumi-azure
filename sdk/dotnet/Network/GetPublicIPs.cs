...
namespace Pulumi.Azure.Network
{
    public static class GetPublicIPs
    {
        ...
        public static Output<GetPublicIPsResult> Invoke(GetPublicIPsOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetPublicIPsOutputArgs
    {
        /// <summary>
        /// The Allocation Type for the Public IP Address. Possible values include `Static` or `Dynamic`.
        /// </summary>
