...
namespace Pulumi.Azure.Network
{
    public static class GetFirewall
    {
        ...
        public static Output<GetFirewallResult> Invoke(GetFirewallOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetFirewallOutputArgs
    {
        /// <summary>
        /// The name of the Azure Firewall.
        /// </summary>
