...
namespace Pulumi.Azure.NotificationHub
{
    public static class GetHub
    {
        ...
        public static Output<GetHubResult> Invoke(GetHubOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetHubOutputArgs
    {
        /// <summary>
        /// Specifies the Name of the Notification Hub.
        /// </summary>
