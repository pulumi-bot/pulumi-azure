...
namespace Pulumi.Azure.Billing
{
    public static class GetMcaAccountScope
    {
        ...
        public static Output<GetMcaAccountScopeResult> Apply(GetMcaAccountScopeApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetMcaAccountScopeApplyArgs
    {
        /// <summary>
        /// The Billing Account Name of the MCA account.
        /// </summary>
        ...
        public GetMcaAccountScopeApplyArgs()
        {
        }
    }
