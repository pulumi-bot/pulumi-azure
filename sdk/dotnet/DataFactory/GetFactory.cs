...
namespace Pulumi.Azure.DataFactory
{
    public static class GetFactory
    {
        ...
        public static Output<GetFactoryResult> Invoke(GetFactoryOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Name.Box(),
                args.ResourceGroupName.Box()
            ).Apply(a => {
                    var args = new GetFactoryArgs();
    ...
    public sealed class GetFactoryOutputArgs
    {
        /// <summary>
        /// The name of this Azure Data Factory.
        /// </summary>
