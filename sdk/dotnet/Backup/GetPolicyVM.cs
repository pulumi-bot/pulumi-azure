...
namespace Pulumi.Azure.Backup
{
    public static class GetPolicyVM
    {
        ...
        public static Output<GetPolicyVMResult> Apply(GetPolicyVMApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetPolicyVMApplyArgs
    {
        /// <summary>
        /// Specifies the name of the VM Backup Policy.
        /// </summary>
