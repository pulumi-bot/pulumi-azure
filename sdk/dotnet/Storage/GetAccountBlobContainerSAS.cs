...
namespace Pulumi.Azure.Storage
{
    public static class GetAccountBlobContainerSAS
    {
        ...
        public static Output<GetAccountBlobContainerSASResult> Apply(GetAccountBlobContainerSASApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetAccountBlobContainerSASApplyArgs
    {
        /// <summary>
        /// The `Cache-Control` response header that is sent when this SAS token is used.
        /// </summary>
        ...
        public GetAccountBlobContainerSASApplyArgs()
        {
        }
    }
