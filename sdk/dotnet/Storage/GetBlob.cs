...
namespace Pulumi.Azure.Storage
{
    public static class GetBlob
    {
        ...
        public static Output<GetBlobResult> Invoke(GetBlobOutputArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetBlobOutputArgs
    {
        [Input("metadata")]
