...
namespace Pulumi.Azure.Storage
{
    public static class GetSync
    {
        ...
        public static Output<GetSyncResult> Invoke(GetSyncOutputArgs args, InvokeOptions? options = null)
        {
            return Pulumi.Output.All(
                args.Name.Box(),
                args.ResourceGroupName.Box()
            ).Apply(a => {
                    var args = new GetSyncArgs();
    ...
    public sealed class GetSyncOutputArgs
    {
        /// <summary>
        /// The name of this Storage Sync.
        /// </summary>
